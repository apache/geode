...
public class TcpSocketCreatorImpl implements TcpSocketCreator {
  ...
  protected ServerSocketCreator serverSocketCreator;
  protected ClientSocketCreator clientSocketCreator;
  protected AdvancedSocketCreator advancedSocketCreator;
  ...
  protected void initializeCreators() {
    ...
    clientSocketCreator = new ClientSocketCreatorImpl();
    advancedSocketCreator = new AdvancedSocketCreatorImpl();
  }
  ...
  protected class ServerSocketCreatorImpl implements ServerSocketCreator {

    public boolean useSSL() {
      return TcpSocketCreatorImpl.this.useSSL();
    }
    ...
    public final Socket connectForServer(HostAndPort addr, int timeout,
        ...
        throws IOException {
      return forAdvancedUse().connect(addr, timeout, optionalWatcher, false, -1, useSSL());
    }

  }

  protected class ClientSocketCreatorImpl implements ClientSocketCreator {
    @Override
    public boolean useSSL() {
      return TcpSocketCreatorImpl.this.useSSL();
    }
  ...
  protected class AdvancedSocketCreatorImpl implements AdvancedSocketCreator {
    @Override
    public boolean useSSL() {
      return TcpSocketCreatorImpl.this.useSSL();
    }
        ...
        while (true) {
          ...
          try {
            if (useNIO) {
              ...
              socket = ((ServerSocketCreatorImpl) forServer()).createServerSocket(localPort,
