...
public class WANClusterConfigurationDUnitTest {
  ...
  // toberal
  @Test
  public void whenAlteringOneRegionsWithParallelSenderIdWithAHighNumberOfServersDoesNotHang()
      throws Exception {
    // toberal.
    ...
    // with 3 sleeps of 10 it finished after 6 minutes and a half showing the "having elapsed" log.
