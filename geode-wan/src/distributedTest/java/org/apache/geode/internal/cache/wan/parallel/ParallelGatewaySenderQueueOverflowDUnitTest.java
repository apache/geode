...
public class ParallelGatewaySenderQueueOverflowDUnitTest extends WANTestBase {
  ...
  public void testParallelSenderQueueEventsOverflow_NoDiskStoreSpecified() {
    ...
    await().untilAsserted(() -> {
      ...
      getLogWriter().info("Entries overflown to disk: " + numOvVm4 + "," + numOvVm5
          + "," + numOvVm6 + "," + numOvVm7);
      getLogWriter().info(
  ...
  @Test
  public void testParallelSenderQueueEventsOverflow() {
    Integer lnPort = vm0.invoke(() -> WANTestBase.createFirstLocatorWithDSId(1));
    Integer nyPort = vm1.invoke(() -> WANTestBase.createFirstRemoteLocator(2, lnPort));
    ...
    // give some time for the senders to deprecatedPause
  ...
  @Ignore("TODO: test is disabled")
  @Test
  public void testParallelSenderQueueEventsOverflow_2() {
    Integer lnPort = vm0.invoke(() -> WANTestBase.createFirstLocatorWithDSId(1));
    Integer nyPort = vm1.invoke(() -> WANTestBase.createFirstRemoteLocator(2, lnPort));
  ...
  @Ignore("TODO: test is disabled")
  @Test
  public void testParallelSenderQueueNoEventsOverflow() {
    Integer lnPort = vm0.invoke(() -> WANTestBase.createFirstLocatorWithDSId(1));
    Integer nyPort = vm1.invoke(() -> WANTestBase.createFirstRemoteLocator(2, lnPort));
  ...
  public void test_ValidateParallelGatewaySenderQueueAttributes_1() {
    ...
    try {
      ...
      assertTrue(regionQueue.getRegion().getAttributes().isDiskSynchronous());
    } finally {
      exTKSender.remove();
    }
  }
  ...
  public void test_ValidateParallelGatewaySenderQueueAttributes_2() {
    ...
    try {
      ...
      assertEquals(regionQueues.size(), 1);
      RegionQueue regionQueue = regionQueues.iterator().next();
      assertFalse(regionQueue.getRegion().getAttributes().isDiskSynchronous());
    } finally {
      ex.remove();
    }
  }
