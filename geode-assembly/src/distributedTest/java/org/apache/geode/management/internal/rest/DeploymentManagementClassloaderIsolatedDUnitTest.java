...
/**
 * This test is only run when we are running with classloader isolation.
 *
 * @see DeploymentManagementDUnitTest
 */
public class DeploymentManagementClassloaderIsolatedDUnitTest {
  @ClassRule
  ...
  public static void beforeClass() throws Exception {
    // ignore if classloader isolation is disabled
    assumeTrue(Boolean.parseBoolean(System.getProperty("classloader.isolated")));
