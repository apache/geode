...
public class LocatorManagerConfiguresSerialFilterAcceptanceTest {
  ...
  public void setUpOutputFiles() {
    ...
    locatorLogFile = temporaryFolder.getRoot().toPath().resolve(NAME + ".log");
  }
  ...
  @Test
  public void startingLocatorWithJmxManager_configuresSerialFilter_atLeastJava9() throws Exception {
    ...
    ProcessBuilder processBuilder = new ProcessBuilder()
        ...
        .command(javaBin.toFile().getAbsolutePath(),
            ...
            "org.apache.geode.distributed.LocatorLauncher", "start", NAME,
  ...
  @Test
  public void startingLocatorWithJmxManager_configuresSerialFilter_atMostJava8() throws Exception {
