...
public class QueryAccessController extends AbstractBaseController {
  ...
  @ApiOperation(value = "create a parametrized Query", notes = "Prepare the specified parametrized query and assign the corresponding ID for lookup", response = void.class)
  @ApiResponses({
  ...
  @ApiOperation(value = "update parametrized query", notes = "Update named, parametrized query by ID", response = void.class)
  @ApiResponses({
  ...
  @ApiOperation(value = "delete parametrized query", notes = "delete named, parametrized query by ID", response = void.class)
  @ApiResponses({
