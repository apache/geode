...
public class GemFireVersion {
  ...
  public static String getGemFireJarFileName() {
    return "gemfire-core-" + GemFireVersion.getGemFireVersion() +".jar";
  }

  public static String getGemFireJGroupsJarFileName() {
    return "gemfire-jgroups-" + GemFireVersion.getGemFireVersion() +".jar";
  }
