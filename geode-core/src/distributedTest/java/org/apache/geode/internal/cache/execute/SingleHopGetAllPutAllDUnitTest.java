  ...
  public void testGetAllInClient() {
    client.invoke("testGetAllInClient", () -> {
      ...
      long metadataRefreshes =
          ((GemFireCacheImpl) cache).getClientMetadataService().getTotalRefreshTaskCount();
      ...
      assertThat(((GemFireCacheImpl) cache).getClientMetadataService().getTotalRefreshTaskCount())
