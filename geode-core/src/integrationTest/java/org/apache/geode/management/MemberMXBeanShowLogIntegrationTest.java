...
public class MemberMXBeanShowLogIntegrationTest {
  ...
  public void showLogZeroUsesDefault() {
    ...
    // splitting on LINE_SEPARATOR results in a length near 30
    assertThat(log.split(LINE_SEPARATOR).length).as("Log: " + log).isGreaterThan(25).isLessThan(35);
  }
  ...
  public void showLogMaxLinesCount() {
    ...
    // splitting on LINE_SEPARATOR results in a length near 100
    assertThat(log.split(LINE_SEPARATOR).length).as("Log: " + log).isGreaterThan(90)
        .isLessThan(110);
  }
