...
/**
 * Integration tests for {@link PausableLogWriterAppender} with
 * {@link ConfigurationProperties#LOG_FILE_SIZE_LIMIT} and
 * {@link ConfigurationProperties#LOG_DISK_SPACE_LIMIT}.
 */
@Category(LoggingTest.class)
public class PausableLogWriterAppenderWithLimitsIntegrationTest {

  private static final String CONFIG_FILE_NAME =
      "PausableLogWriterAppenderWithLimitsIntegrationTest_log4j2.xml";
  ...
  public void logDiskSpaceLimit() {
    ...
    LogConfig logConfig = pausableLogWriterAppender.getLogWriter().getConfig();
    ...
    pausableLogWriterAppender.configChanged();
