...
public class LocatorLauncherSerializableObjectFilterExistsIntegrationTest {
  ...
  @Test
  public void doesNotConfigureSerializableObjectFilter_whenSerializableObjectFilterExists_onJava9orGreater() {
    assumeThat(isJavaVersionAtMost(JAVA_9)).isTrue();
  ...
  @Test
  public void doesNotConfigureSerializableObjectFilter_whenSerializableObjectFilterExists_onJava8() {
