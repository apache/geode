...
/**
 * Integration tests for {@link PausableConsoleAppender} with {@code SystemOutRule} and
 * {@code SystemErrRule}.
 *
 * <p>
 * Verifies that {@code SystemOutRule} can capture the output of {@link PausableConsoleAppender}.
 * If this behavior changes, then Geode logging tests may also need to change.
 */
@Category(LoggingTest.class)
public class PausableConsoleAppenderWithSystemOutRuleIntegrationTest {

  private static final String CONFIG_FILE_NAME =
      "PausableConsoleAppenderWithSystemOutRuleIntegrationTest_log4j2.xml";
