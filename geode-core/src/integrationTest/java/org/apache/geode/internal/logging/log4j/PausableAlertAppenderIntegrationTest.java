...
/**
 * Integration tests for {@link PausableAlertAppender}.
 */
@Category({AlertingTest.class, LoggingTest.class})
public class PausableAlertAppenderIntegrationTest {

  private static final String CONFIG_FILE_NAME = "PausableAlertAppenderIntegrationTest_log4j2.xml";
  ...
  public void setUp() throws Exception {
    pausableAlertAppender =
        loggerContextRule.getAppender(APPENDER_NAME, PausableAlertAppender.class);
  ...
  public void tearDown() throws Exception {
    ...
    pausableAlertAppender.clearLogEvents();
  }

  @Test
  public void getLogEventsIsEmptyByDefault() {
    assertThat(pausableAlertAppender.getLogEvents()).isEmpty();
  }
  ...
  public void getLogEventsReturnsLoggedEvents() {
    ...
    assertThat(pausableAlertAppender.getLogEvents()).hasSize(1);
    LogEvent event = pausableAlertAppender.getLogEvents().get(0);
  ...
  public void isPausedReturnsTrueAfterPause() {
    ...
    assertThat(pausableAlertAppender.isPaused()).isTrue();
  }
  ...
  public void isPausedReturnsFalseAfterResume() {
    ...
    assertThat(pausableAlertAppender.isPaused()).isFalse();
  }
  ...
  public void alertMessagingExistsAfterOnConnect() {
    pausableAlertAppender.createSession(alertMessaging);

    assertThat(pausableAlertAppender.getAlertMessaging()).isNotNull();
  }

  @Test
  public void alertMessagingDoesNotExistAfterOnDisconnect() {
    pausableAlertAppender.createSession(alertMessaging);
    pausableAlertAppender.stopSession();

    assertThat(pausableAlertAppender.getAlertMessaging()).isNull();
  }

  @Test
  public void sendsNoAlertsIfNoListeners() {
    pausableAlertAppender.createSession(alertMessaging);
    alertMessaging = spy(pausableAlertAppender.getAlertMessaging());
    pausableAlertAppender.setAlertMessaging(alertMessaging);
  ...
  public void sendsAlertIfListenerExists() {
    ...
    alertMessaging = spy(pausableAlertAppender.getAlertMessaging());
    pausableAlertAppender.setAlertMessaging(alertMessaging);
    pausableAlertAppender.addAlertListener(localMember, AlertLevel.WARNING);
  ...
  public void isRegisteredWithAlertingProviderRegistryDuringInitialization() {
    assertThat(alertingProviderRegistry.getAlertingProvider()).isSameAs(pausableAlertAppender);
  }

  @Test
  public void isUnregisteredWithAlertingProviderRegistryDuringCleanUp() {
    pausableAlertAppender.stop();
