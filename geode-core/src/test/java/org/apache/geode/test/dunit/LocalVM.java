...
public class LocalVM extends VM {
  ...
  protected static MethExecutorResult execute(final String targetClass, final String methodName, final Object[] args) {
  ...
  protected static class LocalDUnitVMIF implements RemoteDUnitVMIF {
    ...
    @Override
    public MethExecutorResult executeMethodOnObject(final Object target, final String methodName, final Object[] args)
        throws RemoteException {
