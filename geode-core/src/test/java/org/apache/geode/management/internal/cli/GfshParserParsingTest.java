...
public class GfshParserParsingTest {
  ...
  public void testSynonyms() throws Exception {
    ...
    assertThat(result.getParamValue("group")).isEqualTo("group1");
    assertThat(result.getParamValue("member")).isEqualTo("member1");
    command = "destroy gateway-sender --id=test --members=member1 --groups=group1"; // Not in
                                                                                    // documentation?
    result = parser.parse(command);
    assertThat(result.getParamValue("group")).isEqualTo("group1");
    assertThat(result.getParamValue("member")).isEqualTo("member1");
    ...
    command = "list gateways --groups=group1 --members=member1"; // Documentation missing param
                                                                 // under Syntax
    result = parser.parse(command);
    assertThat(result.getParamValue("group")).isEqualTo("group1");
    assertThat(result.getParamValue("member")).isEqualTo("member1");
