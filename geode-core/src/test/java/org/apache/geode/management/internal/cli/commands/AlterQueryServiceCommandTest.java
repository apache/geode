...
public class AlterQueryServiceCommandTest {
  ...
  public void populateMethodAuthorizerSetsAuthorizerNameAndParameters() {
    ...
    String param = "param";
    Set<String> parameters = new HashSet<>(Collections.singleton(param));
    ...
    assertThat(methodAuthorizer.getParameters().get(0).getParameterValue()).isEqualTo(param);
  }

  @Test
  public void getQueryConfigServiceReturnsExistingQueryConfigService() {
  ...
  @Test
  public void getQueryConfigServiceeturnsNewQueryConfigServicehenNoExistingServiceIsFound() {
    ConfigurationPersistenceService mockConfigPersistenceService =
        mock(ConfigurationPersistenceService.class);
    CacheConfig mockCacheConfig = mock(CacheConfig.class);
