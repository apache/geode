...
import static org.apache.geode.management.internal.cli.i18n.CliStrings.RESUME_GATEWAYSENDER;
...
public class ResumeAsyncEventQueueCommandTest {
  ...
  public void resumeAsyncEventQueueSuccessful() {
    ...
    functionResults.add(new CliFunctionResult("member1", CliFunctionResult.StatusState.OK, "SUCCESS"));
    functionResults.add(new CliFunctionResult("member2", CliFunctionResult.StatusState.ERROR, "FAILURE"));
