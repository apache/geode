...
public class OffHeapStorageNonRuntimeStatsJUnitTest {
  ...
  public void testUpdateNonRealTimeOffHeapStorageStats() {
    ...
    try {
      ...
      OffHeapStoredObject.release(storedObject1.getAddress(), freeListManager);
      ...
      OffHeapStoredObject.release(storedObject3.getAddress(), freeListManager);
      OffHeapStoredObject.release(storedObject2.getAddress(), freeListManager);
