...
public class CachePerfStatsTest {
  ...
  @Test
  public void cacheWriterCallsCompletedCompletedWrapsFromMaxIntegerToNegativeValue() {
    statistics.incInt(cacheWriterCallsCompletedId, Integer.MAX_VALUE);
  ...
  @Test
  public void deltaFullValuesSentFromMaxIntegerToNegativeValue() {
    statistics.incInt(deltaFullValuesSentId, Integer.MAX_VALUE);
  ...
  @Test
  public void deltaFullValuesRequestedFromMaxIntegerToNegativeValue() {
    statistics.incInt(deltaFullValuesRequestedId, Integer.MAX_VALUE);
