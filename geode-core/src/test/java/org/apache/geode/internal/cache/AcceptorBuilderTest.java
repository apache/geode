...
public class AcceptorBuilderTest {
  ...
  @Test
  public void forServerDoesNotUnsetGatewayReceiverMetrics() {
    InternalCacheServer server = mock(InternalCacheServer.class);
    AcceptorBuilder builder = new AcceptorBuilder();
    GatewayReceiverMetrics gatewayReceiverMetrics = mock(GatewayReceiverMetrics.class);
    builder.setGatewayReceiverMetrics(gatewayReceiverMetrics);

    builder.forServer(server);

    assertThat(builder.getGatewayReceiverMetrics()).isEqualTo(gatewayReceiverMetrics);
  }
