...
import static org.apache.geode.internal.util.ArgumentRedactorRegex.getRegex;
...
public class ArgumentRedactorTest {
  ...
  @Test
  public void printActualRegexString() {
  ...
  @Test
  public void redactsArgumentBeginningWithHyphen() {
