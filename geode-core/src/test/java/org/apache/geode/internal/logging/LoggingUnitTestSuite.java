...
@RunWith(Suite.class)
@Suite.SuiteClasses({LogServiceJUnitTest.class, LogWriterImplJUnitTest.class,
    SortLogFileJUnitTest.class, AlertAppenderJUnitTest.class, ConfigLocatorJUnitTest.class,
