...
public abstract class AbstractGMSAuthenticatorTestCase {
  ...
  public void setUp() throws Exception {
    ...
    when(securityService.isIntegratedSecurity(any(Properties.class))).thenReturn(isIntegratedSecurity());
    when(securityService.isPeerSecurityRequired(any(Properties.class))).thenReturn(true);
