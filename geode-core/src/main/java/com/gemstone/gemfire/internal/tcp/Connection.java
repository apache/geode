...
public class Connection implements Runnable {
    ...
    final static int NORMAL_MSG_TYPE = 0x4c;
    final static int CHUNKED_MSG_TYPE = 0x4d; // a chunk of one logical msg
    final static int END_CHUNKED_MSG_TYPE = 0x4e; // last in a series of chunks
    final static int DIRECT_ACK_BIT = 0x20;
     ...
     */
    final static int SMALL_BUFFER_SIZE = Integer.getInteger(DistributionConfig.GEMFIRE_PREFIX + "SMALL_BUFFER_SIZE", 4096);
...
//  private String senderName = null;
     ...
     */
    private final static int MAX_SENDERS = getInteger("p2p.maxConnectionSenders", DirectChannel.DEFAULT_CONCURRENCY_LEVEL).intValue();
    /**
...
//          this.writerThread = null;
    ...
    private static final int HANDSHAKE_TIMEOUT_MS = getInteger("p2p.handshakeTimeoutMs", 59000).intValue();
...
//        this.writerThread = null;
    ...
    protected static final int BATCH_BUFFER_SIZE = getInteger("p2p.batchBufferSize", 1024 * 1024).intValue();
    protected static final int BATCH_FLUSH_MS = getInteger("p2p.batchFlushTime", 50).intValue();
