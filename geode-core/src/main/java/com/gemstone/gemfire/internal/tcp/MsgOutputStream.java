 ...
 * @since GemFire 3.0
 */
class MsgOutputStream extends AbstractDataOutputStream {
     ...
     * stream
     */
    final void setMessageHeader(int msgType, int processorType, short msgId) {
     ...
     */
    final ByteBuffer getContentBuffer() {
        buffer.flip();
        return buffer;
    }
