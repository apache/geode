...
public interface ManagedEntity {
     ...
     *
     * @throws AdminException        If a problem is encountered while starting this managed
     *                               entity.
     ...
     *
     * @throws AdminException        If a problem is encountered while stopping this managed
     *                               entity.
     * @throws IllegalStateException If this managed entity resides on a remote machine and a
     *                               <code>null</code> or empty (<code>""</code>) {@linkplain
     *                               ManagedEntityConfig#getRemoteCommand remote command} has
     ...
     *
     * @param timeout The number of milliseconds to wait for this managed entity
     *                to start.
     * @return Whether or not the entity has started.
     * <code>false</code>, if the method times out.
     * @throws InterruptedException If the thread invoking this method is interrupted while
     *                              waiting.
     */
     ...
     *
     * @throws AdminException                If a problem is encountered while getting the log of this
     *                                       managed entity.
