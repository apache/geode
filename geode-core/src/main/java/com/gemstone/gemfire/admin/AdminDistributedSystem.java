...
public interface AdminDistributedSystem {
     ...
     *
     * @throws AdminException If a problem is encountered while starting the managed
     *                        entities.
     */
     ...
     * to tell the remaining members to stop waiting for the lost data.
     *
     * @param diskStoreID The unique id of the disk store which you are revoking. The unique
