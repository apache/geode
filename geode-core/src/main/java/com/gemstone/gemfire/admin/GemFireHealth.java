...
public interface GemFireHealth {
     ...
     * configuration.
     *
     * @param hostName The {@linkplain java.net.InetAddress#getCanonicalHostName
     ...
     * @param hostName The {@linkplain java.net.InetAddress#getCanonicalHostName
     *                 canonical} name of the host.
     * @throws IllegalArgumentException If host <code>hostName</code> does not exist or if there
