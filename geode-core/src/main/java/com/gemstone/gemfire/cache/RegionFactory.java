...
public class RegionFactory<K, V> {
     ...
     *
     * @param distributedSystemProperties properties used to either find or create a DistributedSystem.
     ...
     *
     * @param distributedSystemProperties properties used to either find or create a DistributedSystem.
     * @param regionAttributesId          the identifier for set of RegionAttributes in the cache.xml file
...
//    this.attrsFactory.setPublisher(v);
     ...
     * @return a reference to this RegionFactory object
     * @throws IllegalArgumentException if <code>valueConstraint</code> is a class denoting a primitive
     *                                  type
     ...
     * @throws IllegalStateException if the supplied RegionAttributes are incompatible with this region
