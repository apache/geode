...
public interface LoaderHelper<K, V> {
     ...
     *
     * @param doNetLoad if true, and there is no valid value found for this entry
     ...
     * @throws CacheLoaderException If <code>netSearch</code> is attempted on a {@linkplain
