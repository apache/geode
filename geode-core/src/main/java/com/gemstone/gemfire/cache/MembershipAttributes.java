...
public class MembershipAttributes implements DataSerializable, Externalizable {
     ...
     *
     * @param requiredRoles array of role names required by this process for reliable access to
     *                      the region
     ...
     * @param requiredRoles    array of role names required by this process for reliable access to
     *                         the region
     * @param lossAction       the configuration defining how this process behaves when there are
     *                         missing required roles
     * @param resumptionAction the action to take when missing required roles return to the system
     * @throws IllegalArgumentException if the resumptionAction is incompatible with the lossAction
