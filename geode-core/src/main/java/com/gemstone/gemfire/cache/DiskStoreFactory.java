...
public interface DiskStoreFactory {
     ...
     *
     * @param compactionThreshold percentage of remaining live data in the oplog at which an oplog
     *                            is compactable
     * @return a reference to <code>this</code>
     */
     ...
     *
     * @param queueSize number of operations that can be asynchronously queued. If 0, the
