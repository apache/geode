...
public interface ClientSession {
     ...
     * @param policy        The {@link com.gemstone.gemfire.cache.InterestResultPolicy}. Note:
     ...
     *                      pushed to the client.
     * @param isDurable     Whether the interest is durable
     * @param receiveValues Whether to receive create or update events as invalidates similar
