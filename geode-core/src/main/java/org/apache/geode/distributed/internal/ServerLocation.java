...
public class ServerLocation implements DataSerializable, Comparable, SerializationVersions {
  ...
  public void fromData(DataInput in) throws IOException, ClassNotFoundException {
    fromDataPre_GEODE_1_11_0_0(in);
    Version senderVersion = StaticSerialization.getVersionForDataStreamOrNull(in);
    if (senderVersion.compareTo(Version.GEODE_1_11_0) > 0) {
  ...
  public void toData(DataOutput out) throws IOException {
    toDataPre_GEODE_1_11_0_0(out);
    DataSerializer.writeString(memberId, out);
  }

  public Version[] getSerializationVersions() {
    return new Version[] {Version.GEODE_1_11_0};
  }

  public void fromDataPre_GEODE_1_11_0_0(DataInput in) throws IOException, ClassNotFoundException {
    hostName = DataSerializer.readString(in);
    port = in.readInt();
    memberId = "";
  }

  public void toDataPre_GEODE_1_11_0_0(DataOutput out) throws IOException {
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + port + memberId.hashCode();
    return result;
  }
