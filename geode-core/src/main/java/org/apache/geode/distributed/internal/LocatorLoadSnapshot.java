...
public class LocatorLoadSnapshot {
  ...
  synchronized List<ServerLocation> getServersForQueue(ClientProxyMembershipID id, String group,
    ...
    {
      List<LoadHolder> bestLHs = findBestServers2(groupServers, excludedServers, count);
   ...
   */
  private List<LoadHolder> findBestServers(Map<ServerLocationAndMemberId, LoadHolder> groupServers,
      Set<ServerLocation> excludedServers, int count) {
  ...
  private List<LoadHolder> findBestServers2(Map<ServerLocation, LoadHolder> groupServers,
      Set<ServerLocation> excludedServers, int count) {
