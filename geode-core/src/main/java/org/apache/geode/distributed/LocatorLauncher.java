...
public class LocatorLauncher extends AbstractLauncher<String> {
   ...
   *
   * @param args the command-line arguments used to configure the Locator at runtime.
   */
  ...
  /**
   * Gets the instance of the LocatorLauncher used to launch the Locator, or null if this VM
   * does not have an instance of LocatorLauncher indicating no Locator is running.
   *
   * @return the instance of LocatorLauncher used to launcher a Locator in this VM.
   */
