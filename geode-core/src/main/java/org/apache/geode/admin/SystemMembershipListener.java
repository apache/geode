...
public interface SystemMembershipListener {
   ...
   *
   * @param event the triggering {@link SystemMembershipEvent}
   */
   ...
   * is forcibly removed from the distributed system by another process, such as from
   * <a href=../distributed/DistributedSystem.html#member-timeout> failure detection</a>, or
   * <a href=../distributed/DistributedSystem.html#enable-network-partition-detection> network
