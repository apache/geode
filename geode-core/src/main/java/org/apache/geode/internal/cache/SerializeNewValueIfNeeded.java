...
class SerializeNewValueIfNeeded {

  private static final String ENABLE_PROPERTY = GEMFIRE_PREFIX + "enableSerializeNewValueIfNeeded";

  private final boolean enabled = true || Boolean.getBoolean(ENABLE_PROPERTY);
