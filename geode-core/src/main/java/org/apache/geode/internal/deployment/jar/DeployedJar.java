...
public class DeployedJar {
  ...
  public String getDeployedFileName() {
    String fileBaseName = DeployJarFileUtils.getDeployedFileBaseName(file.getName());
  ...
  public int getVersion() {
    return DeployJarFileUtils.extractVersionFromFilename(this.file.getName());
  }
  ...
  public DeployedJar(File versionedJarFile) {
    String artifactId = DeployJarFileUtils.getArtifactIdForSequencedJar(versionedJarFile.getName());

    this.file = versionedJarFile;
    this.artifactId = artifactId;

    if (!DeployJarFileUtils.hasValidJarContent(versionedJarFile)) {
   ...
   */
  public boolean hasSameContentAs(final File stagedFile) {
