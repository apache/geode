...
public class DefaultSecurityServiceFactory implements SecurityServiceFactory {

  public DefaultSecurityServiceFactory() {}
  ...
  @Override
  public SecurityService create(Properties securityProps) {
    return create(securityProps, null, null);
  }

  @Override
  public SecurityService create(Properties securityProps, CacheConfig cacheConfig) {
    if (cacheConfig == null) {
      return create(securityProps, null, null);
    }
