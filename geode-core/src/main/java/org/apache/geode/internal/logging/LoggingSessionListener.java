 ...
 * session:
 * <ul>
 * <li>{@code PausableConsoleAppender} pauses so that logging stops going to STDOUT.
 * <li>{@code PausableLogWriterAppender}s (main log and security log) resume so that logging starts
 * going to the Geode log files.
 * </ul>
 * Appender actions in response to stopping a session:
 * <ul>
 * <li>{@code PausableConsoleAppender} resumes so that logging resumes going to STDOUT.
 * <li>{@code PausableLogWriterAppender}s (main log and security log) pause so that logging stops
 * going to the Geode log files.
 * </ul>
 */
