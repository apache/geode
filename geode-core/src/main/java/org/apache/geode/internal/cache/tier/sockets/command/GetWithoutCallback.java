...
public class GetWithoutCallback extends AbstractGet {

  @Immutable
  private static final GetWithoutCallback singleton = new GetWithoutCallback();
  ...
  protected void processRequest(final @NotNull Message request,
    ...
    processGetRequest(request, serverConnection, securityService, stats, startTime,
        stepStartTime, regionName, key, null);
  }
