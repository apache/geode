...
public class ServerConnectionFactory {
  ...
  ServerConnection makeServerConnection(final Socket socket, final InternalCache cache,
      ...
      final GatewayReceiverMetrics gatewayReceiverMetrics, final SecurityService securityService)
      throws IOException {
  ...
  private ServerConnection createProtobufServerConnection(final Socket socket,
      ...
      final SecurityService securityService, final GatewayReceiverMetrics gatewayReceiverMetrics)
      throws IOException {
    ...
    return new ProtobufServerConnection(socket, cache, cachedRegionHelper, stats, hsTimeout,
        ...
        securityService, gatewayReceiverMetrics);
  }
}
