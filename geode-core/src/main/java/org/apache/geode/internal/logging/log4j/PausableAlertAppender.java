...
@Plugin(name = PausableAlertAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME,
    elementType = Appender.ELEMENT_TYPE, printObject = true)
@SuppressWarnings("unused")
public class PausableAlertAppender extends AbstractAppender
  ...
  private static final AtomicReference<PausableAlertAppender> instanceRef = new AtomicReference<>();
  ...
  protected PausableAlertAppender(final String name,
  ...
  public static <B extends PausableAlertAppender.Builder<B>> B newBuilder() {
    return new PausableAlertAppender.Builder<B>().asBuilder();
  }

  /**
   * Builds PausableAlertAppender instances.
   *
   * @param <B> The type to build
   */
  public static class Builder<B extends Builder<B>> extends AbstractAppender.Builder<B>
      implements org.apache.logging.log4j.core.util.Builder<PausableAlertAppender> {
    ...
    @Override
    public PausableAlertAppender build() {
      Layout<? extends Serializable> layout = getOrCreateLayout();
      instanceRef.set(new PausableAlertAppender(getName(), layout, getFilter(),
  ...
  public static PausableAlertAppender getInstance() {
    return instanceRef.get();
  }
}
