 ...
 *
 */
public class DefaultResultCollector<T> implements ResultCollector<T, List<T>> {
   ...
   */
  @Override
  public List<T> getResult() throws FunctionException {
   ...
   */
  @Override
  public List<T> getResult(long timeout, TimeUnit unit) throws FunctionException {
    return resultList;
  }
