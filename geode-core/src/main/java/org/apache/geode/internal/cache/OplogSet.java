...
public interface OplogSet {
  ...
  void create(LocalRegion region, DiskEntry entry, ValueWrapper value, boolean async);

  void modify(LocalRegion region, DiskEntry entry, ValueWrapper value, boolean async);
