...
public interface PersistentMemberView {
   ...
   * distribution so that if we crash during distribution, we can recover and complete the destroy.
   ...
   * bucket and become a proxy bucket. This method will be called before distribution so that if we
