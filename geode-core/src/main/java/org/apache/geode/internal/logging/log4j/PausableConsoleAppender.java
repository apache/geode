 ...
 */
@Plugin(name = PausableConsoleAppender.PLUGIN_NAME, category = Core.CATEGORY_NAME,
    elementType = Appender.ELEMENT_TYPE, printObject = true)
@SuppressWarnings("unused")
public class PausableConsoleAppender extends AbstractOutputStreamAppender<OutputStreamManager>
  ...
  private static final PausableConsoleManagerFactory MANAGER_FACTORY =
      new PausableConsoleManagerFactory();
  ...
  protected PausableConsoleAppender(final String name,
  ...
  public static PausableConsoleAppender createDefaultAppenderForLayout(
      final Layout<? extends Serializable> layout) {
    // this method cannot use the builder class without introducing an infinite loop due to
    // DefaultConfiguration
    return new PausableConsoleAppender(PLUGIN_NAME + "-" + COUNT.incrementAndGet(), layout, null,
  ...
  /**
   * Builds PausableConsoleAppender instances.
   *
   * @param <B> The type to build
   */
  public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
      implements org.apache.logging.log4j.core.util.Builder<PausableConsoleAppender> {
    ...
    @Override
    public PausableConsoleAppender build() {
      ...
      return new PausableConsoleAppender(getName(), layout,
  ...
  private static class PausableConsoleManagerFactory implements
