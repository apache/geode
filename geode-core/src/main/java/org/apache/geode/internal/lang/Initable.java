...
public interface Initable {
  ...
  /**
   * Called to perform additional initialization logic after construction of the Object instance.
   * This is necessary in certain cases to prevent escape of the "this" reference during
