...
public class LocalizedStrings {
  ...
  public static final StringId Launcher_Builder_MEMBER_NAME_VALIDATION_ERROR_MESSAGE = new StringId(5240, "The member name of the {0} must be provided as an argument to the launcher, or a path to geode.properties must be specified, which assumes the {0} member name will be set using the \"name\" property.");
