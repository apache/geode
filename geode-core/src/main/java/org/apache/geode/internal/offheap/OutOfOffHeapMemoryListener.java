 ...
 *
 * The implementation created by OffHeapStorage for a real DistribytedSystem connection causes the
 * System and Cache to close in order to avoid data inconsistency.
 *
 * @since Geode 1.0
 */
