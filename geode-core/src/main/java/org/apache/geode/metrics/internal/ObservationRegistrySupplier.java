...
public class ObservationRegistrySupplier implements Supplier<ObservationRegistry> {

  private final Supplier<InternalDistributedSystem> internalDistributedSystemSupplier;

  public ObservationRegistrySupplier(
  ...
  public ObservationRegistry get() {
    ...
    return internalCache.getObservationRegistry();
  }
}
