...
public class ClusterRegionConfigPersister extends ConfigurationPersister<ClusterRegionConfig> {

  public ClusterRegionConfigPersister(ClusterRegionConfig config) {
    super(config);
  }

  @Override
  public void addTo(CacheConfig existing) {
    existing.getRegions().add(config);
  }
}
