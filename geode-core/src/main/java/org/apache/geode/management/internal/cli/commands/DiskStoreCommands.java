...
public class DiskStoreCommands extends AbstractCommandsSupport {
  ...
  public Result createDiskStore(
      ...
      @CliOption(key = CliStrings.GROUP, help = CliStrings.CREATE_DISK_STORE__GROUP__HELP,
  ...
  public Result destroyDiskStore(
      ...
      @CliOption(key = CliStrings.GROUP, help = CliStrings.DESTROY_DISK_STORE__GROUP__HELP,
          optionContext = ConverterHint.MEMBERGROUP) String[] groups) {
    try {
      TabularResultData tabularData = ResultBuilder.createTabularResultData();
      boolean accumulatedData = false;
