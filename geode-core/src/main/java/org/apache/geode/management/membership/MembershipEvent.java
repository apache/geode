...
/**
 * An event that describes the member that originated this event. Instances of this are delivered to
 * a {@link MembershipListener} when a member has joined or left the distributed system.
 *
 * @since GemFire 8.0
 */
