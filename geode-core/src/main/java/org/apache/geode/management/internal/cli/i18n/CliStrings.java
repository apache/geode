...
public class CliStrings {
  ...
  public static final String RESUME_ASYNCEVENTQUEUE__HELP =
      "Resume the Async Event Queue on a member or members.";
  ...
  public static final String RESUME_ASYNCEVENTQUEUE__GROUP__HELP =
      "Group(s) of members on which to resume the Async Event Queue.";
  public static final String RESUME_ASYNCEVENTQUEUE__MEMBER__HELP =
      "Name/Id of the member on which to resume the Async Event Queue.";
