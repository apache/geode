...
public class CliStrings {
  ...
  public static final String STATUS_LOCATOR__NO_LOCATOR_SPECIFIED_ERROR_MESSAGE =
      "Unable to determine the status of Locator on %1$s running in %2$s. At least one of the following must be specified: --name, --port, or --host.\nUse 'help status locator' to display detailed usage information.";
  ...
  public static final String STATUS_SERVER__NO_SERVER_SPECIFIED_ERROR_MESSAGE =
      "Unable to determine the status of Geode Cache server on %1$s. At least one of the following must be specified: --name, --dir, or --pid.\nUse 'help status server' to display detailed usage information.";
