...
public interface SecurityManager {
   ...
   * @throw AuthenticationFailedException if the credentials are invalid, this exception will be
   *        seen by the client.
   * @throw AuthenticationExpiredException if credentials have expired, this will give the
