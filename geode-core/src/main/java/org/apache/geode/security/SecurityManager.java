...
public interface SecurityManager {
   ...
   * @throws AuthenticationFailedException if the credentials are invalid, this exception will be
   *         seen by the client.
   * @throws AuthenticationExpiredException if credentials have expired, this will give the
   *         client a second chance to gather new credentials and try login again once more.
   */
