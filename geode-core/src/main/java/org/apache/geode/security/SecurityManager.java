...
public interface SecurityManager {
  ...
  /**
   * property name of the common name passed in the Properties in authenticate method
   */
  String COMMON_NAME = "security-common-name";
   ...
   *
   * if a channel supports common-name authentication/authorization then common name will be passed
   * to the security manager in the property with the key "security-common-name".
   *
   * @param credentials it contains the security-username, security-password or security-token,
   *        security-common-name as keys of the properties, also the properties generated by your
