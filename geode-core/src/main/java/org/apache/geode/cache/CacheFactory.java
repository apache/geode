...
public class CacheFactory {
  ...
  private final InternalCacheFactory internalCacheFactory;
  ...
  public CacheFactory(Properties props) {
    internalCacheFactory = new InternalCacheFactory(props);
  }
  ...
  public Cache create()
    ...
    return internalCacheFactory.create();
  }
  ...
  public CacheFactory set(String name, String value) {
    internalCacheFactory.set(name, value);
    return this;
  }
  ...
  public CacheFactory setPdxReadSerialized(boolean readSerialized) {
    internalCacheFactory.setPdxReadSerialized(readSerialized);
    return this;
  }
  ...
  public CacheFactory setSecurityManager(SecurityManager securityManager) {
    internalCacheFactory.setSecurityManager(securityManager);
    return this;
  }
  ...
  public CacheFactory setPostProcessor(PostProcessor postProcessor) {
    internalCacheFactory.setPostProcessor(postProcessor);
    return this;
  }
  ...
  public CacheFactory setPdxSerializer(PdxSerializer serializer) {
    internalCacheFactory.setPdxSerializer(serializer);
    return this;
  }
  ...
  public CacheFactory setPdxDiskStore(String diskStoreName) {
    internalCacheFactory.setPdxDiskStore(diskStoreName);
    return this;
  }
  ...
  public CacheFactory setPdxPersistent(boolean isPersistent) {
    internalCacheFactory.setPdxPersistent(isPersistent);
    return this;
  }
  ...
  public CacheFactory setPdxIgnoreUnreadFields(boolean ignore) {
    internalCacheFactory.setPdxIgnoreUnreadFields(ignore);
    return this;
  }
