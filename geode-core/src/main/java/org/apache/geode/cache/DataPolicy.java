 ...
 *
 * @since GemFire 5.0
 * @deprecated Use {@link org.apache.geode.cache.api.DataPolicy}.
 */
@Deprecated
@Immutable
public class DataPolicy implements java.io.Serializable {
  ...
  public static DataPolicy fromEnum(org.apache.geode.cache.api.DataPolicy dataPolicy) {
    return VALUES[dataPolicy.ordinal()];
  }

  public org.apache.geode.cache.api.DataPolicy toEnum() {
    return org.apache.geode.cache.api.DataPolicy.fromOrdinal(ordinal);
  }
}
