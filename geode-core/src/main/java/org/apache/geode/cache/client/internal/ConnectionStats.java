...
public class ConnectionStats implements MessageStats {
    ...
    try {
      ...
      type = f.createType("ClientStats", "Statistics about client to server communication",
          new StatisticDescriptor[] {
              ///////////////////////////////////////////////////////////////////////
              /*
               * f.createLongGauge("opsInProgress", "Current number of ops being executed", "ops"),
               * f.createLongCounter("ops", "Total number of ops completed successfully", "ops"),
               * f.createLongCounter("opFailures", "Total number of op attempts that have failed",
               * "ops"), f.createLongCounter("opTimeouts",
      ...
      sendType = f.createType("ClientSendStats", "Statistics about client to server communication",
          new StatisticDescriptor[] {
              ///////////////////////////////////////////////////////////////////////
              /*
               * f.createLongGauge("opSendsInProgress", "Current number of op sends being executed",
               * "sends"), f.createLongCounter("opSends",
               * "Total number of op sends that have completed successfully", "sends"),
               * f.createLongCounter("opSendFailures", "Total number of op sends that have failed",
              ...
              f.createLongCounter("commitSends", "Total number of commit sends that have failed",
                  "sends"),
              ...
              f.createLongCounter("sizeSendFailures", "Total number of size sends that have failed",
                  "sends"),
              f.createLongCounter("sizeSends", "Total number of size sends that have failed",
                  "sends"),
              ...
              f.createLongCounter("gatewayBatchSendTime",
                  ...
                  "nanoseconds"),
              f.createLongGauge("getDurableCQsSendsInProgressId",
              ...
              f.createLongGauge("asyncExecuteFunctionSendsInProgress",
                  "Current number of Function sends being executed asynchronously", "sends"),
              f.createLongCounter("asyncExecuteFunctionSends",
                  "Total number of asynchronous Function sends that have completed successfully",
                  "sends"),
              f.createLongCounter("asyncExecuteFunctionSendFailures",
  ...
  public int getGets() {
    return (int) this.stats.getLong(getId);
  }
  ...
  public int getPuts() {
    return (int) this.stats.getLong(putId);
  }
  ...
  public int getConnections() {
    return (int) this.stats.getLong(connectionsId);
  }

  public int getOps() {
    int ops = 0;
    for (int i = 0; i < opIds.length; i++) {
      ops += (int) this.stats.getLong(i);
    }
    return ops;
  }
  ...
  public int getGetDurableCqs() {
    return (int) this.stats.getLong(getDurableCQsId);
  }
