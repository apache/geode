...
public class SingleHopClientExecutorImpl implements SingleHopClientExecutor {
  ...
  @Override
  public void submitAll(List callableTasks) {
  ...
  @Override
  public int submitAllHA(List callableTasks, LocalRegion region, boolean isHA,
   ...
   */
  @Override
  public Map<ServerLocation, Object> submitBulkOp(List callableTasks, ClientMetadataService cms,
      LocalRegion region,
  ...
  @Override
  public Map<ServerLocation, Object> submitGetAll(Map<ServerLocation, HashSet> serverToFilterMap,
