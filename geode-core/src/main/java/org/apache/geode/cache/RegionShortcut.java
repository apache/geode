...
public enum RegionShortcut {
   ...
   */
  PARTITION(DataPolicy.PARTITION),
  /**
   ...
   */
  PARTITION_REDUNDANT(DataPolicy.PARTITION),
  /**
   ...
   */
  PARTITION_PERSISTENT(DataPolicy.PERSISTENT_PARTITION),
  /**
   ...
   */
  PARTITION_REDUNDANT_PERSISTENT(DataPolicy.PERSISTENT_PARTITION),
  /**
   ...
   */
  PARTITION_OVERFLOW(DataPolicy.PARTITION),
  /**
   ...
   */
  PARTITION_REDUNDANT_OVERFLOW(DataPolicy.PARTITION),
  /**
   ...
   * {@link EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#OVERFLOW_TO_DISK}.
   */
  PARTITION_PERSISTENT_OVERFLOW(DataPolicy.PERSISTENT_PARTITION),
  /**
   ...
   */
  PARTITION_REDUNDANT_PERSISTENT_OVERFLOW(DataPolicy.PERSISTENT_PARTITION),
  /**
   ...
   */
  PARTITION_HEAP_LRU(DataPolicy.PARTITION),
  /**
   ...
   */
  PARTITION_REDUNDANT_HEAP_LRU(DataPolicy.PARTITION),
   ...
   */
  REPLICATE(DataPolicy.REPLICATE),
  /**
   ...
   */
  REPLICATE_PERSISTENT(DataPolicy.PERSISTENT_REPLICATE),
   ...
   * {@link EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#OVERFLOW_TO_DISK}.
   */
  REPLICATE_OVERFLOW(DataPolicy.REPLICATE),
  /**
   ...
   * {@link EvictionAction#OVERFLOW_TO_DISK}.
   */
  REPLICATE_PERSISTENT_OVERFLOW(DataPolicy.PERSISTENT_REPLICATE),
  /**
   ...
   */
  REPLICATE_HEAP_LRU(DataPolicy.PRELOADED),
   ...
   */
  LOCAL_PERSISTENT(DataPolicy.PERSISTENT_REPLICATE),
   ...
   * {@link EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#LOCAL_DESTROY}.
   */
  LOCAL_HEAP_LRU(DataPolicy.NORMAL),
  /**
   ...
   * {@link EvictionAlgorithm#LRU_HEAP} with {@link EvictionAction#OVERFLOW_TO_DISK}.
   */
  LOCAL_OVERFLOW(DataPolicy.NORMAL),
  /**
   ...
   */
  LOCAL_PERSISTENT_OVERFLOW(DataPolicy.PERSISTENT_REPLICATE),
   ...
   */
  PARTITION_PROXY(DataPolicy.PARTITION),
  /**
   ...
   */
  PARTITION_PROXY_REDUNDANT(DataPolicy.PARTITION),
  /**
   ...
   * {@link Scope#DISTRIBUTED_ACK}.
   */
  REPLICATE_PROXY(DataPolicy.EMPTY);

  private DataPolicy dataPolicy;

  RegionShortcut(DataPolicy dataPolicy) {
