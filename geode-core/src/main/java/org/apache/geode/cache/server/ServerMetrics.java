...
public interface ServerMetrics {
   ...
   *
   * @return the number of open connections for this cache server
   */
   ...
   *
   * @return the number of clients connected to this cache server
   */
  int getClientCount();
   ...
   *
   * @return the number of client subscription connections hosted on this cache server
   */
   ...
   *
   * @return the max connections for this cache server
   */
