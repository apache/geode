...
public class OQLParser extends org.apache.geode.cache.query.internal.parse.UtilParser
...

    {
      switch (LA(1)) {
        ...
        case RegionPath: {
          ...
          tmp136_AST = (org.apache.geode.cache.query.internal.parse.ASTRegionPath) astFactory
              .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTRegionPath");
  ...
  public final void index() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      index_AST =
          (AST) astFactory
              .make((new ASTArray(2))
                  .add((AST) astFactory.create(TOK_LBRACK, "index",
                      "org.apache.geode.cache.query.internal.parse.ASTCombination"))
                  .add(index_AST));
  ...
  public final void methodInvocation(boolean implicitReceiver)
    ...
    if (inputState.guessing == 0) {
      ...
      methodInvocation_AST = (AST) astFactory.make((new ASTArray(3))
          .add((AST) astFactory.create(METHOD_INV, "methodInv",
              "org.apache.geode.cache.query.internal.parse.ASTMethodInvocation"))
          .add(methodName_AST).add(args_AST));
      ((ASTMethodInvocation) methodInvocation_AST).setImplicitReceiver(implicitReceiver);
      currentAST.root = methodInvocation_AST;
      currentAST.child =
          methodInvocation_AST != null && methodInvocation_AST.getFirstChild() != null
  ...
  public final void argList() throws RecognitionException, TokenStreamException {
    ...
    t = LT(1);
    t_AST = (org.apache.geode.cache.query.internal.parse.ASTCombination) astFactory.create(t,
        "org.apache.geode.cache.query.internal.parse.ASTCombination");
        ...
        case LITERAL_flatten: {
          {
            switch (LA(1)) {
              ...
              case LITERAL_element: {
                ...
                tmp143_AST =
                    (org.apache.geode.cache.query.internal.parse.ASTConversionExpr) astFactory
                        .create(LT(1),
          ...
          {
            {
              ...
              tmp148_AST =
                  (org.apache.geode.cache.query.internal.parse.ASTConversionExpr) astFactory.create(
                      LT(1), "org.apache.geode.cache.query.internal.parse.ASTConversionExpr");
  ...
  public final void undefinedExpr() throws RecognitionException, TokenStreamException {
...

    {
      if ((LA(1) == LITERAL_is_undefined)) {
        ...
        tmp162_AST = (org.apache.geode.cache.query.internal.parse.ASTUndefinedExpr) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTUndefinedExpr");
        ...
        tmp163_AST = (org.apache.geode.cache.query.internal.parse.ASTUndefinedExpr) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTUndefinedExpr");
      ...
      if (((LA(1) >= LITERAL_array && LA(1) <= LITERAL_bag))) {
        {
          switch (LA(1)) {
            ...
            case LITERAL_set: {
              ...
              tmp171_AST = (org.apache.geode.cache.query.internal.parse.ASTConstruction) astFactory
                  .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTConstruction");
  ...
  public final void stringLiteral() throws RecognitionException, TokenStreamException {
    ...
    tmp178_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory.create(LT(1),
  ...
  public final void fieldList() throws RecognitionException, TokenStreamException {
    ...
    if (inputState.guessing == 0) {
      ...
      fieldList_AST =
          (AST) astFactory.make((new ASTArray(2))
              .add((AST) astFactory.create(COMBO, "fieldList",
                  "org.apache.geode.cache.query.internal.parse.ASTCombination"))
              .add(fieldList_AST));
  ...
  public final void objectLiteral() throws RecognitionException, TokenStreamException {
    ...
    switch (LA(1)) {
      case LITERAL_nil: {
        ...
        tmp182_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
      ...
      case LITERAL_null: {
        ...
        tmp183_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
      ...
      case LITERAL_undefined: {
        ...
        tmp184_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public final void booleanLiteral() throws RecognitionException, TokenStreamException {
...

    {
      if ((LA(1) == LITERAL_true)) {
        ...
        tmp185_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
        astFactory.addASTChild(currentAST, tmp185_AST);
        match(LITERAL_true);
      } else if ((LA(1) == LITERAL_false)) {
        org.apache.geode.cache.query.internal.parse.ASTLiteral tmp186_AST = null;
        tmp186_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
            .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
...

    {
      switch (LA(1)) {
        case NUM_INT: {
          ...
          tmp187_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
              .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
        ...
        case NUM_LONG: {
          ...
          tmp188_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
              .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
        ...
        case NUM_FLOAT: {
          ...
          tmp189_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
              .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
        ...
        case NUM_DOUBLE: {
          ...
          tmp190_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory
              .create(LT(1), "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public final void charLiteral() throws RecognitionException, TokenStreamException {
    ...
    tmp191_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory.create(LT(1),
        "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public final void dateLiteral() throws RecognitionException, TokenStreamException {
    ...
    tmp193_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory.create(LT(1),
        "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public final void timeLiteral() throws RecognitionException, TokenStreamException {
    ...
    tmp195_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory.create(LT(1),
        "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public final void timestampLiteral() throws RecognitionException, TokenStreamException {
    ...
    tmp197_AST = (org.apache.geode.cache.query.internal.parse.ASTLiteral) astFactory.create(LT(1),
        "org.apache.geode.cache.query.internal.parse.ASTLiteral");
  ...
  public static final String[] _tokenNames = {"<0>", "EOF", "<2>", "NULL_TREE_LOOKAHEAD",
      "TOK_RPAREN", "TOK_LPAREN", "TOK_COMMA", "TOK_SEMIC", "TOK_DOTDOT", "TOK_COLON", "TOK_DOT",
      "TOK_INDIRECT", "TOK_CONCAT", "TOK_EQ", "TOK_PLUS", "TOK_MINUS", "TOK_SLASH", "TOK_STAR",
      "TOK_LE", "TOK_GE", "TOK_NE", "TOK_NE_ALT", "TOK_LT", "TOK_GT", "TOK_LBRACK", "TOK_RBRACK",
      "TOK_DOLLAR", "LETTER", "DIGIT", "ALL_UNICODE", "NameFirstCharacter", "NameCharacter",
      "RegionNameCharacter", "QuotedIdentifier", "Identifier", "RegionPath", "NUM_INT", "EXPONENT",
      "FLOAT_SUFFIX", "HEX_DIGIT", "QUOTE", "StringLiteral", "WS", "SL_COMMENT", "ML_COMMENT",
      "QUERY_PROGRAM", "QUALIFIED_NAME", "QUERY_PARAM", "ITERATOR_DEF", "PROJECTION_ATTRS",
      "PROJECTION", "TYPECAST", "COMBO", "METHOD_INV", "POSTFIX", "OBJ_CONSTRUCTOR", "IMPORTS",
      "SORT_CRITERION", "LIMIT", "HINT", "AGG_FUNC", "SUM", "AVG", "COUNT", "MAX", "MIN",
      "\"trace\"", "\"import\"", "\"as\"", "\"declare\"", "\"define\"", "\"query\"", "\"undefine\"",
      "\"select\"", "\"distinct\"", "\"all\"", "\"from\"", "\"in\"", "\"type\"", "\"where\"",
      "\"limit\"", "\"group\"", "\"by\"", "\"having\"", "\"hint\"", "\"order\"", "\"asc\"",
      "\"desc\"", "\"or\"", "\"orelse\"", "\"and\"", "\"for\"", "\"exists\"", "\"andthen\"",
      "\"any\"", "\"some\"", "\"like\"", "\"union\"", "\"except\"", "\"mod\"", "\"intersect\"",
      "\"abs\"", "\"not\"", "\"listtoset\"", "\"element\"", "\"flatten\"", "\"nvl\"", "\"to_date\"",
      "\"first\"", "\"last\"", "\"unique\"", "\"sum\"", "\"avg\"", "\"min\"", "\"max\"",
      "\"count\"", "\"is_undefined\"", "\"is_defined\"", "\"struct\"", "\"array\"", "\"set\"",
      "\"bag\"", "\"list\"", "\"short\"", "\"long\"", "\"int\"", "\"float\"", "\"double\"",
      "\"char\"", "\"string\"", "\"boolean\"", "\"byte\"", "\"octet\"", "\"enum\"", "\"date\"",
      "\"time\"", "\"interval\"", "\"timestamp\"", "\"collection\"", "\"dictionary\"", "\"map\"",
      "\"nil\"", "\"null\"", "\"undefined\"", "\"true\"", "\"false\"", "NUM_LONG", "NUM_FLOAT",
      "NUM_DOUBLE"};
