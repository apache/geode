...
public class GemFireVersionJUnitTest {
  ...
  public void testNoFile() {
    ...
    VersionDescription noVersion = new VersionDescription(noFile, new ServiceLoaderModuleService(
  ...
  public void testNoFileGetProperty() {
    String noFile = "not a property file";
    VersionDescription noVersion =
        new VersionDescription(noFile, new ServiceLoaderModuleService(LogManager.getLogger()));
