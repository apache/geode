...
public class CloseDurableCQsCommand extends GfshCommand {
  ...
  @ShellMethod(value = CliStrings.CLOSE_DURABLE_CQS__HELP, key = CliStrings.CLOSE_DURABLE_CQS)
  @CliMetaData()
