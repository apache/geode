...
public class ResumeGatewaySenderCommand extends GfshCommand {
  ...
  @ShellMethod(value = CliStrings.RESUME_GATEWAYSENDER__HELP, key = CliStrings.RESUME_GATEWAYSENDER)
  @CliMetaData(relatedTopic = CliStrings.TOPIC_GEODE_WAN)
  @ResourceOperation(resource = ResourcePermission.Resource.CLUSTER,
      operation = ResourcePermission.Operation.MANAGE, target = ResourcePermission.Target.GATEWAY)
  public ResultModel resumeGatewaySender(@ShellOption(value = CliStrings.RESUME_GATEWAYSENDER__ID,
