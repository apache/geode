...
public class CompactOfflineDiskStoreCommand extends GfshCommand {
  @ShellMethod(value = CliStrings.COMPACT_OFFLINE_DISK_STORE__HELP,
      key = CliStrings.COMPACT_OFFLINE_DISK_STORE)
  @CliMetaData(shellOnly = true, relatedTopic = CliStrings.TOPIC_GEODE_DISKSTORE)
  public ResultModel compactOfflineDiskStore(
      @ShellOption(value = CliStrings.COMPACT_OFFLINE_DISK_STORE__NAME,
          help = CliStrings.COMPACT_OFFLINE_DISK_STORE__NAME__HELP) String diskStoreName,
      @ShellOption(value = CliStrings.COMPACT_OFFLINE_DISK_STORE__DISKDIRS,
          help = CliStrings.COMPACT_OFFLINE_DISK_STORE__DISKDIRS__HELP) String[] diskDirs,
      @ShellOption(value = CliStrings.COMPACT_OFFLINE_DISK_STORE__MAXOPLOGSIZE,
          defaultValue = "-1",
          help = CliStrings.COMPACT_OFFLINE_DISK_STORE__MAXOPLOGSIZE__HELP) long maxOplogSize,
      @ShellOption(value = CliStrings.COMPACT_OFFLINE_DISK_STORE__J,
