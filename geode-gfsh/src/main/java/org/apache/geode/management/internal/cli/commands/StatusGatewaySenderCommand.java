...
public class StatusGatewaySenderCommand extends GfshCommand {
  @ShellMethod(value = CliStrings.STATUS_GATEWAYSENDER__HELP, key = CliStrings.STATUS_GATEWAYSENDER)
  @CliMetaData(relatedTopic = CliStrings.TOPIC_GEODE_WAN)
  @ResourceOperation(resource = ResourcePermission.Resource.CLUSTER,
      operation = ResourcePermission.Operation.READ)
  public ResultModel statusGatewaySender(@ShellOption(value = CliStrings.STATUS_GATEWAYSENDER__ID,
