...
namespace gemfire
{
  ...
  gemfire::TransactionListener* ManagedTransactionListenerGeneric::create( const char* assemblyPath,
  ...
  void ManagedTransactionListenerGeneric::afterCommit(gemfire::TransactionEventPtr& te )
  {
    try {
  ...
  void ManagedTransactionListenerGeneric::afterFailedCommit(gemfire::TransactionEventPtr& te )
  {
    try {
      GemStone::GemFire::Cache::TransactionEvent mevent( te.ptr()  );
  ...
  void ManagedTransactionListenerGeneric::afterRollback(gemfire::TransactionEventPtr& te )
  {
    try {
      GemStone::GemFire::Cache::TransactionEvent mevent( te.ptr()  );
