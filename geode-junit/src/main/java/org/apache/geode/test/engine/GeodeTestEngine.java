 ...
 * where the request specifies a single category of tests to run.</li>
 ...
 * </ul>
 * Even with these limitations, {@code GeodeTestEngine} suffices for Geode's current use in CI.
 * The limitations may cause confusion for developers executing ad hoc test runs.
 */
