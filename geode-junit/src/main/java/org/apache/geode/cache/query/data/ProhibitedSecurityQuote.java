...
public class ProhibitedSecurityQuote implements Serializable {
  ...
  public ProhibitedSecurityQuote(String inputStr) {
    ...
    prohibited_security_quote_id =
        Integer.parseInt(tempArr[i++].replaceAll("\"", " ").trim());// INTEGER
    ...
    lower_qty = Integer.parseInt(tempArr[i++].replaceAll("\"", " ").trim());// INTEGER
    upper_qty = Integer.parseInt(tempArr[i++].replaceAll("\"", " ").trim());// INTEGER
