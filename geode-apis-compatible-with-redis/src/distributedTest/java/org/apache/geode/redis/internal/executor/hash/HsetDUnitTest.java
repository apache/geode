...
public class HsetDUnitTest {
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingSameDataToSameHashConcurrently() {
    ...
    Consumer<Integer> hsetJedis1Consumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
    Consumer<Integer> hsetJedis2Consumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingToDifferentHashesConcurrently() {
    ...
    Consumer<Integer> hsetJedis1Consumer = makeHSetConsumer(testMap1, testMap1Fields, key1, jedis);
    Consumer<Integer> hsetJedis2Consumer = makeHSetConsumer(testMap2, testMap2Fields, key2, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingSameDataToSameSetConcurrently() {
    ...
    Consumer<Integer> hsetJedis1Consumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
    Consumer<Integer> hsetJedis1BConsumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
    Consumer<Integer> hsetJedis2Consumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
    Consumer<Integer> hsetJedis2BConsumer = makeHSetConsumer(testMap, testMapFields, key, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingDifferentDataToSameSetConcurrently() {
    ...
    Consumer<Integer> consumer1 = makeHSetConsumer(testMap1, testMap1Fields, key, jedis);
    Consumer<Integer> consumer1B = makeHSetConsumer(testMap1, testMap1Fields, key, jedis);
    Consumer<Integer> consumer2 = makeHSetConsumer(testMap2, testMap2Fields, key, jedis);
    Consumer<Integer> consumer2B = makeHSetConsumer(testMap2, testMap2Fields, key, jedis);
