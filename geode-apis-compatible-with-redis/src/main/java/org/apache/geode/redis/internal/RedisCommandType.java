...
public enum RedisCommandType {
  ...
  HSCAN(new HScanExecutor(), SUPPORTED, new Parameter().min(3).odd().flags(readonly, random)),
  ...
  ZSCAN(new ZScanExecutor(), SUPPORTED,
      new Parameter().min(3).odd(ERROR_SYNTAX).flags(readonly, random)),
