...
[3] - Redis accepts 64-bit signed integer for the cursor and COUNT parameters to be represented as an integer for the HSCAN command. This operation is limited to 32-bit integer values.
