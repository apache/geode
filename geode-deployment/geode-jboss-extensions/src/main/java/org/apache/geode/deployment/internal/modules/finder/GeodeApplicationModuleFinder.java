...
public class GeodeApplicationModuleFinder implements ModuleFinder {
  private final Application application;
  private static final String GEODE_CORE_MODULE_NAME = "geode-core";

  public GeodeApplicationModuleFinder(Application application) {
  ...
  public ModuleSpec findModule(String name, ModuleLoader delegateLoader) {
    if (application.getName().equals(name)) {
      ModuleSpec.Builder builder = ModuleSpecUtils.createBuilder(application.getName(), true);
