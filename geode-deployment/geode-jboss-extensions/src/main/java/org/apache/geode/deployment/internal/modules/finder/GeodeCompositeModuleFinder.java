...
public class GeodeCompositeModuleFinder implements ModuleFinder {
   ...
   */
  public void addDependencyToModule(String moduleName, String... modulesToDependOn) {
    ...
    if (moduleSpec != null) {
      moduleSpec = ModuleSpecUtils.addModuleDependencyToSpec(moduleSpec, modulesToDependOn);
