...
package org.apache.geode.internal.protocol.protobuf.acceptance;
...
import static org.apache.geode.internal.protocol.protobuf.MessageUtil.validateGetResponse;
...
import org.apache.geode.internal.protocol.protobuf.MessageUtil;
import org.apache.geode.internal.protocol.protobuf.ProtobufRequestUtilities;
...
import org.apache.geode.internal.protocol.protobuf.serializer.exception.InvalidProtocolMessageException;
...
public class CacheOperationsJUnitTest {
  ...
  private void validateGetAllResponse(Socket socket,
    ...
    for (BasicTypes.Entry result : getAllResponse.getEntriesList()) {
      ...
      } catch (org.apache.geode.internal.protocol.protobuf.serialization.exception.DecodingException e) {
        e.printStackTrace();
      }
      String value = null;
      try {
