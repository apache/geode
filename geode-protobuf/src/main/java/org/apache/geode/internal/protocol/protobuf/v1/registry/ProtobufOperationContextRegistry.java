...
public class ProtobufOperationContextRegistry {
  ...
  private void addContexts() {
    ...
    operationContexts.put(RequestAPICase.EXECUTEFUNCTIONONMEMBERREQUEST,
        new ProtobufOperationContext<>(ClientProtocol.Request::getExecuteFunctionOnMemberRequest,
