 ...
 * {@link Sharable} because no state is kept in this class. State is kept by
 * {@link ByteToMessageDecoder}, it may be worthwhile to look at a different decoder setup as to
 * avoid allocating a decoder for every new connection.
 * <p>
