 ...
 * buildscript {} configuration in the root project's build.gradle. */
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    deps.put("jakarta.activation.version", "2.1.2")
    deps.put("jakarta.transaction.version", "2.0.1")
    deps.put("jakarta.xml.bind.version", "4.0.1")
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      constraints {
        ...
        api(group: 'org.glassfish.jaxb', name: 'jaxb-runtime', version: '3.0.2')
        ...
        api(group: 'org.apache.httpcomponents.core5', name: 'httpcore5-h2', version: '5.2.4')
