...
public class LuceneRegionListener implements RegionListener {
  ...
  public void afterCreate(Region region) {
    if (region.getFullPath().equals(this.regionPath)) {
      ...
      LuceneEventListener luceneEventListener;
      if (aeq != null
          && ((luceneEventListener = (LuceneEventListener) aeq.getAsyncEventListener()) != null)) {
        luceneEventListener.allowProcessingOfEvents();
      }
