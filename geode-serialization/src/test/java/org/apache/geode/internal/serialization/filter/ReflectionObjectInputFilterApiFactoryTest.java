...
public class ReflectionObjectInputFilterApiFactoryTest {

  @Test
  public void createsInstanceOfReflectionObjectInputFilterApi() {
    ObjectInputFilterApiFactory factory = new ReflectionObjectInputFilterApiFactory();

    ObjectInputFilterApi api = factory.createObjectInputFilterApi();

    assertThat(api).isInstanceOf(ReflectionObjectInputFilterApi.class);
  }
  ...
  public void usesJavaIO_inJava9() {
    ...
    ReflectionObjectInputFilterApi api =
        (ReflectionObjectInputFilterApi) factory.createObjectInputFilterApi();
