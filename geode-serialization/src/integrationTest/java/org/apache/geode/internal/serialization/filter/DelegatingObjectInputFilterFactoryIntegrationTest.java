...
import org.apache.geode.internal.serialization.filter.impl.ApiPackage;
...
import org.apache.geode.internal.serialization.filter.impl.ReflectionObjectInputFilterApi;
...
public class DelegatingObjectInputFilterFactoryIntegrationTest {
  ...
  public void createsJava9InputStreamFilter_onJava9orGreater() {
    ...
    // arrange
    DelegatingObjectInputFilterFactory factory = new DelegatingObjectInputFilterFactory(NOOP);

    // act
    ObjectInputFilter objectInputFilter = factory
        .create(config, SANCTIONED_CLASSES);
