 ...
 * the License.
 */
package org.apache.geode.alerting.log4j;
...
import org.apache.geode.alerting.spi.AlertingAction;
...
import org.apache.geode.logging.log4j.DebuggableAppender;
import org.apache.geode.logging.log4j.PausableAppender;
...
public class AlertAppender extends AbstractAppender
  ...
  private void sendAlerts(final LogEvent event) {
    ...
    alertingService.sendAlerts(alertLevel, date, threadName, formattedMessage, stackTrace);
  }
