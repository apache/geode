...
namespace gemfire
{
  namespace pdx_auto_serializer
  {
    ...
    public:
      ...
      virtual void startMethod(const Method::Type type,
                               const std::string& varName, const std::string& methodPrefix);
      ...
      virtual void genMethod(const Method::Type type,
      ...
      virtual void genClassNameMethod(std::map<std::string, std::string>&, const std::string& methodPrefix);
    ...
    protected:
       ...
       */
      virtual std::string getNamespacePrefix(const StringVector&
                                             namespaces) const;
