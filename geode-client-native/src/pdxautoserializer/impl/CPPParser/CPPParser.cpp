...
void CPPParser::declaration_specifiers() {
	ANTLR_USE_NAMESPACE(antlr)RefToken  gfArr = ANTLR_USE_NAMESPACE(antlr)nullToken;
	ANTLR_USE_NAMESPACE(antlr)RefToken  gfArrList = ANTLR_USE_NAMESPACE(antlr)nullToken;
	ANTLR_USE_NAMESPACE(antlr)RefToken  gfArrElem = ANTLR_USE_NAMESPACE(antlr)nullToken;
...
#line 914 "CPP_parser.g"
					tq |= tqGFEXCLUDE; _tq |= tqGFEXCLUDE;
...
#line 915 "CPP_parser.g"
					tq |= tqGFINCLUDE; _tq |= tqGFINCLUDE;
...
#line 3582 "CPPParser.cpp"
									...
									if (((_tokenSet_42.member(LA(1))) && (_tokenSet_7.member(LA(2))))) {
										int _m106 = mark();
...
#line 3711 "CPPParser.cpp"
													...
													if (((LA(1) == LITERAL_inline || LA(1) == OPERATOR) && (_tokenSet_43.member(LA(2))))) {
														int _m115 = mark();
...
void CPPParser::optor() {
	...
	try {      // for error handling
		...
		case LITERAL_new:
		{
			...
			else if ((_tokenSet_64.member(LA(1))) && (_tokenSet_57.member(LA(2)))) {
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
			}
...
#line 6812 "CPPParser.cpp"
		...
		case LPAREN:
		{
			...
			else if ((_tokenSet_69.member(LA(1))) && (_tokenSet_80.member(LA(2)))) {
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
			}
...
#line 7248 "CPPParser.cpp"
					...
					else if ((_tokenSet_44.member(LA(1))) && (_tokenSet_81.member(LA(2)))) {
						id=qualified_id();
						if ( inputState->guessing==0 ) {
		...
		if ((LA(1) == LSQUARE)) {
			...
			for (;;) {
				if ((LA(1) == LSQUARE)) {
					...
					if ( _cnt283>=1 ) { goto _loop283; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
				}
...
#line 7868 "CPPParser.cpp"
		...
		{ // ( ... )*
		for (;;) {
			if (((LA(1) >= LITERAL_const && LA(1) <= LITERAL___volatile__)) && (_tokenSet_83.member(LA(2)))) {
				tq=type_qualifier();
			}
			else {
				goto _loop303;
...
#line 8446 "CPPParser.cpp"
		...
		{
		if (((_tokenSet_12.member(LA(1))) && (_tokenSet_88.member(LA(2))))&&(!((LA(1)==SCOPE) && (LA(2)==STAR||LA(2)==OPERATOR)) &&
				...
				try {
					...
					for (;;) {
						if ((_tokenSet_25.member(LA(1)))) {
							...
							if ( _cnt350>=1 ) { goto _loop350; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
						}
			...
			if ( synPredMatched351 ) {
				...
				for (;;) {
					if ((_tokenSet_25.member(LA(1)))) {
						...
						if ( _cnt353>=1 ) { goto _loop353; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
					}
		...
		case LSQUARE:
		{
			...
			for (;;) {
				if ((LA(1) == LSQUARE)) {
					...
					if ( _cnt359>=1 ) { goto _loop359; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
				}
...
void CPPParser::template_parameter() {
	...
	try {      // for error handling
		...
		else if ((_tokenSet_100.member(LA(1))) && (_tokenSet_15.member(LA(2)))) {
			parameter_declaration();
		}
		else {
			throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
...
void CPPParser::template_argument() {
	...
	try {      // for error handling
		if (((_tokenSet_12.member(LA(1))) && (_tokenSet_105.member(LA(2))))&&(( !(LA(1)==SCOPE||LA(1)==ID) || qualifiedItemIsOneOf(qiType|qiCtor) ))) {
			type_id();
		}
	...
	try {      // for error handling
		...
		for (;;) {
			if ((_tokenSet_49.member(LA(1)))) {
				...
				if ( _cnt389>=1 ) { goto _loop389; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
			}
	...
	try {      // for error handling
		...
		default:
			...
			if ( synPredMatched393 ) {
				...
				if (((_tokenSet_20.member(LA(1))) && (_tokenSet_110.member(LA(2))))) {
					int _m397 = mark();
						...
						if ( synPredMatched402 ) {
							...
							if (((_tokenSet_20.member(LA(1))) && (_tokenSet_110.member(LA(2))))) {
								...
								try {
									...
									if (((_tokenSet_25.member(LA(1))) && (_tokenSet_111.member(LA(2))))) {
										int _m406 = mark();
							...
							else if ((_tokenSet_72.member(LA(1))) && (_tokenSet_112.member(LA(2)))) {
								expression();
								match(SEMICOLON);
								if ( inputState->guessing==0 ) {
...
#line 9539 "CPPParser.cpp"
							...
							else if ((LA(1) == SEMICOLON) && (_tokenSet_40.member(LA(2)))) {
								match(SEMICOLON);
								if ( inputState->guessing==0 ) {
...
#line 9547 "CPPParser.cpp"
							...
							else if ((LA(1) == LITERAL_antlrTrace_on) && (_tokenSet_40.member(LA(2)))) {
								match(LITERAL_antlrTrace_on);
								if ( inputState->guessing==0 ) {
...
#line 9555 "CPPParser.cpp"
							...
							else if ((LA(1) == LITERAL_antlrTrace_off) && (_tokenSet_40.member(LA(2)))) {
								match(LITERAL_antlrTrace_off);
								if ( inputState->guessing==0 ) {
...
void CPPParser::selection_statement() {
	...
	try {      // for error handling
		...
		case LITERAL_if:
		{
			...
			else if ((_tokenSet_40.member(LA(1))) && (_tokenSet_113.member(LA(2)))) {
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
			}
...
void CPPParser::unary_expression() {
	...
	try {      // for error handling
		...
		default:
			...
			else if ((_tokenSet_132.member(LA(1))) && (_tokenSet_72.member(LA(2)))) {
				unary_operator();
				cast_expression();
			}
...
#line 11404 "CPPParser.cpp"
	...
	try {      // for error handling
		...
		case LITERAL_typeid:
		{
			...
			if (((_tokenSet_12.member(LA(1))) && (_tokenSet_135.member(LA(2))))) {
				int _m544 = mark();
			...
			else if ((_tokenSet_72.member(LA(1))) && (_tokenSet_136.member(LA(2)))) {
				expression();
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
		...
		default:
			...
			if ((((_tokenSet_103.member(LA(1))) && (_tokenSet_137.member(LA(2))))&&(!(LA(1)==LPAREN)))) {
				int _m529 = mark();
			...
			if ( synPredMatched529 ) {
				...
				else if ((_tokenSet_138.member(LA(1))) && (_tokenSet_131.member(LA(2)))) {
					primary_expression();
					{ // ( ... )*
					for (;;) {
						switch ( LA(1)) {
...
void CPPParser::new_expression() {
	...
	try {      // for error handling
		...
		else if ((_tokenSet_139.member(LA(1))) && (_tokenSet_140.member(LA(2)))) {
		}
		else {
			throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
		}
	...
	try {      // for error handling
		...
		case WStringLiteral:
		{
			...
			for (;;) {
				...
				default:
				{
					if ( _cnt551>=1 ) { goto _loop551; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
				}
				}
				_cnt551++;
			}
...
void CPPParser::new_type_id() {
	...
	try {      // for error handling
		...
		else if ((_tokenSet_144.member(LA(1))) && (_tokenSet_57.member(LA(2)))) {
		}
		else {
			throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
		}
	...
	try {      // for error handling
		...
		for (;;) {
			if ((LA(1) == LSQUARE)) {
				...
				if ( _cnt570>=1 ) { goto _loop570; } else {throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());}
			}
...
const unsigned long CPPParser::_tokenSet_0_data_[] = { 4291950480UL, 4294967293UL, 1910571007UL, 2UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_2_data_[] = { 4291835520UL, 4294967292UL, 65535UL, 2UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
...
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_2(_tokenSet_2_data_,12);
const unsigned long CPPParser::_tokenSet_3_data_[] = { 4293949344UL, 4294967293UL, 1910571007UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_4_data_[] = { 4096UL, 3840UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "inline" "_inline" "__inline" "virtual" "explicit" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_4(_tokenSet_4_data_,8);
const unsigned long CPPParser::_tokenSet_5_data_[] = { 3072UL, 0UL, 31457280UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_6_data_[] = { 5136UL, 1792UL, 268435456UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" ID "inline" "_inline" "__inline" "virtual" TILDE SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_6(_tokenSet_6_data_,12);
const unsigned long CPPParser::_tokenSet_7_data_[] = { 5152UL, 1792UL, 268435456UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN ID "inline" "_inline" "__inline" "virtual" TILDE SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_7(_tokenSet_7_data_,12);
const unsigned long CPPParser::_tokenSet_8_data_[] = { 5120UL, 2816UL, 0UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID "inline" "_inline" "__inline" "explicit" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_8(_tokenSet_8_data_,12);
const unsigned long CPPParser::_tokenSet_9_data_[] = { 5152UL, 2817UL, 0UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN ID "inline" LPAREN "_inline" "__inline" "explicit" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_9(_tokenSet_9_data_,12);
const unsigned long CPPParser::_tokenSet_10_data_[] = { 5120UL, 0UL, 2097152UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID "inline" "operator" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_10(_tokenSet_10_data_,12);
const unsigned long CPPParser::_tokenSet_11_data_[] = { 4291835552UL, 4294967292UL, 2162687UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_12_data_[] = { 4291835520UL, 4294967292UL, 65535UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
const unsigned long CPPParser::_tokenSet_13_data_[] = { 4291835552UL, 4294967293UL, 1642135551UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" 
// "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" 
...
const unsigned long CPPParser::_tokenSet_14_data_[] = { 4291835520UL, 4294967293UL, 1642135551UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
const unsigned long CPPParser::_tokenSet_15_data_[] = { 4292097760UL, 4294967293UL, 1977810943UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" "enum" ID "inline" "friend" ASSIGNEQUAL 
// "extern" "struct" "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" 
// "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" 
...
const unsigned long CPPParser::_tokenSet_16_data_[] = { 29372416UL, 3840UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_17_data_[] = { 29367296UL, 3840UL, 31525888UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_18_data_[] = { 4291835808UL, 4294967293UL, 1910571007UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_19_data_[] = { 4292081554UL, 4294967293UL, 1910571007UL, 2UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_20_data_[] = { 4291934096UL, 4294967293UL, 1912406015UL, 2UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_21_data_[] = { 100664576UL, 1UL, 1910505472UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_22_data_[] = { 256UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_22(_tokenSet_22_data_,8);
const unsigned long CPPParser::_tokenSet_23_data_[] = { 101188864UL, 1UL, 1910505472UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_24_data_[] = { 101582176UL, 3UL, 4259446784UL, 4293918720UL, 557055UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_25_data_[] = { 100664320UL, 0UL, 1610612736UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_26_data_[] = { 100664352UL, 1UL, 1642131456UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN ID "_stdcall" "__stdcall" LPAREN "const" "__const" "volatile" 
// "__volatile__" "operator" "this" "true" "false" STAR AMPERSAND SCOPE 
// "_cdecl" "__cdecl" "_near" "__near" "_far" "__far" "__interrupt" "pascal" 
// "_pascal" "__pascal" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_26(_tokenSet_26_data_,12);
const unsigned long CPPParser::_tokenSet_27_data_[] = { 1024UL, 1UL, 31457280UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_28_data_[] = { 263264UL, 1UL, 1977745408UL, 3220176896UL, 2744319UL, 16396UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_29_data_[] = { 4291837824UL, 4294967292UL, 65535UL, 2UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_30_data_[] = { 4294180754UL, 4294967293UL, 1945960447UL, 1015807UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
// "static_cast" "reinterpret_cast" "const_cast" "typeid" DECIMALINT HEXADECIMALINT 
...
const unsigned long CPPParser::_tokenSet_31_data_[] = { 4291835520UL, 4294967293UL, 1910571007UL, 2UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
const unsigned long CPPParser::_tokenSet_32_data_[] = { 2304UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON LCURLY 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_32(_tokenSet_32_data_,8);
const unsigned long CPPParser::_tokenSet_33_data_[] = { 1024UL, 0UL, 0UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_33(_tokenSet_33_data_,12);
const unsigned long CPPParser::_tokenSet_34_data_[] = { 1024UL, 0UL, 836763648UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID "operator" "this" "true" "false" TILDE STAR 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_34(_tokenSet_34_data_,8);
const unsigned long CPPParser::_tokenSet_35_data_[] = { 4291837568UL, 4294967292UL, 65535UL, 2UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_36_data_[] = { 4294180784UL, 4294967293UL, 1945960447UL, 1015775UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_37_data_[] = { 4294180752UL, 4294967293UL, 1945960447UL, 1015775UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
// "reinterpret_cast" "const_cast" "typeid" DECIMALINT HEXADECIMALINT CharLiteral 
...
const unsigned long CPPParser::_tokenSet_38_data_[] = { 100664320UL, 1UL, 1642070016UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_39_data_[] = { 100926560UL, 1UL, 1977806848UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_40_data_[] = { 4294180752UL, 4294967293UL, 1945960447UL, 1015807UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" "typedef" SEMICOLON "enum" ID LCURLY "inline" "friend" "namespace" 
// "antlrTrace_on" "antlrTrace_off" RCURLY "extern" StringLiteral "struct" 
// "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" 
// "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" 
...
const unsigned long CPPParser::_tokenSet_41_data_[] = { 101453120UL, 3UL, 4125229056UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_42_data_[] = { 5120UL, 1792UL, 268435456UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_43_data_[] = { 4291835520UL, 4294967292UL, 2162687UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
const unsigned long CPPParser::_tokenSet_44_data_[] = { 1024UL, 0UL, 31457280UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID "operator" "this" "true" "false" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_44(_tokenSet_44_data_,12);
const unsigned long CPPParser::_tokenSet_45_data_[] = { 263520UL, 1UL, 1977745408UL, 3220176896UL, 2744319UL, 16396UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
// MINUS DIVIDE MOD POINTERTOMBR PLUSPLUS MINUSMINUS SCOPE POINTERTO NOT 
// "new" "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_45(_tokenSet_45_data_,12);
const unsigned long CPPParser::_tokenSet_46_data_[] = { 100668416UL, 3841UL, 1642070016UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_47_data_[] = { 100930656UL, 3841UL, 1977806848UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_47(_tokenSet_47_data_,12);
const unsigned long CPPParser::_tokenSet_48_data_[] = { 526592UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON LCURLY COLON 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_48(_tokenSet_48_data_,8);
const unsigned long CPPParser::_tokenSet_49_data_[] = { 4294049680UL, 4294967293UL, 1945960447UL, 1015775UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" "typedef" SEMICOLON "enum" ID LCURLY "inline" "friend" "namespace" 
...
// "_near" "__near" "_far" "__far" "__interrupt" "pascal" "_pascal" "__pascal" 
// "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_49(_tokenSet_49_data_,12);
const unsigned long CPPParser::_tokenSet_50_data_[] = { 4294180754UL, 4294967293UL, 1945960447UL, 1048575UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// EOF "template" "typedef" SEMICOLON "enum" ID LCURLY "inline" "friend" 
// "namespace" "antlrTrace_on" "antlrTrace_off" RCURLY "extern" StringLiteral 
// "struct" "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" 
// "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" 
...
const unsigned long CPPParser::_tokenSet_51_data_[] = { 525312UL, 1024UL, 0UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID COLON "virtual" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_51(_tokenSet_51_data_,12);
const unsigned long CPPParser::_tokenSet_52_data_[] = { 64UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_52(_tokenSet_52_data_,8);
const unsigned long CPPParser::_tokenSet_53_data_[] = { 2048UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LCURLY 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_53(_tokenSet_53_data_,8);
const unsigned long CPPParser::_tokenSet_54_data_[] = { 4292755424UL, 4294967295UL, 4259512319UL, 4293918723UL, 557055UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_55_data_[] = { 4293932672UL, 4294967293UL, 1944125439UL, 0UL, 4291790336UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_55(_tokenSet_55_data_,12);
const unsigned long CPPParser::_tokenSet_56_data_[] = { 101584224UL, 3UL, 4259446784UL, 4293918720UL, 557055UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_57_data_[] = { 4294967282UL, 4294967295UL, 4294967295UL, 4294934527UL, 4294967295UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_58_data_[] = { 3072UL, 0UL, 31522816UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_59_data_[] = { 524544UL, 2UL, 134217728UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON COLON RPAREN RSQUARE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_59(_tokenSet_59_data_,8);
const unsigned long CPPParser::_tokenSet_60_data_[] = { 2048UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LCURLY COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_60(_tokenSet_60_data_,8);
const unsigned long CPPParser::_tokenSet_61_data_[] = { 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// RCURLY 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_61(_tokenSet_61_data_,8);
const unsigned long CPPParser::_tokenSet_62_data_[] = { 131072UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// RCURLY COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_62(_tokenSet_62_data_,8);
const unsigned long CPPParser::_tokenSet_63_data_[] = { 917760UL, 0UL, 134348800UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_64_data_[] = { 101584224UL, 3UL, 4259446784UL, 4293918720UL, 3801087UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON ID LCURLY RCURLY ASSIGNEQUAL COLON "_stdcall" 
// "__stdcall" LPAREN RPAREN COMMA "operator" "this" "true" "false" LSQUARE 
// RSQUARE TILDE STAR AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL 
// PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL 
...
const unsigned long CPPParser::_tokenSet_65_data_[] = { 256UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_65(_tokenSet_65_data_,8);
const unsigned long CPPParser::_tokenSet_66_data_[] = { 100664352UL, 1UL, 1910566912UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN ID "_stdcall" "__stdcall" LPAREN "const" "__const" "volatile" 
// "__volatile__" "operator" "this" "true" "false" TILDE STAR AMPERSAND 
...
const unsigned long CPPParser::_tokenSet_67_data_[] = { 1024UL, 1UL, 299892736UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID LPAREN "operator" "this" "true" "false" TILDE SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_67(_tokenSet_67_data_,12);
const unsigned long CPPParser::_tokenSet_68_data_[] = { 100926816UL, 3UL, 4125229056UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_69_data_[] = { 262464UL, 3UL, 2147614720UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_70_data_[] = { 131328UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON RCURLY COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_70(_tokenSet_70_data_,8);
const unsigned long CPPParser::_tokenSet_71_data_[] = { 0UL, 2UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// RPAREN 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_71(_tokenSet_71_data_,8);
const unsigned long CPPParser::_tokenSet_72_data_[] = { 2098176UL, 4294963201UL, 1944063999UL, 0UL, 4291790336UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_73_data_[] = { 4294850528UL, 4294967295UL, 4293066751UL, 4293918720UL, 4294967295UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_74_data_[] = { 655680UL, 2UL, 2281832448UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY COLON RPAREN COMMA RSQUARE ELLIPSIS 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_74(_tokenSet_74_data_,8);
const unsigned long CPPParser::_tokenSet_75_data_[] = { 2622464UL, 4294963201UL, 1944063999UL, 0UL, 4291790336UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_76_data_[] = { 100664320UL, 1UL, 1910505472UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_77_data_[] = { 100926816UL, 1UL, 1977806848UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON ID ASSIGNEQUAL "_stdcall" "__stdcall" 
...
const unsigned long CPPParser::_tokenSet_78_data_[] = { 262400UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SEMICOLON ASSIGNEQUAL COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_78(_tokenSet_78_data_,8);
const unsigned long CPPParser::_tokenSet_79_data_[] = { 4293932672UL, 4294967295UL, 4225826815UL, 0UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" StringLiteral "struct" 
// "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" 
...
const unsigned long CPPParser::_tokenSet_80_data_[] = { 4294967250UL, 4294967295UL, 4160684031UL, 1015807UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_81_data_[] = { 263520UL, 3UL, 4125229056UL, 3220176896UL, 2744319UL, 16396UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
// NOT "new" "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_81(_tokenSet_81_data_,12);
const unsigned long CPPParser::_tokenSet_82_data_[] = { 4292624320UL, 4294967295UL, 2147680255UL, 2UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN "typedef" SEMICOLON "enum" ID LCURLY "inline" "friend" ASSIGNEQUAL 
...
const unsigned long CPPParser::_tokenSet_83_data_[] = { 4292099968UL, 4294967292UL, 65535UL, 3UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_85_data_[] = { 0UL, 1UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LPAREN 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_85(_tokenSet_85_data_,8);
const unsigned long CPPParser::_tokenSet_86_data_[] = { 1024UL, 0UL, 268435456UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID TILDE SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_86(_tokenSet_86_data_,12);
const unsigned long CPPParser::_tokenSet_87_data_[] = { 0UL, 2UL, 2147483648UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// RPAREN ELLIPSIS 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_87(_tokenSet_87_data_,8);
const unsigned long CPPParser::_tokenSet_88_data_[] = { 4292097760UL, 4294967295UL, 4125294591UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" "enum" ID "inline" "friend" ASSIGNEQUAL 
// "extern" "struct" "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" 
// "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN RPAREN "GFARRAYSIZES" 
// "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" "_inline" "__inline" 
...
const unsigned long CPPParser::_tokenSet_89_data_[] = { 100926560UL, 3UL, 4125290496UL, 3220176896UL, 2744319UL, 32764UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_90_data_[] = { 100926528UL, 3UL, 3825336320UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_91_data_[] = { 4294721520UL, 4294967295UL, 4293066751UL, 3UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
// ELLIPSIS "throw" "using" PLUS MINUS PLUSPLUS MINUSMINUS "sizeof" "__alignof__" 
// SCOPE "dynamic_cast" "static_cast" "reinterpret_cast" "const_cast" "typeid" 
// DECIMALINT HEXADECIMALINT CharLiteral WCharLiteral WStringLiteral FLOATONE 
// FLOATTWO NOT "new" "_cdecl" "__cdecl" "_near" "__near" "_far" "__far" 
// "__interrupt" "pascal" "_pascal" "__pascal" "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_91(_tokenSet_91_data_,12);
const unsigned long CPPParser::_tokenSet_92_data_[] = { 64UL, 2UL, 2147614720UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN RPAREN COMMA ELLIPSIS 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_92(_tokenSet_92_data_,8);
const unsigned long CPPParser::_tokenSet_93_data_[] = { 262208UL, 3UL, 2214723584UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_94_data_[] = { 4294852594UL, 4294967295UL, 4293066751UL, 4293918723UL, 4291821567UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// EOF "template" LESSTHAN GREATERTHAN "typedef" SEMICOLON "enum" ID LCURLY 
...
// FLOATTWO NOT "new" "_cdecl" "__cdecl" "_near" "__near" "_far" "__far" 
// "__interrupt" "pascal" "_pascal" "__pascal" "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_94(_tokenSet_94_data_,12);
const unsigned long CPPParser::_tokenSet_95_data_[] = { 262208UL, 2UL, 2147614720UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_96_data_[] = { 64UL, 2UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN RPAREN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_96(_tokenSet_96_data_,8);
const unsigned long CPPParser::_tokenSet_97_data_[] = { 101582176UL, 3UL, 4259446784UL, 4293918721UL, 557055UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON ID RCURLY ASSIGNEQUAL COLON "_stdcall" 
// "__stdcall" LPAREN RPAREN COMMA "operator" "this" "true" "false" LSQUARE 
...
// "__near" "_far" "__far" "__interrupt" "pascal" "_pascal" "__pascal" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_97(_tokenSet_97_data_,12);
const unsigned long CPPParser::_tokenSet_98_data_[] = { 16777232UL, 4096UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" "class" "typename" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_98(_tokenSet_98_data_,8);
const unsigned long CPPParser::_tokenSet_99_data_[] = { 1120UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN ID COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_99(_tokenSet_99_data_,8);
const unsigned long CPPParser::_tokenSet_100_data_[] = { 4291835520UL, 4294967293UL, 4058054655UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
// ELLIPSIS SCOPE "_cdecl" "__cdecl" "_near" "__near" "_far" "__far" "__interrupt" 
// "pascal" "_pascal" "__pascal" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_100(_tokenSet_100_data_,12);
const unsigned long CPPParser::_tokenSet_101_data_[] = { 64UL, 0UL, 131072UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_101(_tokenSet_101_data_,8);
const unsigned long CPPParser::_tokenSet_102_data_[] = { 100664416UL, 1UL, 1677852672UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_103_data_[] = { 1024UL, 4294963200UL, 4095UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_104_data_[] = { 100664416UL, 4294959105UL, 1677856767UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_105_data_[] = { 4291835616UL, 4294967293UL, 1677918207UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_106_data_[] = { 4294194912UL, 4294967293UL, 2011365375UL, 3220176896UL, 4294967295UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" "enum" ID "inline" "friend" ASSIGNEQUAL 
// "extern" StringLiteral "struct" "union" "class" "_stdcall" "__stdcall" 
// "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" 
// "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" "_inline" "__inline" 
...
const unsigned long CPPParser::_tokenSet_107_data_[] = { 917856UL, 2UL, 3355574272UL, 4293918720UL, 127UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_108_data_[] = { 4291851904UL, 4294967292UL, 65535UL, 983042UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_109_data_[] = { 4291852192UL, 4294967293UL, 1910571007UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN "typedef" SEMICOLON "enum" ID "inline" "friend" "namespace" 
// "extern" "struct" "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" 
// "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" 
// "auto" "register" "static" "mutable" "_inline" "__inline" "virtual" 
...
const unsigned long CPPParser::_tokenSet_110_data_[] = { 4294967280UL, 4294967293UL, 2013265919UL, 3221192703UL, 4293910527UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" LESSTHAN GREATERTHAN "typedef" SEMICOLON "enum" ID LCURLY 
// "inline" "friend" "namespace" "antlrTrace_on" "antlrTrace_off" RCURLY 
// ASSIGNEQUAL COLON "extern" StringLiteral "struct" "union" "class" "_stdcall" 
// "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
...
const unsigned long CPPParser::_tokenSet_111_data_[] = { 1056UL, 0UL, 568389632UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_112_data_[] = { 4294195168UL, 4294967293UL, 2011365375UL, 4293918720UL, 4294967295UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" SEMICOLON "enum" ID "inline" "friend" 
...
const unsigned long CPPParser::_tokenSet_113_data_[] = { 4294967282UL, 4294967293UL, 2013265919UL, 4294967295UL, 4294967295UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// EOF "template" LESSTHAN GREATERTHAN "typedef" SEMICOLON "enum" ID LCURLY 
// "inline" "friend" "namespace" "antlrTrace_on" "antlrTrace_off" RCURLY 
// ASSIGNEQUAL COLON "extern" StringLiteral "struct" "union" "class" "_stdcall" 
// "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
...
const unsigned long CPPParser::_tokenSet_114_data_[] = { 4294180752UL, 4294967293UL, 1945960447UL, 1048575UL, 4291790336UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "template" "typedef" SEMICOLON "enum" ID LCURLY "inline" "friend" "namespace" 
// "antlrTrace_on" "antlrTrace_off" RCURLY "extern" StringLiteral "struct" 
// "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" 
// "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" 
...
const unsigned long CPPParser::_tokenSet_115_data_[] = { 917824UL, 2UL, 2281832448UL, 1072693248UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_116_data_[] = { 917824UL, 2UL, 2281832448UL, 2146435072UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL 
// SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL QUESTIONMARK 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_116(_tokenSet_116_data_,8);
const unsigned long CPPParser::_tokenSet_117_data_[] = { 917824UL, 2UL, 2281832448UL, 4293918720UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL 
// SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL QUESTIONMARK 
// OR 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_117(_tokenSet_117_data_,8);
const unsigned long CPPParser::_tokenSet_118_data_[] = { 917824UL, 2UL, 2281832448UL, 4293918720UL, 1UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL 
// SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL QUESTIONMARK 
// OR AND 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_118(_tokenSet_118_data_,12);
const unsigned long CPPParser::_tokenSet_119_data_[] = { 917824UL, 2UL, 2281832448UL, 4293918720UL, 3UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL 
// SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL QUESTIONMARK 
// OR AND BITWISEOR 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_119(_tokenSet_119_data_,12);
const unsigned long CPPParser::_tokenSet_120_data_[] = { 917824UL, 2UL, 2281832448UL, 4293918720UL, 7UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL SHIFTLEFTEQUAL 
// SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL QUESTIONMARK 
// OR AND BITWISEOR BITWISEXOR 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_120(_tokenSet_120_data_,12);
const unsigned long CPPParser::_tokenSet_121_data_[] = { 917824UL, 2UL, 3355574272UL, 4293918720UL, 7UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL 
// SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL 
...
const unsigned long CPPParser::_tokenSet_122_data_[] = { 96UL, 0UL, 0UL, 0UL, 96UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN LESSTHANOREQUALTO GREATERTHANOREQUALTO 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_122(_tokenSet_122_data_,12);
const unsigned long CPPParser::_tokenSet_123_data_[] = { 917824UL, 2UL, 3355574272UL, 4293918720UL, 31UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA RSQUARE 
// AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL MODEQUAL 
// SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL BITWISEOREQUAL 
...
const unsigned long CPPParser::_tokenSet_124_data_[] = { 917856UL, 2UL, 3355574272UL, 4293918720UL, 511UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA 
// RSQUARE AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL 
// MODEQUAL SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL 
// BITWISEOREQUAL QUESTIONMARK OR AND BITWISEOR BITWISEXOR NOTEQUAL EQUAL 
...
const unsigned long CPPParser::_tokenSet_125_data_[] = { 0UL, 0UL, 536870912UL, 0UL, 6144UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// STAR DIVIDE MOD 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_125(_tokenSet_125_data_,12);
const unsigned long CPPParser::_tokenSet_126_data_[] = { 917856UL, 2UL, 3355574272UL, 4293918720UL, 2047UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA 
// RSQUARE AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL 
// MODEQUAL SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL 
// BITWISEOREQUAL QUESTIONMARK OR AND BITWISEOR BITWISEXOR NOTEQUAL EQUAL 
...
const unsigned long CPPParser::_tokenSet_127_data_[] = { 917856UL, 2UL, 3892445184UL, 4293918720UL, 8191UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA 
...
const unsigned long CPPParser::_tokenSet_128_data_[] = { 1024UL, 4294963200UL, 65535UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID "typename" "char" "wchar_t" "bool" "short" "int" "_int8" "__int8" 
// "int8_t" "_int16" "__int16" "int16_t" "_int32" "__int32" "int32_t" "_int64" 
// "__int64" "int64_t" "uint8_t" "uint16_t" "uint32_t" "uint64_t" "_w64" 
// "__w64" "long" "signed" "unsigned" "float" "double" "void" "_declspec" 
// "__declspec" "const" "__const" "volatile" "__volatile__" SCOPE 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_128(_tokenSet_128_data_,12);
const unsigned long CPPParser::_tokenSet_129_data_[] = { 917856UL, 2UL, 3892445184UL, 4293918720UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON RPAREN COMMA 
// RSQUARE STAR AMPERSAND ELLIPSIS TIMESEQUAL DIVIDEEQUAL MINUSEQUAL PLUSEQUAL 
// MODEQUAL SHIFTLEFTEQUAL SHIFTRIGHTEQUAL BITWISEANDEQUAL BITWISEXOREQUAL 
// BITWISEOREQUAL QUESTIONMARK OR AND BITWISEOR BITWISEXOR NOTEQUAL EQUAL 
...
const unsigned long CPPParser::_tokenSet_130_data_[] = { 2098176UL, 4294963201UL, 333451263UL, 0UL, 4291297280UL, 3UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID StringLiteral LPAREN "typename" "char" "wchar_t" "bool" "short" "int" 
// "_int8" "__int8" "int8_t" "_int16" "__int16" "int16_t" "_int32" "__int32" 
// "int32_t" "_int64" "__int64" "int64_t" "uint8_t" "uint16_t" "uint32_t" 
// "uint64_t" "_w64" "__w64" "long" "signed" "unsigned" "float" "double" 
...
const unsigned long CPPParser::_tokenSet_131_data_[] = { 3016032UL, 4294963203UL, 4293005311UL, 4293918720UL, 4294967295UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_132_data_[] = { 0UL, 0UL, 1879048192UL, 0UL, 1536UL, 4UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// TILDE STAR AMPERSAND PLUS MINUS NOT 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_132(_tokenSet_132_data_,12);
const unsigned long CPPParser::_tokenSet_133_data_[] = { 0UL, 0UL, 0UL, 0UL, 524288UL, 16392UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// SCOPE "new" "delete" 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_133(_tokenSet_133_data_,12);
const unsigned long CPPParser::_tokenSet_134_data_[] = { 4293932672UL, 4294967293UL, 2011234303UL, 0UL, 4291790336UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" StringLiteral "struct" 
// "union" "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" 
// "GFUNREAD" "GFARRAYSIZE" LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" 
// "register" "static" "mutable" "_inline" "__inline" "virtual" "explicit" 
...
const unsigned long CPPParser::_tokenSet_135_data_[] = { 4291835552UL, 4294967295UL, 1677787135UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" 
// "class" "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" 
...
const unsigned long CPPParser::_tokenSet_136_data_[] = { 4294194912UL, 4294967295UL, 2011365375UL, 4293918720UL, 4294967295UL, 16399UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" "enum" ID "inline" "friend" ASSIGNEQUAL 
// "extern" StringLiteral "struct" "union" "class" "_stdcall" "__stdcall" 
// "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" LPAREN RPAREN 
// "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
...
const unsigned long CPPParser::_tokenSet_137_data_[] = { 1056UL, 4294959105UL, 4095UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_138_data_[] = { 2098176UL, 1UL, 333447168UL, 0UL, 4161273856UL, 3UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_139_data_[] = { 4291835520UL, 4294967293UL, 65535UL, 0UL, 524288UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "typedef" "enum" ID "inline" "friend" "extern" "struct" "union" "class" 
// "_stdcall" "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// LPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" "mutable" 
// "_inline" "__inline" "virtual" "explicit" "typename" "char" "wchar_t" 
...
const unsigned long CPPParser::_tokenSet_140_data_[] = { 4292753376UL, 4294967295UL, 3959619583UL, 4293918720UL, 557055UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN "typedef" SEMICOLON "enum" ID "inline" "friend" 
// RCURLY ASSIGNEQUAL COLON "extern" "struct" "union" "class" "_stdcall" 
// "__stdcall" "GFEXCLUDE" "GFINCLUDE" "GFID" "GFUNREAD" "GFARRAYSIZE" 
// LPAREN RPAREN "GFARRAYSIZES" "GFARRAYELEMSIZE" "auto" "register" "static" 
...
const unsigned long CPPParser::_tokenSet_141_data_[] = { 917856UL, 3UL, 3959554048UL, 4293918720UL, 3276799UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_142_data_[] = { 100664320UL, 0UL, 1677721600UL, 0UL, 524288UL, 16368UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long CPPParser::_tokenSet_143_data_[] = { 103679328UL, 4294963203UL, 4293066751UL, 4293918720UL, 4291821567UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON ID RCURLY ASSIGNEQUAL COLON StringLiteral 
...
const unsigned long CPPParser::_tokenSet_144_data_[] = { 917856UL, 3UL, 3892445184UL, 4293918720UL, 32767UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// LESSTHAN GREATERTHAN SEMICOLON RCURLY ASSIGNEQUAL COLON LPAREN RPAREN 
...
// LESSTHANOREQUALTO GREATERTHANOREQUALTO SHIFTLEFT SHIFTRIGHT PLUS MINUS 
// DIVIDE MOD DOTMBR POINTERTOMBR 
const ANTLR_USE_NAMESPACE(antlr)BitSet CPPParser::_tokenSet_144(_tokenSet_144_data_,12);
