...
namespace gemfire
{
  namespace pdx_auto_serializer
  {
    ...
    InputParser* InputParserFactory::getInstance(const std::string& parserName) const
    {
    ...
    StringVector InputParserFactory::getParsers() const
    {
      ...
      for (std::map<std::string, InputParserFn>::const_iterator
          parserIterator = m_parserMap.begin(); parserIterator
          != m_parserMap.end(); ++parserIterator) {
