...
DUNIT_TASK_DEFINITION(SERVER1, CreateServer1_With_Locator_And_SSL)
{
  //starting servers
  if ( isLocalServer )
    CacheHelper::initServer( 1, NULL, locatorsG, NULL, true );
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(SERVER1, CreateServer1_With_Locator_XML_Bug849)
{
  //starting servers
  if ( isLocalServer )
    CacheHelper::initServer( 1, "cacheserver_notify_subscriptionBug849.xml", locatorsG );
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(SERVER1, CreateServer1_With_Locator_XML2)
{
  //starting servers
  if ( isLocalServer )
    CacheHelper::initServer( 1, "cacheserver_notify_subscription_PutAllTimeout.xml", locatorsG );
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(SERVER1, CreateServer1_With_Locator_XML5)
{
  //starting servers
  if ( isLocalServer )
    CacheHelper::initServer( 1, "cacheserver_notify_subscription5.xml", locatorsG );
}
END_TASK_DEFINITION
