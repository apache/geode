...
const char * nvals[] = { "New Value-1", "New Value-2", "New Value-3", "New Value-4" , "New Value-5"};
...
DUNIT_TASK_DEFINITION(CLIENT2, StepSix)
{
  ...
  // This step get the value from region, if key is inavalidate in region, value will get from server.
...
void runThinClientFailover2(bool poolConfig = true, bool isLocator = true)
{
