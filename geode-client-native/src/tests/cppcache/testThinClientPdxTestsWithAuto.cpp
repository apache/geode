...
void initClient2WithClientName( const bool isthinClient, const PropertiesPtr& configPtr = NULLPTR )
{
...
void stepOneForClient2(bool pool = false, bool locator = false, bool  isPdxIgnoreUnreadFields = false )
{
...
void initClient1(bool pool = false, bool locator = false, bool  isPdxIgnoreUnreadFields = false )
{
  //Create just one pool and attach all regions to that.
  initClient(true, isPdxIgnoreUnreadFields);
  if(locator){
    isPoolConfig = true;
    createPool(poolNames[0], locHostPort, NULL, NULL, 0, false );
    createRegionAndAttachPool( "DistRegionAck", USE_ACK, poolNames[0], true /*Caching enabled*/);
  }else {
    isPoolConfig = true;
    createPool(poolNames[0], NULL, NULL,endPoints, 0, false );
    createRegionAndAttachPool( "DistRegionAck", USE_ACK, poolNames[0], true);
  }
  LOG( "StepOne complete." );
}

void initClient2(bool pool = false, bool locator = false, bool  isPdxIgnoreUnreadFields = false )
{
  //Create just one pool and attach all regions to that.
  initClient(true, isPdxIgnoreUnreadFields);
  if(locator){
    isPoolConfig = true;
    createPool(poolNames[0], locHostPort, NULL, NULL, 0, true /*ClientNotification enabled*/ );
    createRegionAndAttachPool( "DistRegionAck", USE_ACK, poolNames[0], true /*Caching enabled*/);
  }else {
    isPoolConfig = true;
    createPool(poolNames[0], NULL, NULL,endPoints, 0, true );
...
void initClient3(bool pool = false, bool locator = false, bool  isPdxIgnoreUnreadFields = false )
{
  //Create just one pool and attach all regions to that.
  initClient(true, isPdxIgnoreUnreadFields);
  if(locator){
...
{
  LOG("Starting SERVER1...");
  if ( isLocalServer ) CacheHelper::initServer( 1, "cacheserverPdx2.xml",locHostPort );
  LOG("SERVER1 started");
}
END_TASK_DEFINITION
...
{
  LOG("Starting SERVER1...");
  if ( isLocalServer ) CacheHelper::initServer( 1, "cacheserverForPdxWithAuto.xml" );
  LOG("SERVER1 started");
}
END_TASK_DEFINITION
...
{
  LOG("Starting SERVER1...");
  if ( isLocalServer ) CacheHelper::initServer( 1, "cacheserverForPdxWithAuto.xml",locHostPort );
  LOG("SERVER1 started");
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(CLIENT1, testPutWithMultilevelInheritance)
{
  ...
  PdxTestsAuto::ChildPtr  obj2 = dynCast<PdxTestsAuto::ChildPtr>(regPtr0->get(keyport));
  //LOGINFO("Task: testPutWithMultilevelInheritance: got members :: %d %d %d %d %d %d ", obj2->getMember_a(), obj2->getMember_b(), obj2->getMember_c(), obj2->getMember_d(), obj2->getMember_e(), obj2->getMember_f());
...
DUNIT_TASK_DEFINITION(CLIENT2, testGetWithMultilevelInheritance)
{
  ...
  PdxTestsAuto::ChildPtr  obj1 = dynCast<PdxTestsAuto::ChildPtr>(regPtr0->get(keyport1));

  CacheablePtr pdxobj(new PdxTestsAuto::Child());
  bool isEqual = (dynCast<PdxTestsAuto::ChildPtr>(pdxobj))->equals(obj1);
  LOGINFO("testPutWithMultilevelInheritance:.. isEqual = %d", isEqual);
  ASSERT(isEqual == true, "Objects of type class Child should be equal");
  //LOGINFO("Task: testGetWithMultilevelInheritance: got members :: %d %d %d %d %d %d ", obj1->getMember_a(), obj1->getMember_b(), obj1->getMember_c(), obj1->getMember_d(), obj1->getMember_e(), obj1->getMember_f());
  LOGINFO("TASK::testGetWithMultilevelInheritance GET completed Successfully");
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(CLIENT1, JavaPutGet)
{
  ...
  PdxTestsAuto::PdxTypePtr  obj2 = dynCast<PdxTestsAuto::PdxTypePtr>(regPtr0->get(keyport));
  ...
  ASSERT(isEqual == true, "Task JavaPutGet:Objects of type PdxType should be equal");
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(CLIENT2, JavaGet)
{
  ...
  PdxTestsAuto::PdxTypePtr  obj1 = dynCast<PdxTestsAuto::PdxTypePtr>(regPtr0->get(keyport1));
  LOGDEBUG("JavaGet-3 Line_316");
  CacheableKeyPtr keyport2 = CacheableKey::create("putFromjava");
  LOGDEBUG("JavaGet-4 Line_316");
  PdxTestsAuto::PdxTypePtr  obj2 = dynCast<PdxTestsAuto::PdxTypePtr>(regPtr0->get(keyport2));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypesR2V2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypesR2V2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesR2V2Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypesV1R2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypesV1R2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesV1R2Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxType3V1::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxType3V1Ptr  pRet = dynCast<PdxTestsAuto::PdxType3V1Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes3V2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  RegionPtr regPtr0 = getHelper()->getRegion("DistRegionAck");
  ...
  PdxTestsAuto::PdxTypes3V2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypes3V2Ptr>(regPtr0->get(keyport));
  bool isEqual = np->equals(pRet);
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxType2V1::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  RegionPtr regPtr0 = getHelper()->getRegion("DistRegionAck");
  ...
  PdxTestsAuto::PdxType2V1Ptr  pRet = dynCast<PdxTestsAuto::PdxType2V1Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes2V2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypes2V2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypes2V2Ptr>(regPtr0->get(keyport));
  bool isEqual = np->equals(pRet);
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxType1V1::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxType1V1Ptr  pRet = dynCast<PdxTestsAuto::PdxType1V1Ptr>(regPtr0->get(keyport));
...
DUNIT_TASK_DEFINITION(CLIENT2, putAtVersionTwo1)
{
  ...
  PdxTestsAuto::PdxTypesR1V2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesR1V2Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypesV1R1::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypesV1R1Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesV1R1Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  RegionPtr regPtr0 = getHelper()->getRegion("DistRegionAck");
  PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV2Ptr np(new PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV2());
  CacheableKeyPtr keyport = CacheableKey::create(1);
  regPtr0->put(keyport, np );

  PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV2Ptr>(regPtr0->get(keyport));
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV1::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV1Ptr  pRet = dynCast<PdxTestsAuto::PdxTypesIgnoreUnreadFieldsV1Ptr>(regPtr0->get(keyport));
  regPtr0->put(keyport, pRet );
}
END_TASK_DEFINITION
...
{
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes1V2::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  ...
  PdxTestsAuto::PdxTypes1V2Ptr  pRet = dynCast<PdxTestsAuto::PdxTypes1V2Ptr>(regPtr0->get(keyport));
...
DUNIT_TASK_DEFINITION(CLIENT1, getPutAtVersionOne13)
{
  ...
  PdxTestsAuto::PdxType1V1Ptr  pRet = dynCast<PdxType1V1Ptr>(regPtr0->get(keyport));
  bool isEqual = np->equals(pRet);
...
DUNIT_TASK_DEFINITION(CLIENT2, getPutAtVersionTwo16)
{
  ...
  regPtr0->put(keyport, pRet );
  LOGDEBUG("getPutAtVersionTwo16 m_useWeakHashMap = %d and TestUtils::testNumberOfPreservedData() = %d", m_useWeakHashMap, TestUtils::testNumberOfPreservedData());
}
END_TASK_DEFINITION
...
DUNIT_TASK_DEFINITION(CLIENT1, PutAndVerifyPdxInGet)
{
  ...
  LOGINFO("PdxSerializations = %d ", lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializations());
  LOGINFO("PdxDeSerializations = %d ", lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations());
  LOGINFO("PdxSerializationBytes = %ld ", lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializationBytes());
  LOGINFO("PdxDeSerializationBytes = %ld ", lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes());
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializations() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations(),
    "Total pdxDeserializations should be equal to Total pdxSerializations.");
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializationBytes() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes(),
    "Total pdxDeserializationBytes should be equal to Total pdxSerializationsBytes.");  
...
DUNIT_TASK_DEFINITION(CLIENT1, PutAndVerifyNestedPdxInGet)
{
  ...
  try{
	  Serializable::registerPdxType(PdxTestsAuto::NestedPdx::createDeserializable);
	}catch (const IllegalStateException& ) {
		    // ignore exception
	}

  try{
	  Serializable::registerPdxType(PdxTestsAuto::PdxTypes1::createDeserializable);
	}catch (const IllegalStateException& ) {
		    // ignore exception
	}

  try{
	  Serializable::registerPdxType(PdxTestsAuto::PdxTypes2::createDeserializable);
	}catch (const IllegalStateException& ) {
		    // ignore exception
	}
  ...
  PdxTestsAuto::NestedPdxPtr obj2 = dynCast<PdxTestsAuto::NestedPdxPtr>(regPtr0->get(keyport));  
...
DUNIT_TASK_DEFINITION(CLIENT1, PutAndVerifyPdxInGFSInGet)
{
  ...
  try{
    Serializable::registerType(PdxTestsAuto::PdxInsideIGFSerializable::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  try{
  ...
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes3::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }
  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes4::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }

  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes5::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }

  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes6::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }

  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes7::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }

  try{
    Serializable::registerPdxType(PdxTestsAuto::PdxTypes8::createDeserializable);
  }catch (const IllegalStateException& ) {
    // ignore exception
  }

  RegionPtr regPtr0 = getHelper()->getRegion("DistRegionAck");
  PdxTestsAuto::PdxInsideIGFSerializablePtr np(new PdxTestsAuto::PdxInsideIGFSerializable());

  CacheableKeyPtr keyport = CacheableKey::create(1);
  regPtr0->put(keyport, np );

  //GET
  PdxTestsAuto::PdxInsideIGFSerializablePtr pRet = dynCast<PdxTestsAuto::PdxInsideIGFSerializablePtr>(regPtr0->get(keyport));
...
DUNIT_TASK_DEFINITION(CLIENT2, VerifyPdxInGFSGetOnly)
{
  ...
  RegionPtr regPtr0 = getHelper()->getRegion("DistRegionAck");
  PdxTestsAuto::PdxInsideIGFSerializablePtr orig(new PdxTestsAuto::PdxInsideIGFSerializable());
...
DUNIT_TASK_DEFINITION(CLIENT2, VerifyGetOnly)
{
  ...
  LOGINFO("PdxDeSerializationBytes = %ld ", lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes());
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializations() < lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations(),
    "Total pdxDeserializations should be less than Total pdxSerializations.");
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializationBytes() < lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes(),
    "Total pdxDeserializationBytes should be less than Total pdxSerializationsBytes.");
...
DUNIT_TASK_DEFINITION(CLIENT1, PutAndVerifyVariousPdxTypes)
{
	...
	try{
	  Serializable::registerPdxType(PdxTestsAuto::PdxTypes9::createDeserializable);
	}catch (const IllegalStateException& ) {
		    // ignore exception
	}
	try{
	  Serializable::registerPdxType(PdxTestsAuto::PdxTypes10::createDeserializable);
	}catch (const IllegalStateException& ) {
		    // ignore exception
	}
	...
	bool flag = false;
	{
		...
		regPtr0->put(keyport, p1 );
		PdxTestsAuto::PdxTypes1Ptr  pRet = dynCast<PdxTestsAuto::PdxTypes1Ptr>(regPtr0->get(keyport));

		flag = p1->equals(pRet);
		LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
		ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes1 should be equal");
		checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes2Ptr pRet2 = dynCast<PdxTestsAuto::PdxTypes2Ptr>(regPtr0->get(keyport2));

    flag = p2->equals(pRet2);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes2 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes3Ptr pRet3 = dynCast<PdxTestsAuto::PdxTypes3Ptr>(regPtr0->get(keyport3));

    flag = p3->equals(pRet3);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes3 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes4Ptr pRet4 = dynCast<PdxTestsAuto::PdxTypes4Ptr>(regPtr0->get(keyport4));

    flag = p4->equals(pRet4);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes4 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes5Ptr pRet5 = dynCast<PdxTestsAuto::PdxTypes5Ptr>(regPtr0->get(keyport5));

    flag = p5->equals(pRet5);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes5 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes6Ptr pRet6 = dynCast<PdxTestsAuto::PdxTypes6Ptr>(regPtr0->get(keyport6));

    flag = p6->equals(pRet6);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes6 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes7Ptr pRet7 = dynCast<PdxTestsAuto::PdxTypes7Ptr>(regPtr0->get(keyport7));

    flag = p7->equals(pRet7);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes7 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes8Ptr pRet8 = dynCast<PdxTestsAuto::PdxTypes8Ptr>(regPtr0->get(keyport8));

    flag = p8->equals(pRet8);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes8 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes9Ptr pRet9 = dynCast<PdxTestsAuto::PdxTypes9Ptr>(regPtr0->get(keyport9));

    flag = p9->equals(pRet9);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes9 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    PdxTestsAuto::PdxTypes10Ptr pRet10 = dynCast<PdxTestsAuto::PdxTypes10Ptr>(regPtr0->get(keyport10));

    flag = p10->equals(pRet10);
    LOGDEBUG("PutAndVerifyVariousPdxTypes:.. flag = %d", flag);
    ASSERT(flag == true, "Objects of type PdxTestsAuto::PdxTypes10 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...
DUNIT_TASK_DEFINITION(CLIENT3, client3GetsV2Object)
{
	...
	CacheablePtr args = CacheableKey::create("compareDotNETPdxTypes");
	  ...
	  LOGINFO("NIL:: testTCPDXTests:verifyDotNetPdxTypes result->size = %d ", result->size());
	  if(result==NULLPTR)
	  {
	    ...
	    for(int i=0; i<result->size(); i++) {
	      try {
	        CacheableBooleanPtr  boolValue = dynCast<CacheableBooleanPtr>(result->operator[](i));
	        LOGINFO("NIL::verifyDotNetPdxTypes boolValue is %d ", boolValue->value());
	        bool resultVal = boolValue->value();
	        ASSERT(resultVal == true, "Function should return true NIL LINE_1508");
	        gotResult = true;
	      }
	        ...
	        LOG(logmsg.c_str());
	        ex.printStackTrace();
	        LOG("exFuncNameSendException now casting to UserFunctionExecutionExceptionPtr for arrayList arguement exception.");
...
DUNIT_TASK_DEFINITION(CLIENT2, VerifyVariousPdxGets)
{
  ...
  bool flag = false;
    ...
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes1 should be equal");
		checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p2->equals(pRet2);
    LOGDEBUG("VerifyVariousPdxGets:. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes2 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p3->equals(pRet3);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes3 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p4->equals(pRet4);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes4 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p5->equals(pRet5);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes5 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p6->equals(pRet6);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes6 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p7->equals(pRet7);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes7 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p8->equals(pRet8);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes8 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p9->equals(pRet9);
    LOGDEBUG("VerifyVariousPdxGets:. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes9 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...

  {
    ...
    flag = p10->equals(pRet10);
    LOGDEBUG("VerifyVariousPdxGets:.. flag = %d", flag);
    ASSERT(flag == true, "VerifyVariousPdxGets:Objects of type PdxTestsAuto::PdxTypes10 should be equal");
    checkPdxInstanceToStringAtServer(regPtr0);
...
DUNIT_TASK_DEFINITION(CLIENT1, putCharTypes)
{
  ...
  try{
    Serializable::registerPdxType(PdxTestsAuto::CharTypes::createDeserializable);
  }catch (const IllegalStateException& ) {
  	    // ignore exception
  }
...
DUNIT_TASK_DEFINITION(CLIENT2, getCharTypes)
{
  ...
  PdxTestsAuto::CharTypesPtr  remotePdxptr = dynCast<PdxTestsAuto::CharTypesPtr>(regPtr0->get(keyport));
  LOG("Client-2 PdxTestsAuto::CharTypes GET OP Done....");


  PdxTestsAuto::CharTypes* localPdx  = localPdxptr.ptr();
  PdxTestsAuto::CharTypes* remotePdx = dynamic_cast<PdxTestsAuto::CharTypes*>(remotePdxptr.ptr());

  LOGINFO("testThinClientPdxTests:StepFour before equal() check");
  ASSERT(remotePdx->equals(*localPdx) == true, "PdxTestsAuto::PdxTypes should be equal.");
...
DUNIT_TASK_DEFINITION(CLIENT1, StepThree)
{
  ...
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(1, "street0", "city0")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(2, "street1", "city1")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(3, "street2", "city2")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(4, "street3", "city3")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(5, "street4", "city4")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(6, "street5", "city5")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(7, "street6", "city6")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(8, "street7", "city7")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(9, "street8", "city8")));
  m_objectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(10, "street9", "city9")));
  ...
  LocalRegion* lregPtr = (dynamic_cast<LocalRegion *>(regPtr0.ptr()));
  LOGINFO("PdxTestsAutoPdxSerializations = %d ", lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializations());
  LOGINFO("PdxTestsAuto PdxDeSerializations = %d ", lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations());
  LOGINFO("PdxTestsAutoPdxSerializationBytes = %ld ", lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializationBytes());
  LOGINFO("PdxTestsAutoPdxDeSerializationBytes = %ld ", lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes());
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializations() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations(),
    "Total pdxDeserializations should be equal to Total pdxSerializations.");
  ASSERT(lregPtr->getCacheImpl()->m_cacheStats->getPdxSerializationBytes() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes(),
    "Total pdxDeserializationBytes should be equal to Total pdxSerializationsBytes.");

  //Now update new keys with updated stats values, so that other client can verify these values with its stats.
  CacheableKeyPtr keyport3 = CacheableKey::create(3);
  CacheableKeyPtr keyport4 = CacheableKey::create(4);
  regPtr0->put(keyport3, CacheableInt32::create(lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations()));
  regPtr0->put(keyport4, CacheableInt64::create(lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes()));  
...
DUNIT_TASK_DEFINITION(CLIENT2, StepFour)
{
  ...
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(1, "street0", "city0")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(2, "street1", "city1")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(3, "street2", "city2")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(4, "street3", "city3")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(5, "street4", "city4")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(6, "street5", "city5")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(7, "street6", "city6")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(8, "street7", "city7")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(9, "street8", "city8")));
  m_localObjectArray->push_back(PdxTestsAuto::AddressPtr(new PdxTestsAuto::Address(10, "street9", "city9")));

  //Get remote CacheableObjectArray on key 2
  CacheableKeyPtr keyport2 = CacheableKey::create(2);
  LOGINFO("Client-2 PdxTestsAuto::PdxType GET OP Start....");
  CacheableObjectArrayPtr  remoteCObjArray = dynCast<CacheableObjectArrayPtr>(regPtr0->get(keyport2));

  LOGINFO("Client-2 PdxTestsAuto::PdxType GET OP Done.. Received CObjeArray Size = %d", remoteCObjArray->size());
  ASSERT(remoteCObjArray->size() == 10, "PdxTestsAuto StepFour: CacheableObjectArray Size should be equal to 10");


  //Compare local vs remote CacheableObjectArray elements.
  bool isEqual = true;
  for(int i = 0; i< remoteCObjArray->size(); i++) {
    PdxTestsAuto::Address* rAddr1 = dynamic_cast<PdxTestsAuto::Address*>(remoteCObjArray->at(i).ptr());
    PdxTestsAuto::Address* lAddr1 = dynamic_cast<PdxTestsAuto::Address*>(m_localObjectArray->at(i).ptr());
    LOGINFO("Remote PdxTestsAuto::Address:: %d th element  AptNum=%d  street=%s  city=%s ", i, rAddr1->getAptNum(), rAddr1->getStreet(), rAddr1->getCity());
    if (!rAddr1->equals(*lAddr1)){
      isEqual = false;
      break;
    }
  }
  ASSERT(isEqual == true, "PdxTestsAuto StepFour: CacheableObjectArray elements are not matched");

  PdxTestsAuto::PdxTypePtr localPdxptr(new PdxTestsAuto::PdxType());

  CacheableKeyPtr keyport = CacheableKey::create(1);
  LOG("Client-2 PdxTestsAuto::PdxType GET OP Start....");
  PdxTestsAuto::PdxTypePtr  remotePdxptr = dynCast<PdxTestsAuto::PdxTypePtr>(regPtr0->get(keyport));
  LOG("Client-2 PdxTestsAuto::PdxType GET OP Done....");

  //
  PdxTestsAuto::PdxType* localPdx  = localPdxptr.ptr();
    PdxTestsAuto::PdxType* remotePdx = dynamic_cast<PdxTestsAuto::PdxType*>(remotePdxptr.ptr());

    //ToDo open this equals check
  LOGINFO("testThinClientPdxTests:StepFour before equal() check");
  ASSERT(remotePdx->equals(*localPdx, false) == true, "PdxTestsAuto::PdxTypes should be equal.");
  LOGINFO("testThinClientPdxTests:StepFour equal check done successfully");
  ...
  LOGINFO("GET OP Result: Array of byte arrays [2]=%x", remotePdx->getArrayOfByteArrays()[1][1]);
  ...
  CacheableKeyPtr keyport3 = CacheableKey::create(3);
  CacheableKeyPtr keyport4 = CacheableKey::create(4);
  CacheableInt32Ptr int32Ptr = dynCast<CacheableInt32Ptr> (regPtr0->get(keyport3));
  CacheableInt64Ptr int64Ptr = dynCast<CacheableInt64Ptr> (regPtr0->get(keyport4));
  ASSERT(int32Ptr->value() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializations(),
    "Total pdxDeserializations should be equal to Total pdxSerializations.");
  ASSERT(int64Ptr->value() == lregPtr->getCacheImpl()->m_cacheStats->getPdxDeSerializationBytes(),
    "Total pdxDeserializationBytes should be equal to Total pdxSerializationsBytes.");    
...
void runPdxTestForCharTypes(bool poolConfig = false, bool withLocators = false)
{
  if(!poolConfig){
    CALL_TASK(CreateServer)
    CALL_TASK(StepOne)
...
void testPolymorphicUseCase(bool poolConfig = false, bool withLocators = false)
{
  if(withLocators){
    CALL_TASK(StartLocator)
    CALL_TASK(CreateServerWithLocator2)
