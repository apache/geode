...
void createPooledRegion( const char * name, bool ackMode, const char * endpoints, const char* locatorsG,const char* poolname, bool clientNotificationEnabled = false, bool cachingEnable = true)
{
...
END_TASK_DEFINITION
void runThinClientInterestList(bool poolConfig = true, bool isLocator = true)
{
