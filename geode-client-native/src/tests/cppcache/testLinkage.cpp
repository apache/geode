...
BEGIN_TEST(LinkageTest)
    ...
    }
    {
      ...
      // all exceptions.
      IllegalArgumentException aIllegalArgumentException("IllegalArgumentException");
      ...
      RegionDestroyedException aRegionDestroyedException("RegionDestroyedException");
      ...
      AlreadyConnectedException aAlreadyConnectedException("AlreadyConnectedException");
      ...
      UnsupportedOperationException aUnsupportedOperationException("UnsupportedOperationException");
      StatisticsDisabledException aStatisticsDisabledException("StatisticsDisabledException");
      ConcurrentModificationException aConcurrentModificationException("ConcurrentModificationException");
    ...
    DistributedSystemPtr distSysPtr = DistributedSystem::connect( "foo" );
    CachePtr cachePtr;
    //    CacheFactory cf;
    cachePtr = CacheFactory::create( (char *)"playmoney", distSysPtr );
    // Cache cache;
