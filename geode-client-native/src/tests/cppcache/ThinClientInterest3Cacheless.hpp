...
{
  initClient(true);
  createPooledRegion( regionNames[0],false/*ack mode*/,NULL/*endpoints*/,locatorsG, "__TEST_POOL1__",true/*client notification*/, NULLPTR/*cachelistener*/,false/*caching*/);
  reg1Listener1 = new TallyListener();
  reg1Writer1   = new TallyWriter  ();
  setCacheListener(regionNames[0],reg1Listener1);
  setCacheWriter  (regionNames[0],reg1Writer1  );
...
{
  initClient(true);
  createPooledRegion( regionNames[0],false/*ack mode*/,endPoint/*endpoints*/,NULL, "__TEST_POOL1__",true/*client notification*/, NULLPTR/*cachelistener*/,false/*caching*/);
  reg1Listener1 = new TallyListener();
  reg1Writer1   = new TallyWriter  ();
  setCacheListener(regionNames[0],reg1Listener1);
  setCacheWriter  (regionNames[0],reg1Writer1  );
...
void testThinClientInterest3Cacheless( bool poolConfig, bool isLocator = true)
{
