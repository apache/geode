...
typedef gemfire::SharedPtr< TallyWriter >
   TallyWriterPtr;
...
int expectCreates( int expected )
  ...
  {
    char buf[1024];
    sprintf( buf, "TallyWriter state: (updates = %d, creates = %d, invalidates = %d, destroy = %d)",
