...
class TestPdxSerializer : public PdxSerializer
{
  ...
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in deallocate()");
    LOG("TestPdxSerializer::deallocate called");
    if (strcmp(className, CLASSNAME1) == 0) {
      PdxTests::NonPdxType * npt = reinterpret_cast<PdxTests::NonPdxType *>(testObject);
      delete npt;
    } else {
      PdxTests::NonPdxAddress * npa = reinterpret_cast<PdxTests::NonPdxAddress *>(testObject);
      delete npa;
    }
  }
  ...
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in objectSize()");
  ...
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in getDeallocator");
    return deallocate;
  }

  UserObjectSizer getObjectSizer(const char * className)
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in getObjectSizer");
    return objectSize;
  }
  ...
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in fromData");
    ...
    try
    {
      ...
      int32_t arrLen = 0;
      npt->m_byteByteArray = pr->readArrayOfByteArrays("m_byteByteArray", arrLen, &Lengtharr);
      ...
      npt->m_doubleArray = pr->readDoubleArray("m_doubleArray", npt->doubleArrayLen);
      npt->m_float = pr->readFloat("m_float");
      npt->m_floatArray = pr->readFloatArray("m_floatArray", npt->floatArrayLen);
      ...
      npt->m_int16Array = pr->readShortArray("m_int16Array", npt->shortArrayLen);
      npt->m_sbyte = pr->readByte("m_sbyte");
      npt->m_sbyteArray = pr->readByteArray("m_sbyteArray", npt->byteArrayLen);
      npt->m_stringArray = pr->readStringArray("m_stringArray", npt->strLenArray);
      ...
      npt->m_uint16Array = pr->readShortArray("m_uint16Array", npt->shortArrayLen);
  ...
  {
    ASSERT(strcmp(className, CLASSNAME1) == 0 || strcmp(className, CLASSNAME2) == 0, "Unexpected classname in toData");
    ...
    try
    {
      ...
      lengthArr[0] = 1;
      lengthArr[1] = 2;
      pw->writeArrayOfByteArrays("m_byteByteArray", npt->m_byteByteArray, 2, lengthArr);
