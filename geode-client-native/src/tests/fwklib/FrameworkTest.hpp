...
class FrameworkTest // Base class all test classes written for xml testing should derive from.
{
private:
  TestDriver * m_coll;
  int32_t m_id;
...
public:
  ...
  void cacheInitialize( PropertiesPtr& props,const CacheAttributesPtr& cAttrs = NULLPTR);
  ...
  void setCacheLevelEp( bool ispool=false );
  ...
  CacheTransactionManagerPtr gettxManager()
  {
	  return txManager;
  }
  ...
  inline int64_t getAdjustedNowMicros() { return m_timeSync->adjustedNowMicros(); }
  ...
  /** @brief dump all data
    ...
    */
  inline std::string bbDump() const {
    return m_bbc->dump();
  }
  ...
  /** @brief clear BB data
    ...
    * @retval true = Success, false = Failed
    */
  inline void bbClear( const std::string & bb ) const {
    m_bbc->clear( bb );
  }
  ...
  /** @brief get BB key value
    ...
    */
  inline std::string bbGetString( const std::string & bb, const std::string & key ) const {
  ...
  /** @brief set BB key value
    ...
    */
  inline void bbSet( const std::string & bb, const std::string & key, const std::string & val ) const {
  ...
  /** @brief set BB counter value
    ...
    * @param val value to set
    */
  inline void bbSet( const std::string & bb, const std::string & cntr, const int64_t val ) const {
  ...
  /** @brief add BB counter value
    ...
    */
  inline int64_t bbAdd( const std::string & bb, const std::string & cntr, const int64_t val ) const {
  ...
  /** @brief increment BB counter value by 1
    ...
    */
  inline int64_t bbIncrement( const std::string & bb, const std::string & cntr ) const {
  ...
  /** @brief decrement BB counter value by 1
    ...
    */
  inline int64_t bbDecrement( const std::string & bb, const std::string & cntr ) const {
  ...
  /** @brief setIfGreater BB counter value is greater
    ...
    */
  inline int64_t bbSetIfGreater( const std::string & bb, const std::string & cntr, const int64_t val ) const {
  ...
  /** @brief setIfLess BB counter value is less
    ...
    */
  inline int64_t bbSetIfLess( const std::string & bb, const std::string & cntr, const int64_t val ) const {
