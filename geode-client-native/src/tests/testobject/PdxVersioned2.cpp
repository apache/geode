...
template <typename T1, typename T2>
bool PdxTests::PdxVersioned2::genericCompare(T1* value1, T2* value2, int length) const
{
  int i = 0;
  while (i < length)
  {
...
template <typename T1, typename T2>
bool PdxTests::PdxVersioned2::generic2DCompare(T1** value1, T2** value2, int length, int* arrLengths) const
{
...
PdxVersioned2::PdxVersioned2(const char* key){
	init(key);
}
...
bool PdxTests::PdxVersioned2::equals(PdxTests::PdxVersioned2& other, bool isPdxReadSerialized)const {
