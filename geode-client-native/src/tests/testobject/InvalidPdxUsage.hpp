...
class TESTOBJECT_EXPORT CharTypesWithInvalidUsage : public PdxSerializable
{
  ...
  bool equals(CharTypesWithInvalidUsage& other)const {
    ...
    CharTypesWithInvalidUsage* ot = dynamic_cast<CharTypesWithInvalidUsage*>(&other);
    if (ot == NULL) {
      return false;
    }
    if (ot == this) {
    ...
    LOGINFO("CharTypesWithInvalidUsage::equals ot->m_ch = %c m_ch = %c AND ot->m_widechar = %lc m_widechar = %lc", ot->m_ch, m_ch, ot->m_widechar, m_widechar);
    ...
    while (i < 2)
    {
      LOGINFO("CharTypesWithInvalidUsage::equals Normal char array values ot->m_chArray[%d] = %c m_chArray[%d] = %c", i, ot->m_chArray[i], i, m_chArray[i]);
      LOGINFO("CharTypesWithInvalidUsage::equals Wide char array values ot->m_widecharArray[%d] = %lc m_widecharArray[%d] = %lc", i, ot->m_widecharArray[i], i, m_widecharArray[i]);
...
public:
  ...
  AddressWithInvalidAPIUsage(int32_t aptN, const char* street, const char* city)
  {
    _aptNumber = aptN;
	_street = street;
	_city = city;
  ...
  bool equals(AddressWithInvalidAPIUsage& other)const {
    LOGDEBUG("Inside AddressWithInvalidAPIUsage equals");
	  AddressWithInvalidAPIUsage* ot = dynamic_cast<AddressWithInvalidAPIUsage*>(&other);
    if (ot == NULL) {
      return false;
    }
    if (ot == this) {
...
public:
  ...
  inline void init(){
    ...
    m_pdxEnum = CacheableEnum::create("PdxTests.pdxEnumTestWithInvalidAPIUsage", "mypdx2" , mypdx2);
    ...
    /*
    AddressWithInvalidAPIUsagePtr addObj1(new AddressWithInvalidAPIUsage(1, "abc", "ABC"));
    AddressWithInvalidAPIUsagePtr addObj2(new AddressWithInvalidAPIUsage(2, "def", "DEF"));
    AddressWithInvalidAPIUsagePtr addObj3(new AddressWithInvalidAPIUsage(3, "ghi", "GHI"));*/

    m_objectArray = CacheableObjectArray::create();
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(1, "street0", "city0")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(2, "street1", "city1")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(3, "street2", "city2")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(4, "street3", "city3")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(5, "street4", "city4")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(6, "street5", "city5")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(7, "street6", "city6")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(8, "street7", "city7")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(9, "street8", "city8")));
    m_objectArray->push_back(AddressWithInvalidAPIUsagePtr(new AddressWithInvalidAPIUsage(10, "street9", "city9")));
  ...
  int gettoDataExceptionCount(){
    return toDataexceptionCounter;
  }

  int getfromDataExceptionCount(){
    return fromDataexceptionCounter;
  }
  ...
  const char* getClassName()const {
    return "PdxTests.InvalidPdxUsage";
  }
