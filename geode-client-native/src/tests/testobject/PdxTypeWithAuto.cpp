...
template <typename T1, typename T2>
bool PdxTestsAuto::PdxType::genericCompare(T1* value1, T2* value2, int length) const
{
  int i = 0;
  while (i < length)
  {
...
template <typename T1, typename T2>
bool PdxTestsAuto::PdxType::generic2DCompare(T1** value1, T2** value2, int length, int* arrLengths) const
{
...
bool PdxTestsAuto::PdxType::equals(PdxTestsAuto::PdxType& other, bool isPdxReadSerialized)const {
