...
public:
  ...
  inline void init(){
    ...
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(1, "street0", "city0"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(2, "street1", "city1"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(3, "street2", "city2"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(4, "street3", "city3"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(5, "street4", "city4"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(6, "street5", "city5"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(7, "street6", "city6"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(8, "street7", "city7"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(9, "street8", "city8"), "PdxTests.Address")));
    m_objectArray->push_back(PdxWrapperPtr(new PdxWrapper(new NonPdxAddress(10, "street9", "city9"), "PdxTests.Address")));
