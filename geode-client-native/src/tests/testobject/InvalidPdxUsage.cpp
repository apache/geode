...
template <typename T1, typename T2>
bool InvalidPdxUsage::generic2DCompare(T1** value1, T2** value2, int length, int* arrLengths) const
{
...
void InvalidPdxUsage::toData( PdxWriterPtr pw ) /*const*/ {
  ...
  LOGINFO(" NILKANTH InvalidPdxUsage::toData() Start exceptionCounter = %d ", toDataexceptionCounter);
  ...
  //TestCase: writeArrayOfByteArrays with empty field name, IllegalStateException is expected
  bool excptExpected = false;

  try{
    pw->writeArrayOfByteArrays("", m_byteByteArray, 2, lengthArr);
  }catch(IllegalStateException& excpt){
	toDataexceptionCounter++;
	LOGINFO("writeArrayOfByteArrays():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeWideChar():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeBoolean():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeBooleanArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
	LOGINFO("writeByteArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeWideCharArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for ArrayList:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for Map:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for HashTable:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for Vector:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for CacheableHashSet:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for CacheableLinkedHashSet:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeString():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeDouble():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeDoubleArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeFloatArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeIntArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeLongArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeShortArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeStringArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for Enum:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObject() for Custom Object Address:: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
	...
	toDataexceptionCounter++;
    LOGINFO("writeObjectArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
...
void  InvalidPdxUsage::fromData( PdxReaderPtr pr )
{
  ...
  LOGINFO(" NILKANTH InvalidPdxUsage::fromData() Start fromDataexceptionCounter = %d ", fromDataexceptionCounter);
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readArrayOfByteArrays():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readWideChar():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readBoolean():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readBooleanArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readByteArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readWideCharArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readDoubleArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readFloatArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readIntArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readLongArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readShortArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readStringArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  try{
    ...
    exceptionCounter++;
    LOGINFO("readObjectArray():: Got expected Exception :: %s ", excpt.getMessage());
  }
  ...
  LOGINFO("InvalidPdxUsage::fromData() competed...fromDataexceptionCounter = %d and exceptionCounter=%d ", fromDataexceptionCounter, exceptionCounter);
} 
...
bool InvalidPdxUsage::equals(PdxTests::InvalidPdxUsage& other, bool isPdxReadSerialized)const {
  ...
  if (!isPdxReadSerialized) {
    for(int i = 0; i< m_objectArray->size(); i++) {
      AddressWithInvalidAPIUsage* otherAddr1 = dynamic_cast<AddressWithInvalidAPIUsage*>(ot->m_objectArray->at(i).ptr());
      AddressWithInvalidAPIUsage* myAddr1 = dynamic_cast<AddressWithInvalidAPIUsage*>(m_objectArray->at(i).ptr());
