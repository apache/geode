...
//
//  if (hasField)
//    throw new Exception("i7 is not an valid field");
//
//  hasField = pr->hasField("i4");
//
//	if (!hasField)
//    throw new Exception("i4 is an valid field");
//
//	/*
...
CacheableStringPtr PdxType1V1::toString() const {
  char idbuf[4096];
  //sprintf(idbuf,"PdxObject: [ m_bool=%d ] [m_byte=%d] [m_int16=%d] [m_int32=%d] [m_long=%lld] [m_float=%f] [ m_string=%s ]",m_bool, m_byte, m_int16, m_int32, m_long, m_float, m_string);
  //sprintf(idbuf,"PdxObject: [ m_bool=%d ] [m_byte=%d] [m_int16=%d] [m_int32=%d] [m_long=%lld] [m_float=%f] [m_double=%Lf] [ m_string=%s ]",m_bool, m_byte, m_int16, m_int32, m_long, m_float, m_double, m_string);
  ...
  sprintf(idbuf,"PdxType1V1:[ m_i1=%d ] [ m_i2=%d ] [ m_i3=%d ] [ m_i4=%d ]", m_i1, m_i2, m_i3, m_i4 );
...
CacheableStringPtr PdxType2V1::toString() const {
  char idbuf[4096];
  sprintf(idbuf,"PdxType2V1:[ m_i1=%d ] [ m_i2=%d ] [ m_i3=%d ] [ m_i4=%d ]", m_i1, m_i2, m_i3, m_i4 );
  return CacheableString::create( idbuf );
}
...
CacheableStringPtr PdxType3V1::toString() const {
  char idbuf[4096];
  sprintf(idbuf,"PdxType2V1:[ m_i1=%d ] [ m_i2=%d ] [m_str1=%s] [ m_i3=%d ] [ m_i4=%d ] [ m_i5=%d ] [m_str2=%s]", m_i1, m_i2, m_str1, m_i3, m_i4, m_i5, m_str2 );
  return CacheableString::create( idbuf );
}
...
bool PdxTypesIgnoreUnreadFieldsV1::equals(PdxSerializablePtr obj) {
	...
	PdxTypesIgnoreUnreadFieldsV1Ptr pap = dynCast<PdxTypesIgnoreUnreadFieldsV1Ptr>(obj);
	if (pap == NULLPTR)
		return false;
