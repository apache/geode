...
class GFIGNORE(TESTOBJECT_EXPORT) PdxTypesIgnoreUnreadFieldsV2 : public PdxSerializable {
...
class TestPdxSerializerForV2 : public PdxSerializer
{
  ...
  {
    //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0 , "Unexpected classname in deallocate()");
    LOGINFO("TestPdxSerializerForV2::deallocate called");
    if(strcmp(className, V2CLASSNAME3) == 0) {
      PdxTestsAuto::TestKeyV2 * tkv1 = reinterpret_cast<PdxTestsAuto::TestKeyV2 *>(testObject);
      delete tkv1;
    }else if(strcmp(className, V2CLASSNAME4) == 0){
      PdxTestsAuto::TestDiffTypePdxSV2 * dtpv1 = reinterpret_cast<PdxTestsAuto::TestDiffTypePdxSV2 *>(testObject);
      delete dtpv1;
    }else{
  ...
  {
    //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0, "Unexpected classname in objectSize()");
  ...
  {
    //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0, "Unexpected classname in getDeallocator");
    return deallocate;
  }

  UserObjectSizer getObjectSizer(const char * className)
  {
    //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0, "Unexpected classname in getObjectSizer");
    return objectSize;
  }
  ...
  void * fromDataForTestDiffTypePdxSV2(PdxReaderPtr pr)
  {
    try
    {
      PdxTestsAuto::TestDiffTypePdxSV2 * dtpv1 = new PdxTestsAuto::TestDiffTypePdxSV2;
  ...
  //{
  //  //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0, "Unexpected classname in fromData");
  ...
  //{
  //  //ASSERT(strcmp(className, V2CLASSNAME3) == 0 || strcmp(className, V2CLASSNAME4) == 0, "Unexpected classname in toData");
