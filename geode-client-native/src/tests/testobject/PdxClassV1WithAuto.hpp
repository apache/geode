 ...
 * *********************************************************/
class GFIGNORE(TESTOBJECT_EXPORT) PdxTypesIgnoreUnreadFieldsV1 : public PdxSerializable {
...
class TestPdxSerializerForV1 : public PdxSerializer
{
  ...
  static void deallocate(void * testObject, const char * className)
  {
    ...
    if(strcmp(className, V1CLASSNAME1) == 0) {
      PdxTestsAuto::TestKeyV1 * tkv1 = reinterpret_cast<PdxTestsAuto::TestKeyV1 *>(testObject);
      delete tkv1;
    }else if(strcmp(className, V1CLASSNAME2) == 0){
      PdxTestsAuto::TestDiffTypePdxSV1 * dtpv1 = reinterpret_cast<PdxTestsAuto::TestDiffTypePdxSV1 *>(testObject);
      delete dtpv1;
    }else{
  ...
  void * fromDataForTestDiffTypePdxSV1(PdxReaderPtr pr)
  {
    try
    {
      PdxTestsAuto::TestDiffTypePdxSV1 * dtpv1 = new PdxTestsAuto::TestDiffTypePdxSV1;
