...
CacheableStringPtr PdxTypes3::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes3:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s]", m_i1, m_i2, m_i3, m_i4, m_s1);
  return CacheableString::create(idbuf);
}
...
CacheableStringPtr PdxTypes4::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes4:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s]", m_i1, m_i2, m_i3, m_i4, m_s1);
  return CacheableString::create(idbuf);
}
...
bool PdxTypes5::equals(PdxSerializablePtr obj){
  ...
  if (m_i1 == pap->m_i1 && m_i2 == pap->m_i2 && m_i3 == pap->m_i3 && m_i4 == pap->m_i4 && (strcmp(m_s1, pap->m_s1) == 0) && (strcmp(m_s2, pap->m_s2) == 0))
		return true;
...
CacheableStringPtr PdxTypes5::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes4:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s] [m_s2=%s]", m_i1, m_i2, m_i3, m_i4, m_s1, m_s2);
  return CacheableString::create(idbuf);
}
...
CacheableStringPtr PdxTypes7::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes7:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s] [m_s2=%s]", m_i1, m_i2, m_i3, m_i4, m_s1, m_s2);
  return CacheableString::create(idbuf);
}
...
CacheableStringPtr PdxTypes8::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes8:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s] [m_s2=%s]", m_i1, m_i2, m_i3, m_i4, m_s1, m_s2);
  return CacheableString::create(idbuf);
}
...
bool PdxTypes9::equals(PdxSerializablePtr obj){
  ...
  if ((strcmp(m_s1, pap->m_s1) == 0)
      && (strcmp(m_s2, pap->m_s2) == 0)
       && (strcmp(m_s3, pap->m_s3) == 0)
        && (strcmp(m_s4, pap->m_s4) == 0)
...
CacheableStringPtr PdxTypes9::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxTypes9:[m_s1=%s] [m_s2=%s] [m_s3=%s] [m_s4=%s] [m_s5=%s] ", m_s1, m_s2, m_s3, m_s4, m_s5);
  return CacheableString::create(idbuf);
}
...
int32_t PdxTypes10::getHashCode(){
	return 1;
}
...
int32_t PdxInsideIGFSerializable::getHashCode(){
	return 1;
}
...
CacheableStringPtr PdxInsideIGFSerializable::toString() const {
  char idbuf[4096];
  sprintf(idbuf, "PdxInsideIGFSerializable:[m_i1=%d] [m_i2=%d] [m_i3=%d] [m_i4=%d] [m_s1=%s] [m_s2=%s]", m_i1, m_i2, m_i3, m_i4, m_s1, m_s2);
  return CacheableString::create(idbuf);
}
