...
class TestPdxSerializerForV1 : public PdxSerializer
{
  ...
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0 , "Unexpected classname in deallocate()");
    LOGINFO("TestPdxSerializer::deallocate called");
    if(strcmp(className, V1CLASSNAME1) == 0) {
      PdxTests::TestKeyV1 * tkv1 = reinterpret_cast<PdxTests::TestKeyV1 *>(testObject);
      delete tkv1;
    }else if(strcmp(className, V1CLASSNAME2) == 0){
      PdxTests::TestDiffTypePdxSV1 * dtpv1 = reinterpret_cast<PdxTests::TestDiffTypePdxSV1 *>(testObject);
      delete dtpv1;
    }else{
  ...
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0, "Unexpected classname in objectSize()");
  ...
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0, "Unexpected classname in getDeallocator");
    return deallocate;
  }

  UserObjectSizer getObjectSizer(const char * className)
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0, "Unexpected classname in getObjectSizer");
    return objectSize;
  }
  ...
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0, "Unexpected classname in fromData");
  ...
  {
    //ASSERT(strcmp(className, V1CLASSNAME1) == 0 || strcmp(className, V1CLASSNAME2) == 0, "Unexpected classname in toData");
