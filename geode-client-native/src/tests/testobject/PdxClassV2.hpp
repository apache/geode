...
class TestPdxSerializerForV2 : public PdxSerializer
{
  ...
  static void deallocate(void * testObject, const char * className)
  {
    ...
    if(strcmp(className, V2CLASSNAME3) == 0) {
      PdxTests::TestKeyV2 * tkv1 = reinterpret_cast<PdxTests::TestKeyV2 *>(testObject);
      delete tkv1;
    }else if(strcmp(className, V2CLASSNAME4) == 0){
      PdxTests::TestDiffTypePdxSV2 * dtpv1 = reinterpret_cast<PdxTests::TestDiffTypePdxSV2 *>(testObject);
      delete dtpv1;
    }else{
