...
class TESTOBJECT_EXPORT ParentPdx: public PdxSerializable {
  ...
  public:
    ...
    wchar_t* getWideCharArray(){
      return m_wideCharArray;
    }

    int32_t getCharArrayLength(){
      return m_charArrayLen;
    }

    int32_t getWideCharArrayLength(){
      return m_wcharArrayLen;
    }
    virtual void toData(PdxWriterPtr pw);
    ...
    const char* getClassName()const {
      return "testobject::ParentPdx";
    }

    static PdxSerializable* createDeserializable() {
      return new ParentPdx();
    }
  ...
  public:
    ...
    PdxEnumTestClass(int id)
    {
      ...
      { 
        case 0:
          ...
          m_enumid = CacheableEnum::create("enumQuerytest", "id1", /*enumQuerytest::*/id1);
          break;
        case 1:
          LOGINFO("case 1 id2 = %d ", id2);
          m_enumid = CacheableEnum::create("enumQuerytest", "id2", /*enumQuerytest::*/id2);
          break;
        case 2:
          LOGINFO("case 2 id3 = %d ", id3);
          m_enumid = CacheableEnum::create("enumQuerytest", "id3", /*enumQuerytest::*/id3);
          break;
        default:
    ...
    const char* getClassName()const {
      return "testobject::PdxEnumTestClass";
    }
  ...
  public: 
    ...
    bool equals(SerializePdx& other, bool isPdxReadSerialized)const {
      ...
      if (ot->i1 != i1 && ot->i2 !=i2 && 
        strcmp(ot->s1, s1) != 0 && strcmp(ot->s2, s2) != 0) {
