...
class PKCSCredentialGenerator : public CredentialGenerator
{
  public:
    ...
    : CredentialGenerator(ID_PKI,"PKCS") {
      };
     ...
     std::string getClientAuthenticator() {
       return
         "templates.security.PKCSAuthenticator.create";
     }
     ...
     void getValidCredentials(PropertiesPtr& p) {
       ...
       FWKINFO("inserted valid security-username "<<p->find("security-username")->asChar());
     }
     ...
     void getInvalidCredentials(PropertiesPtr& p) {
       ...
       setPKCSProperties(p ,username);
       FWKINFO("inserted invalid security-username "<<p->find("security-username")->asChar());
     }
