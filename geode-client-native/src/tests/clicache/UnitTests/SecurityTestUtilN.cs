...
namespace GemStone.GemFire.Cache.UnitTests.NewAPI
{
  ...
  public class SecurityTestUtil
  {
    ...
    public static void CreateClientMU(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, bool pool, bool locator, bool isMultiuser)
    {
    ...
    public static void CreateClientMU2(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, bool pool, bool locator, bool isMultiuser, bool notificationEnabled)
    {
      CreateClient<object, object>(regionName, endpoints, locators,
    ...
    public static void CreateClient(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, bool pool, bool locator)
    {
      CreateClient(regionName, endpoints, locators, authInit, credentials,
    ...
    public static void CreateClientSSL(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, bool pool, bool locator, bool ssl, bool withPassword)
    {
      CreateClient<object, object>(regionName, endpoints, locators, authInit, credentials,
    ...
    public static void CreateClient(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, ExpectedResult expect, int redundancy, bool pool, bool locator)
    {
      CreateClient<object, object>(regionName, endpoints, locators, authInit, credentials, true, true,
        redundancy, -1, null, expect, pool, locator);
    }

    public static void CreateClient(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, ExpectedResult expect, bool pool, bool locator,
      bool isMultiuser, string durebleClientId)
    {
      CreateClient<object, object>(regionName, endpoints, locators, authInit, credentials, false, false,
    ...
    public static void CreateClient<TKey, TValue>(string regionName, string endpoints, string locators,
      ...
      ICacheListener<TKey, TValue> listener, ExpectedResult expect, bool pool, bool locator)
    {
      CreateClient<TKey, TValue>(regionName, endpoints, locators, authInit, credentials, true, true,
    ...
    public static void CreateClient<TKey, TValue>(string regionName, string endpoints, string locators,
      string authInit, Properties<string, string> credentials, bool caching,
      bool clientNotification, int redundancyLevel, int numConnections,
      ICacheListener<TKey, TValue> listener, ExpectedResult expect, bool pool, bool locator, bool isMultiUser, string durableClientId, bool ssl, bool withPassword)
    {
      ...
      try
      {
        ...
        if (pool)
        {
          if (locator)
          {
            CacheHelper.CreatePool<TKey, TValue>("__TESTPOOL1_", (string)null, locators, (string)null,
          ...
          {
            CacheHelper.CreatePool<TKey, TValue>("__TESTPOOL1_", endpoints, (string)null, (string)null,
              redundancyLevel, clientNotification, numConnections, isMultiUser);
            CacheHelper.CreateTCRegion_Pool<TKey, TValue>(regionName, true, caching,
