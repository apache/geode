...
namespace GemStone.GemFire.Cache.UnitTests.NewAPI
{
  ...
  public class MyResultCollector<TResult> : Generic.IResultCollector<TResult>
  {
    ...
    {
      Util.Log("hitesh in MyResultCollector " + result + " :  " + result.GetType());
      m_addResultCount++;
  ...
  public class ThinClientFunctionExecutionTests : ThinClientRegionSteps
  {
    ...
    {
      CacheHelper.CreatePool<object, object>(name, endpoints, locators, serverGroup, redundancy, subscription, prSingleHop, threadLocal);
    }
    ...
    public void PoolStepOne(string locators)
    {
      ...
      Generic.IResultCollector<object> rc = exc.WithArgs<object>(args).WithFilter<object>(routingObj).Execute(getFuncName, getResult);
      ICollection<object> executeFunctionResult = rc.GetResult();
      List<object> resultList = new List<object>();
      //resultList.Clear();
      ...
      rc = exc.WithArgs<object>(args).WithFilter<object>(filter).Execute(exFuncNameSendException, getResult);
      ...
      rc = exc.WithArgs<object>(arrList).WithFilter<object>(filter).Execute(exFuncNameSendException, getResult);
      executeFunctionResult = rc.GetResult();      
      ...
      rc = exc.WithArgs<object>(args).WithCollector(myRC1).Execute(exFuncNameSendException, getResult);
      executeFunctionResult = rc.GetResult();
      ...
      rc = exc.WithArgs<ArrayList>(args1).WithCollector(myRC).Execute(getFuncIName, getResult);
      //executeFunctionResult = rc.GetResult();
      ...
      rc = exc.WithArgs<object>(args).WithCollector(myRC2).Execute(exFuncNameSendException, getResult);
      executeFunctionResult = rc.GetResult();
    ...
    public void genericFEResultIntTest(string locators)
    {
      ...
      Generic.IResultCollector<int> rc = exc.WithArgs<int>(args1).WithCollector(myRC).Execute("SingleStrGetFunction", getResult);
    ...
    public void genericFEResultStringTest(string locators)
    {
      ...
      Generic.IResultCollector<string> rc = exc.WithArgs<ArrayList>(args1).WithCollector(myRC).Execute("SingleStrGetFunction", getResult);
    ...
    public void genericFEResultDCStringTest(string locators)
    {
      ...
      GemStone.GemFire.Cache.Generic.Execution<string> exc = Generic.FunctionService<string>.OnServers/*OnRegion<string, string>*/(pl/*region*/);
      Generic.IResultCollector<string> rc = exc.WithArgs<ArrayList>(args1).Execute("SingleStrGetFunction", getResult);
    ...
    public void genericFEResultDCPdxTest(string locators)
    {
      ...
      Generic.IResultCollector<object> rc = exc.WithArgs<ArrayList>(args1).Execute("PdxFunctionTest", getResult);
    ...
    public void HAStepOne(string endpoints)
    {
      ...
      //     test get function with result
      GemStone.GemFire.Cache.Generic.Execution<object> exc = Generic.FunctionService<object>.OnRegion<object, object>(region);
      Generic.IResultCollector<object> rc = exc.WithArgs<bool>(args).WithFilter<object>(routingObj).Execute(getFuncName, getResult);
      ICollection<object> executeFunctionResult = rc.GetResult();
      List<object> resultList = new List<object>();
      //resultList.Clear();
    ...
    public void OnRegionHA()
    {
      ...
      Generic.IResultCollector<object> rc = exc.WithArgs<ArrayList>(args1).Execute(RegionOperationsHAFunctionPrSHOP, getResult, 15, true, true);
    ...
    public void OnRegionHAStepOne()
    {
      ...
      Generic.IResultCollector<object> rc = exc.WithArgs<ArrayList>(args1).Execute(RegionOperationsHAFunction, getResult, 15, true, true);
      ...
      filter[0] = "KEY--" + 10;
      rc = exc.WithArgs<ArrayList>(args1).WithFilter<Object>(filter).Execute(RegionOperationsHAFunction, getResult, 15, true, true);
    ...
    public void OnRegionPrSHOPSingleFilterKey()
    {
      ...
      for (int i = 0; i < 230; i++)
      {
        ...
        IResultCollector<object> rc = exc.WithFilter<object>(filter).Execute(FEOnRegionPrSHOP, getResult);
        ICollection<object> executeFunctionResult = rc.GetResult();
        ...
        rc = exc.WithFilter<object>(filter).Execute(FEOnRegionPrSHOP_OptimizeForWrite, getResult);
        executeFunctionResult = rc.GetResult();
    ...
    public void FEOnRegionTx()
    {
      ...
      IResultCollector<object> rc = exc.WithFilter<object>(filter).Execute(putFuncName, getResult);
    ...
    public void ExecuteFEOnRegionMultiFilterKeyStepOne()
    {
      ...
      for (int k = 0; k < 210; k++)
      {
        ...
        IResultCollector<object> rc = exc.WithFilter<object>(filter).Execute(getFuncName, getResult);
        ICollection<object> executeFunctionResult = rc.GetResult();
        ...
        MyResultCollector<object> myRC1 = new MyResultCollector<object>();
        rc = exc.WithFilter<object>(filter).WithCollector(myRC1).Execute(getFuncName, getResult);
        executeFunctionResult = rc.GetResult();
        Util.Log("add result count= {0}.", myRC1.GetAddResultCount());
        Util.Log("get result count= {0}.", myRC1.GetGetResultCount());
        Util.Log("end result count= {0}.", myRC1.GetEndResultCount());
    ...
    public void ExecuteFETimeOut()
    {
      ...
      for (int k = 0; k < 210; k++)
      {
        ...
        Execution<object> exc = Generic.FunctionService<object>.OnRegion<object, object>(region);
        IResultCollector<object> rc = exc.WithArgs<Object>(args).WithFilter<object>(filter).Execute(FuncTimeOutName, getResult, 5000);
      ...
      IResultCollector<object> rcs = excs.WithArgs<Object>(args).Execute(FuncTimeOutName, getResult, 5000);
      ...
      IResultCollector<object> rcss = excss.WithArgs<Object>(args).Execute(FuncTimeOutName, getResult, 5000);
    ...
    public void OnRegionMultiFilterKeyPrSHOP()
    {
      ...
      for (int k = 0; k < 210; k++)
      {
        ...
        MyResultCollector<object> myRC1 = new MyResultCollector<object>();
        rc = exc.WithFilter<object>(filter).WithCollector(myRC1).Execute(FEOnRegionPrSHOP, getResult);
        executeFunctionResult = rc.GetResult();
        Util.Log("add result count= {0}.", myRC1.GetAddResultCount());
        Util.Log("get result count= {0}.", myRC1.GetGetResultCount());
        Util.Log("end result count= {0}.", myRC1.GetEndResultCount());
        ...
        MyResultCollector<object> myRC2 = new MyResultCollector<object>();
        rc = exc.WithFilter<object>(filter).WithCollector(myRC2).Execute(FEOnRegionPrSHOP_OptimizeForWrite, getResult);
        executeFunctionResult = rc.GetResult();
        Util.Log("add result count= {0}.", myRC2.GetAddResultCount());
        Util.Log("get result count= {0}.", myRC2.GetGetResultCount());
        Util.Log("end result count= {0}.", myRC2.GetEndResultCount());
    ...
    public void OnServerHAStepOne()
    {
      ...
      Generic.IResultCollector<object> rc = exc.WithArgs<ArrayList>(args1).Execute(OnServerHAExceptionFunction, getResult, 15, true, false);
      ...
      rc = exc.WithArgs<ArrayList>(args1).Execute(OnServerHAShutdownFunction, getResult, 15, true, false);
    ...
    void runOnServerHAExecuteFunction(bool pool, bool locator)
    {
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, true, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, true, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
    ...
    void runFEOnRegionPrSHOPSingleFilterKey(bool pool, bool locator)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml",
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, true, true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, true, true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool endpoints) regions created");
        }
      }
    ...
    void runOnRegionHAExecuteFunction(bool pool, bool locator)
    {
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, /*singleHop*/false, /*threadLocal*/false);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, /*singleHop*/false, /*threadLocal*/false);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool endpoints) regions created");
        }
      }
    ...
    void runOnRegionHAExecuteFunctionPrSHOP(bool pool, bool locator)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml",
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, /*singleHop*/true, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, /*singleHop*/true, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool endpoints) regions created");
        }
      }
    ...
    void runExecuteFunctionOnRegionMultiFilterKey(bool pool, bool locator, bool singleHop)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml",
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, singleHop, /*threadLocal*/false);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, singleHop, /*threadLocal*/false);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool endpoints) regions created");
        }
      }
    ...
    void runExecuteFunctionTimeOut(bool pool, bool locator, bool singleHop)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml",
    ...
    void runFEOnRegionTx(bool pool, bool locator, bool singleHop)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml");
      ...
      if (pool)
      {
        if (locator)
        {
          m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, singleHop, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool locator) regions created");
        }
        else
        {
          m_client1.Call(createPool, poolName, CacheHelper.Endpoints, (string)null, serverGroup, 1, true, singleHop, /*threadLocal*/true);
          m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
          Util.Log("Client 1 (pool endpoints) regions created");
        }
      }
    ...
    void runFEOnRegionPrSHOPMultiFilterKey(bool pool, bool locator, bool singleHop)
    {
      if (pool && locator)
      {
        CacheHelper.SetupJavaServers(true, "func_cacheserver1_pool.xml",
    ...
    public void PoolExecuteFunctionTest()
    {
      ...
      CacheHelper.StartJavaServerWithLocators(2, "GFECS2", 1);
      Util.Log("Cacheserver 2 started.");
      m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 0, true, /*singleHop*/false, /*threadLocal*/false);
      m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
    ...
    public void PoolExecuteFunctionTestPrSHOP()
    {
      ...
      CacheHelper.StartJavaServerWithLocators(2, "GFECS2", 1);
      Util.Log("Cacheserver 2 started.");
      m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 0, true, /*singleHop*/true, /*threadLocal*/true);
      m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
    ...
    public void HAExecuteFunctionTestPrSHOP()
    {
      ...
      CacheHelper.StartJavaServerWithLocators(3, "GFECS3", 1);
      Util.Log("Cacheserver 3 started.");
      m_client1.Call(createPool, poolName, (string)null, CacheHelper.Locators, serverGroup, 1, true, /*singleHop*/true, true);
      m_client1.Call(createRegionAndAttachPool, QERegionName, poolName);
    ...
    {
      runOnRegionHAExecuteFunction(true, false); // pool with server endpoints singleHop = false
      runOnRegionHAExecuteFunction(true, true);  // pool with locators singleHop = false
    }

    [Test]
    public void TestFEOnRegionPrSHOPSingleFilterKey()
    {
      runFEOnRegionPrSHOPSingleFilterKey(true, true);  // pool with locators
      runFEOnRegionPrSHOPSingleFilterKey(true, false);  // pool with server endpoints
    }

    [Test]
    public void OnRegionHAExecuteFunctionTestPrSHOP()
    {
      runOnRegionHAExecuteFunctionPrSHOP(true, false); // pool with server endpoints singleHop = true
      runOnRegionHAExecuteFunctionPrSHOP(true, true);  // pool with locators singleHop = true
    }

    [Test]
    public void ExecuteFunctionOnRegionMultiFilterKey()
    {
      runExecuteFunctionOnRegionMultiFilterKey(true, false, false); // pool with server endpoints singleHop = false
      runExecuteFunctionOnRegionMultiFilterKey(true, true, false);  // pool with locators singleHop = false

      runExecuteFunctionOnRegionMultiFilterKey(true, false, true); // pool with server endpoints singleHop = true
      runExecuteFunctionOnRegionMultiFilterKey(true, true, true);  // pool with locators singleHop = true
    }

    [Test]
    public void ExecuteFunctionTimeOut()
    {
      runExecuteFunctionTimeOut(true, false, false); // pool with server endpoints singleHop = false
      runExecuteFunctionTimeOut(true, true, false);  // pool with locators singleHop = false

      runExecuteFunctionTimeOut(true, false, true); // pool with server endpoints singleHop = true
      runExecuteFunctionTimeOut(true, true, true);  // pool with locators singleHop = true
    }

    [Test]
    public void TestFEOnRegionPrSHOPMultiFilterKey()
    {
      runFEOnRegionPrSHOPMultiFilterKey(true, true, true);  // pool with locators singleHop = true
      runFEOnRegionPrSHOPMultiFilterKey(true, false, true);  // pool with endpoint singleHop = true
    }

    [Test]
    public void TestFEOnRegionTransaction()
    {
      runFEOnRegionTx(true, true, true);  // pool with locators singleHop = true
      runFEOnRegionTx(true, false, true);  // pool with endpoint singleHop = true
      runFEOnRegionTx(true, true, false);  // pool with locators singleHop = false
      runFEOnRegionTx(true, false, false);  // pool with endpoint singleHop = false
    }
  }
}
