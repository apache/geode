...
namespace GemStone.GemFire.Cache.UnitTests.NewAPI
{
  ...
  public class ThinClientDeltaTest : ThinClientRegionSteps
  {
    ...
    {
      CacheHelper.CreateLRUTCRegion_Pool<object, object>(regionName, true, true, null, null, null, poolName, false, 3);
    }
     ...
     // if (usePools)
      {
        ...
        m_client1.Call(CacheHelper.CreateTCRegion_Pool_AD1, regionName, false, true, (string)null, CacheHelper.Locators, (string)"__TEST_POOL1__", true, cloningenable);
        m_client2.Call(CacheHelper.CreateTCRegion_Pool_AD1, regionName, false, true, (string)null, CacheHelper.Locators, (string)"__TEST_POOL1__", false, cloningenable);
    ...
    void runPutWithDelta(bool usePools)
    {
      ...
      {
       throw new System.NotSupportedException("Old endpoints case not supported");
      }
    ...
    void runPut_Contains_Remove_WithDelta(bool usePools)
    {
      CacheHelper.SetupJavaServers(true, "cacheserver_with_delta.xml");
      CacheHelper.StartJavaLocator(1, "GFELOC1");
      CacheHelper.StartJavaServerWithLocators(1, "GFECS5", 1);
    ...
    {
      runPut_Contains_Remove_WithDelta(true);
    }
