...
namespace GemStone.GemFire.Cache.UnitTests.NewAPI
{
  ...
  public class ThinClientPoolTests : ThinClientRegionSteps
  {
    ...
    {
      DistributedSystem dsys = DistributedSystem.Connect("DSYS_PoolXmlCreation");
      ...
      Cache cache = CacheFactory.Create("CACHE_PoolXmlCreation", dsys, xmlLocation);
      ...
      try
      {
        ...
        CacheHelper.createDuplicateXMLFile(xmlLocation, duplicateXMLFile);
        xmlLocation = duplicateXMLFile;
        cache = CacheFactory.Create("CACHE_PoolXmlCreation", dsys, xmlLocation);
    ...
    {
      CacheHelper.CreateTCRegion_Pool<object, object>(regionName, true, true, null, null, null, poolName, false);
    }
    ...
    {
      CacheHelper.CreateTCRegion_Pool<object, object>(regionName, true, true, null, endpoints, locators, poolName, false);
    }

    public void createPooledRegionWithNotification(string regionName, string poolName, string endpoints, string locators)
    {
      CacheHelper.CreateTCRegion_Pool<object, object>(regionName, true, true, null, endpoints, locators, poolName, true);
    }

    public void createPool(string name, string endpoints, string locators, string serverGroup,
      int redundancy, bool subscription)
    {
      CacheHelper.CreatePool<object, object>(name, endpoints, locators, serverGroup, redundancy, subscription);
    }
    ...
    void runPoolLocator()
    {
      ...
      m_client1.Call(createPooledRegion, RegionName, "Pool1", (string)null, locators.Split(',')[0]);
      m_client2.Call(createPooledRegion, RegionName, "Pool2", (string)null, locators.Split(',')[0]);

      m_client1.Call(createPooledRegionWithNotification, RegionNames[1], "Pool3", (string)null, locators.Split(',')[0]);
      m_client2.Call(createPooledRegionWithNotification, RegionNames[1], "Pool3", (string)null, locators.Split(',')[0]);
    ...
    void runPoolServer()
    {
      ...
      m_client1.Call(CacheHelper.setPorts, CacheHelper.HOST_PORT_1, CacheHelper.HOST_PORT_2, CacheHelper.HOST_PORT_3, CacheHelper.LOCATOR_PORT_1, CacheHelper.LOCATOR_PORT_2);
      m_client1.Call(createPool, "__TEST_POOL1__", (string)null, CacheHelper.Locators, "ServerGroup1", 0, false);
      m_client1.Call(createRegionAndAttachPool, "PoolRegion1", "__TEST_POOL1__");
      ...
      m_client1.Call(CacheHelper.setPorts, CacheHelper.HOST_PORT_1, CacheHelper.HOST_PORT_2, CacheHelper.HOST_PORT_3, CacheHelper.LOCATOR_PORT_1, CacheHelper.LOCATOR_PORT_2);
      m_client2.Call(createPool, "__TEST_POOL1__", (string)null, CacheHelper.Locators, (string)null, 0, false);
    ...
    void runPoolRedundancy()
    {
      for (int runIndex = 0; runIndex < 2; runIndex++)
      {
        ...
        if (runIndex == 0)
        {
          m_client1.Call(createPool, "Pool1", (string)null, CacheHelper.Locators, "ServerGroup1", 2, true);
          m_client1.Call(createRegionAndAttachPool, "PoolRegion1", "Pool1");
          m_client1.Call(createPool, "Pool2", (string)null, CacheHelper.Locators, "ServerGroup1", 1, true);
          m_client1.Call(createRegionAndAttachPool, "PoolRegion2", "Pool2");
          m_client1.Call(createPool, "Pool3", (string)null, CacheHelper.Locators, "ServerGroup1", 0, true);
          ...
          m_client2.Call(createPool, "Pool1", (string)null, CacheHelper.Locators, (string)null, 2, true);
          m_client2.Call(createRegionAndAttachPool, "PoolRegion1", "Pool1");
          m_client2.Call(createPool, "Pool2", (string)null, CacheHelper.Locators, (string)null, 1, true);
          m_client2.Call(createRegionAndAttachPool, "PoolRegion2", "Pool2");
          m_client2.Call(createPool, "Pool3", (string)null, CacheHelper.Locators, (string)null, 0, true);
        ...
        else
        {
          m_client1.Call(createPool, "Pool1", (string)null, CacheHelper.Locators, "ServerGroup1", 2, true);
          m_client1.Call(createRegionAndAttachPool, "PoolRegion1", "Pool1");
          m_client1.Call(createPool, "Pool2", (string)null, CacheHelper.Locators, "ServerGroup2", 1, true);
          m_client1.Call(createRegionAndAttachPool, "PoolRegion2", "Pool2");
          m_client1.Call(createPool, "Pool3", (string)null, CacheHelper.Locators, "ServerGroup3", 0, true);
          m_client1.Call(createRegionAndAttachPool, "PoolRegion3", "Pool3");
          m_client1.Call(feedEntries, 0, false, false);
          m_client1.Call(registerAllKeys);

          string[] endpoints = CacheHelper.Endpoints.Split(',');
          string endpoints2 = endpoints[0] + ',' + endpoints[1];
          m_client2.Call(createPool, "Pool1", (string)null, CacheHelper.Locators, (string)null, 2, true);
          m_client2.Call(createRegionAndAttachPool, "PoolRegion1", "Pool1");
          m_client2.Call(createPool, "Pool2", (string)null, CacheHelper.Locators, (string)null, 1, true);
          m_client2.Call(createRegionAndAttachPool, "PoolRegion2", "Pool2");
    ...
    void runPoolRegisterInterest()
    {
      ...
      CacheHelper.StartJavaServerWithLocators(2, "GFECS2", 1);
      m_client1.Call(CacheHelper.setPorts, CacheHelper.HOST_PORT_1, CacheHelper.HOST_PORT_2, CacheHelper.HOST_PORT_3, CacheHelper.LOCATOR_PORT_1, CacheHelper.LOCATOR_PORT_2);
      m_client1.Call(createPool, "__TEST_POOL1__", (string)null, CacheHelper.Locators, "ServerGroup1", 0, true);
      m_client1.Call(createRegionAndAttachPool, "PoolRegion1", "__TEST_POOL1__");
