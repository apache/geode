  ...
  public abstract class DistOpsSteps : UnitTests
  {
      ...
      string endpoints, bool clientNotification)
    {
      CacheHelper.CreateTCRegion_Pool<string, string>(regionNames[0], true, true,
        null, endpoints, null, "__TESTPOOL__", clientNotification);
    ...
    public virtual void CreateTCRegions_Pool2_WithPartitionResolver(string[] regionNames,
      string endpoints, string locators, string poolName, bool clientNotification, bool pr)
    {
      CreateTCRegions_Pool2<object, object>(regionNames, endpoints, locators, poolName, clientNotification, false, pr);
    }

    public virtual void CreateTCRegions_Pool2<TKey, TVal>(string[] regionNames,
      string endpoints, string locators, string poolName, bool clientNotification, bool pr)
    {
      CreateTCRegions_Pool2<TKey, TVal>(regionNames, endpoints, locators, poolName, clientNotification, false, pr);
    }

    public virtual void CreateTCRegions_Pool2<TKey, TVal>(string[] regionNames,
      string endpoints, string locators, string poolName, bool clientNotification, bool ssl, bool pr)
    {
    ...
    public virtual void CreateTCRegions_Pool1(string regionNames,
      string endpoints, string locators, string poolName, bool clientNotification)
    {
      CreateTCRegions_Pool1(regionNames, endpoints, locators, poolName, clientNotification, false);
    }
      ...
      IPartitionResolver<TradeKey, Object> resolver, string endpoints, string locators, bool clientNotification)
    {
      CacheHelper.CreateTCRegion2<TradeKey, Object>(name, ack, caching, resolver,
           (string)endpoints, (string)locators, clientNotification);
    }
    ...
    public virtual void CreateTCRegions_Pool_AD(string[] regionNames,
      string endpoints, string locators, string poolName, bool clientNotification, bool ssl, long dtTime)
    {
      CreateTCRegions_Pool_AD2(regionNames, endpoints, locators, poolName, clientNotification, ssl, true, false);

      CacheableHelper.RegisterBuiltinsAD(dtTime);
      try
      {
        CacheHelperWrapper chw = new CacheHelperWrapper();
        chw.CreateTCRegions_Pool_AD<object, object>(regionNames, endpoints, locators, poolName, clientNotification, ssl, true, false);
  ...
  string endpoints, string locators, string poolName, bool clientNotification, bool ssl, bool caching, bool pdxReadSerialized)
    {
      ...
      m_chw_forFirstAppDomain.CreateTCRegions_Pool_AD<object, object>(regionNames, endpoints, locators, poolName, clientNotification, ssl, caching, pdxReadSerialized);
      ...
      try
      {
        ...
        m_chw_forSecondAppDomain.CreateTCRegions_Pool_AD<object, object>(regionNames, endpoints, locators, poolName, clientNotification, ssl, caching, pdxReadSerialized);
      ...
      try
      {
        ...
        CacheHelperWrapper chw = new CacheHelperWrapper();
        chw.CreateTCRegions_Pool_AD<object, object>(regionNames, endpoints, locators, poolName, clientNotification, ssl, caching, pdxReadSerialized);
      }
      catch (Exception)
      {
      }
    ...
    public void TestAllKeyValuePairsAD(string regionName, bool runQuery, bool pool, long dtTime)
    {
