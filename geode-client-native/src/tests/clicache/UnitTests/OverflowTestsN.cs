...
namespace GemStone.GemFire.Cache.UnitTests.NewAPI
{
  ...
  public class OverflowTests : UnitTests
  {
    ...
    private const string SqLiteDir = "SqLite";
    ...
    {
      RegionAttributes<object, object> regAttr = region.Attributes;
    ...
    private IRegion<object, object> CreateSubRegion(IRegion<object, object> region, string subRegionName, string libraryName, string factoryFunctionName)
    {
      ...
      Assert.IsTrue(File.Exists(GetSqLiteFileName(SqLiteDir, subRegionName)), "Persistence file is not present");
      DoNput(subRegion, 50);
      DoNget(subRegion, 50);
      return subRegion;
    }
    ...
    public void OverflowPutGet()
    {
      ...
      for (int i = 0; i < 1; i++)
      {
        ...
        Assert.IsFalse(File.Exists(GetSqLiteFileName(SqLiteDir, "SubRegion")), "Persistence file present after region destroy");
      }
    ...
    public void XmlCacheCreationWithOverflow()
    {
      ...
      try
      {
        ...
        RegionAttributes<object, object> attrs = region1.Attributes;
        ...
        RegionAttributes<object, object> attrs2 = region2.Attributes;
        ...
        RegionAttributes<object, object> attrs3 = region3.Attributes;
        //Util.Log("Attributes of root region Root1 are: ");

        Assert.IsTrue(attrs3.CachingEnabled);
        Assert.AreEqual(ScopeType.Local, attrs3.Scope);
