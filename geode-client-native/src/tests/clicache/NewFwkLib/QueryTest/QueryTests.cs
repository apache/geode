          ...
          if ((region = CacheHelper<TKey, TVal>.GetRegion(rootRegionName)) == null)
          {
            ...
            if (endpoints != null && endpoints.Length > 0)
            {
              ...
              else
              {
                ...
                CacheHelper<TKey, TVal>.InitConfigForDurable(endpoints, redundancyLevel, durableClientId, durableTimeout, conflateEvents, isSslEnable);
              }
      ...
      try
      {
          ...
          sRegionName.Length > 0)
        {
          ...
          else
          {
            ...
            RegionAttributes<TKey, TVal> regattrs = parentRegion.Attributes;
