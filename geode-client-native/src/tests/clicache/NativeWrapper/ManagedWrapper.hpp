    ...
    namespace Cache
    {
      ...
      namespace Tests
      {
        ...
        private:
          ...
          /// object holds a reference to the managed object.
          /// </summary>
          property Internal::ManagedPtrWrap<NativeType, ManagedWrapper>
            SafeNativePtr2
          {
            inline Internal::ManagedPtrWrap<NativeType, ManagedWrapper> get()
            {
              return Internal::ManagedPtrWrap<NativeType, ManagedWrapper>(
                m_nativePtr, this);
            }
          }
