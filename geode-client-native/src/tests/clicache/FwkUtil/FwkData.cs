...
namespace GemStone.GemFire.Cache.FwkLib
{
  ...
  public class FwkData 
  {
        ...
        foreach (XmlNode xmlNode in xmlNodes)
        {
          ...
          else if (xmlNode.FirstChild.Name == "snippet")
          {
            ...
            if (xmlNode.FirstChild.FirstChild.Name == "region")
            {
              ...
              Properties rattr = Properties.Create();
    ...
    public static void SetThisAttribute(string name, XmlNode node, AttributesFactory af)
    {
      ...
      switch (name)
      {
        ...
        case "scope":
          ...
          else if (value == "distributed-no-ack")
          {
            af.SetScope(ScopeType.DistributedNoAck);
          }
          else if (value == "distributed-ack")
          {
        ...
        case "endpoints":
          if (value != null)
          {
            af.SetEndpoints(value);
          }
          else
          {
            throw new IllegalArgException("endpoint list is bad");
          }
          break;
  ...
  public class FwkReadData : MarshalByRefObject
  {
    ...
    public RegionAttributes GetRegionAttributes(string key)
    {
      FwkData data = ReadData(key);
      if (data != null && data.Kind == DataKind.Region)
      {
        ...
        {
          DataInput dinp = new DataInput(attrsArr);
          attrs.FromData(dinp);
        }
        return attrs;
      }
    ...
    public Properties GetPoolAttributes(string key)
    {
      FwkData data = ReadData(key);
