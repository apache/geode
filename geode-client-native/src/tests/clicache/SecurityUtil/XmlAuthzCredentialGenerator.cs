...
namespace GemStone.GemFire.Cache.Tests
{
  ...
  public class XmlAuthzCredentialGenerator : AuthzCredentialGenerator
  {
    ...
    public static OperationCode[] WriterOps = { OperationCode.Put, OperationCode.PutAll,
    ...
    protected override Properties GetAllowedPrincipal(
    ...
    protected override Properties GetDisallowedPrincipal(
      OperationCode[] opCodes, string[] regionNames, int index)
    {
      Role roleType = GetRequiredRole(opCodes, regionNames);
    ...
    private Properties GetDummyPrincipal(Role roleType, int index)
    {
    ...
    private Properties GetLdapPrincipal(Role roleType, int index)
    {
      return GetUserPrincipal(GetLdapUser(roleType, index));
    }

    private Properties GetPKCSPrincipal(Role roleType, int index)
    {
    ...
    private Properties GetUserPrincipal(string userName)
    {
      Properties props = new Properties();
