...
namespace GemStone.GemFire.Cache.Tests
{
  ...
  public abstract class CredentialGenerator
  {
    ...
    /// <c>com.gemstone.gemfire.security.Authenticator</c> interface.
    /// </description></item>
    /// <item><description>
    ...
    /// </summary>
    private Properties m_sysProps = null;

    /// <summary>
    /// A set of properties that should be added to the java system properties
    /// before using the authentication module.
    /// </summary>
    protected Properties m_javaProps = null;
    ...
    /// </returns>
    public abstract Properties GetValidCredentials(Properties principal);
