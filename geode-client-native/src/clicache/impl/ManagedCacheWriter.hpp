...
namespace gemfire
{
  ...
  public:
    ...
    /// The managed object.
    /// </param>
    inline ManagedCacheWriter(
      GemStone::GemFire::Cache::ICacheWriter^ managedptr )
    ...
    /// </summary>
    inline GemStone::GemFire::Cache::ICacheWriter^ ptr( ) const
    {
      return m_managedptr;
    }
  ...
  private:
    ...
    /// </summary>
    gcroot<GemStone::GemFire::Cache::ICacheWriter^> m_managedptr;
  };
