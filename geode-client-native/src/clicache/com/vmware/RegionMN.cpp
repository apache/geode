...
namespace GemStone
{
  namespace GemFire
  {
    namespace Cache { namespace Generic
    {
      ...
      {
        _GF_MG_EXCEPTION_TRY2/* due to auto replace */
          RegionAttributes<TKey, TValue>^ rAttributes =  this->Attributes;
      ...
      generic<class TKey, class TValue>
      RegionAttributes<TKey, TValue>^ Region<TKey, TValue>::Attributes::get()
      { 
        _GF_MG_EXCEPTION_TRY2/* due to auto replace */
      ...
      generic<class TKey, class TValue>
      GemStone::GemFire::Cache::Generic::Cache^ Region<TKey, TValue>::Cache::get()
      {        
        _GF_MG_EXCEPTION_TRY2/* due to auto replace */
