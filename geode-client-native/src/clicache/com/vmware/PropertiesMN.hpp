    ...
    namespace Cache
    {
      ...
      public:
        void Visit(GemStone::GemFire::Cache::ICacheableKey^ key,
          GemStone::GemFire::Cache::IGFSerializable^ value)
        {
          TPropKey tpkey = GemStone::GemFire::Cache::Generic::Serializable::
            GetManagedValueGeneric<TPropKey>(SerializablePtr(SafeMSerializableConvert(key)));
          TPropValue tpvalue = GemStone::GemFire::Cache::Generic::Serializable::
            GetManagedValueGeneric<TPropValue>(SerializablePtr(SafeMSerializableConvert(value)));
