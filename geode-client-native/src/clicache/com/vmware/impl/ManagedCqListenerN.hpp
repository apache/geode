...
namespace gemfire {
  ...
  public:
    ...
    /// </summary>
    inline GemStone::GemFire::Cache::/*Generic::*/ICqListener^ ptr( ) const
    {   
      return m_managedptr;
    }

    inline void setptr( GemStone::GemFire::Cache::/*Generic::*/ICqListener^ managedptr )
    {
  ...
  private:
    ...
    /// </summary>
    gcroot<GemStone::GemFire::Cache::/*Generic::*/ICqListener^> m_managedptr;
