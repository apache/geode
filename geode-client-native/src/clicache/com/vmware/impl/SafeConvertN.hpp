...
#include "ManagedCacheableDeltaBytesN.hpp"
  ...
  namespace GemFire
  {
    namespace Cache
    {
      ...
      inline static gemfire::Cacheable* SafeGenericM2UMConvert( TValue mg_val )
      {
        ...
        if(pdxType != nullptr)
        {
          //TODO::hitesh probably need to do for appdomain
					if(!SafeConvertClassGeneric::isAppDomainEnabled)
      ...
      inline static NativeType* GetNativePtrFromSBWrap( GemStone::GemFire::Cache::Internal::SBWrap<NativeType>^ mg_obj )
      {
        return (mg_obj != nullptr ? mg_obj->_NativePtr : NULL);
      }
      ...
      inline static NativeType* GetNativePtrFromUMWrap( GemStone::GemFire::Cache::Internal::UMWrap<NativeType>^ mg_obj )
      {
        return (mg_obj != nullptr ? mg_obj->_NativePtr : NULL);
      }
