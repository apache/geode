...
#include "../../../gf_defs.hpp"
#include <vcclr.h>
#include <cppcache/CqStatusListener.hpp>
#include "../../../ICqStatusListener.hpp"
#include "CqStatusListenerProxyMN.hpp"
...
namespace gemfire {
  ...
  public:
    ...
    /// </summary>
    inline GemStone::GemFire::Cache::ICqStatusListener^ ptr( ) const
    {   
      return m_managedptr;
    }

    inline void setptr( GemStone::GemFire::Cache::ICqStatusListener^ managedptr )
    {
  ...
  private:
    ...
    /// </summary>
    gcroot<GemStone::GemFire::Cache::ICqStatusListener^> m_managedptr;
