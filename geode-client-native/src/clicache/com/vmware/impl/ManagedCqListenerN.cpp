...
#include "ManagedCqListenerN.hpp"
    ...
    const char* factoryFunctionName )
  {
    try
    {
      String^ mg_assemblyPath =
        ManagedString::Get( assemblyPath );
      String^ mg_factoryFunctionName =
        ManagedString::Get( factoryFunctionName );
      ...
      {
        ManagedString typeName( mg_typeName );
    ...
    {
      ManagedString mg_exStr( ex->ToString( ) );
