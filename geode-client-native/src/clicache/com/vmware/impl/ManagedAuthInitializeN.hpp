...
namespace gemfire
{
  ...
  public:
    ...
    /// The managed object.
    /// </param>
    inline ManagedAuthInitializeGeneric(
      /*GemStone::GemFire::Cache::IAuthInitialize^ managedptr,*/ Object^ userptr )
    ...
    inline void setptr( GemStone::GemFire::Cache::IAuthInitialize^ managedptr )
    {
