...
#include "PartitionResolverMN.hpp"
...
namespace gemfire {
  ...
  public:
    ...
    /// </summary>
    inline IPartitionResolverProxy^ ptr( ) const
    {
      return m_managedptr;
    }

    inline void setptr( IPartitionResolverProxy^ managedptr )
    {
  ...
  private:
    ...
    /// </summary>
    gcroot<IPartitionResolverProxy^> m_managedptr;
