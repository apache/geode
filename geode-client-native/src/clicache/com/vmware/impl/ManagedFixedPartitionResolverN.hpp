...
#include "FixedPartitionResolverMN.hpp"
...
namespace gemfire {
  ...
  public:
    ...
    /// </summary>
    inline IFixedPartitionResolverProxy^ ptr( ) const
    {
      return m_managedptr;
    }

    inline void setptr( IFixedPartitionResolverProxy^ managedptr )
    {
  ...
  private:
    ...
    /// </summary>
    gcroot<IFixedPartitionResolverProxy^> m_managedptr;
