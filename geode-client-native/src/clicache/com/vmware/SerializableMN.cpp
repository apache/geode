...
#include "impl/DelegateWrapperN.hpp"
    ...
    namespace Cache
    {
      ...
      TValue Serializable::GetManagedValueGeneric(gemfire::SerializablePtr val)
      {
        ...
        case 8://GemFireClassIds::CacheableManagedObjectXml
        {
          ...
          /* VJR: TODO: replace with IDictionary<K, V>
