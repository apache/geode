...
namespace gemfire {
  ...
  */
  ...
  public:
    ...
    * For C++ on Windows and Linux, signed char type is corresponding to int8_t type.
    * However C++ users on Solaris should always use this api after casting int8_t to signed char.
    * @param fieldName
    *          name of the field whose value will be set
    * @param value
    ...
    * For C++ on Windows and Linux, unsigned char type is corresponding to int8_t type.
    * However C++ users on Solaris should always use this api after casting int8_t to unsigned char.
    * @param fieldName
    *          name of the field whose value will be set
    * @param value
