...
void WindowsProcessStats::createType(StatisticsFactory* statFactory)
{
   ...
   statDescriptorArr[0]  = statFactory->createIntGauge("handles",
                                           ...
                                           "items");
   statDescriptorArr[1] = statFactory->createIntGauge("priorityBase",
                                           ...
                                           "priority");
   statDescriptorArr[2] = statFactory->createIntGauge("threads",
   ...
   statDescriptorArr[5] = statFactory->createLongGauge("pageFileSize",
                                            ...
                                            "bytes");
   statDescriptorArr[6] = statFactory->createLongGauge("pageFileSizePeak",
                                            ...
                                            "bytes");
   statDescriptorArr[7] = statFactory->createLongGauge("privateSize",
                                            "The current number of bytes this process has allocated that cannot be shared with other processes.",
                                            "bytes");
   statDescriptorArr[8] = statFactory->createLongCounter("systemTime",
   ...
   statDescriptorArr[10] = statFactory->createLongGauge("virtualSize",
                                            ...
                                            "bytes");
   statDescriptorArr[11] = statFactory->createLongGauge("virtualSizePeak",
                                            ...
                                            "bytes");
   statDescriptorArr[12] = statFactory->createLongGauge("workingSetSize",
                                            ...
                                            "bytes");
   statDescriptorArr[13] = statFactory->createLongGauge("workingSetSizePeak",
   ...
   statDescriptorArr[14] = statFactory->createIntGauge("cpuUsage",
                                            "Percentage cpu used by this process",
                                            "%");

   try {
     m_statsType  = statFactory->createType("WindowsProcessStats",
                 "Statistics for a Microsoft Windows process.",statDescriptorArr,15 );
   }
     catch (Exception& ) {
   ...
   if(m_statsType == NULL)
   {
      throw OutOfMemoryException
          ("WindowsProcessStats::createType: out memory");
   }
...
int32 WindowsProcessStats::getCpuUsage() {
  //throw UnsupportedOperationException( "getCpuUsage is unsupported on Windows." );
...
int32 WindowsProcessStats::getNumThreads()
{
