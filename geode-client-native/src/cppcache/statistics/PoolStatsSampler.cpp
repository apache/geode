...
#include <string>
#include "../impl/ReadWriteLock.hpp"
...
PoolStatsSampler::PoolStatsSampler(int64 sampleRate, CacheImpl* cache, ThinClientPoolDM* distMan): m_sampleRate(sampleRate), m_distMan(distMan)
{
  m_running = false;
...
int32 PoolStatsSampler::svc()
{
  ...
  int32 msRate = ( int32 )m_sampleRate;
...
bool PoolStatsSampler::isRunning()
{
  return m_running;
}
