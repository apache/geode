...
int64 NullProcessStats::getProcessSize() {
  return 0;
}

int32 NullProcessStats::getCpuUsage() {
  return 0;
}
int64 NullProcessStats::getCPUTime() {
  return 0;
}
int32 NullProcessStats::getNumThreads() {
  return 0;
}
int64 NullProcessStats::getAllCpuTime() {
  return 0;
}
