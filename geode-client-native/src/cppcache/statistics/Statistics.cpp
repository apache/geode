...
int32  Statistics::nameToId(const char* name)
{return 0;}

StatisticDescriptor* Statistics::nameToDescriptor(const char* name)
{return NULL;}

int64 Statistics::getUniqueId()
{return 0;}
 
StatisticsType* Statistics::getType()
{return NULL;}

const char* Statistics::getTextId()
{ return ""; }

int64 Statistics::getNumericId()
{ return 0; }

bool Statistics::isAtomic()
{ return 0;}

bool  Statistics::isShared()
{ return 0; }

bool Statistics::isClosed()
{ return 0; }
...
int32 Statistics::getInt(int32 id)
{ return 0; }

int32 Statistics::getInt(StatisticDescriptor* descriptor)
{ return 0; }

int32 Statistics::getInt(char* name)
{ return 0; }

int64 Statistics::getLong(int32 id)
{ return 0; }

int64 Statistics::getLong(StatisticDescriptor* descriptor)
{ return 0; }

int64 Statistics::getLong(char* name)
{ return 0;}

double Statistics::getDouble(int32 id)
{ return 0; }

double Statistics::getDouble(StatisticDescriptor* descriptor)
{ return 0; }

double Statistics::getDouble(char* name)
{ return  0;}
