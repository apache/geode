...
namespace gemfire {
  ...
  */
  ...
  public:
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.    
    */
    ...
    * For how each element of the array is a mapped to C++ see {@link #writeObject}.
    ...
    * @param fieldName the name of the field to write
    * @param value the value of the field to write
    * @param arrayLength the length of the actual byte array field holding individual byte arrays to write
    ...
    */
    ...
    /**
    * Indicate that the named field should be included in hashCode and equals (operator==()) checks
    ...
    * equals (operator==()) methods of {@link PdxInstance}. Because of this, the identity fields should themselves
    * either be primitives, or implement hashCode and equals (operator==()).
    * 
    * If no fields are set as identity fields, then all fields will be used in hashCode and equals (operator==())
    * checks.
    * 
