...
namespace gemfire {
  ...
  class CPPCACHE_EXPORT PdxReader : public SharedBase {
    ...
    /**
     * Read a wchar_t* value from the <code>PdxReader</code> and sets array length.
     * <p>C++ wchar_t* is mapped to Java char[].</p>
     * @param fieldName name of the field to read
     * @param length length is set with number of wchar_t elements.
     * @return value of type wchar_t*.
    ...
    /**
     * Read a int16_t* value from the <code>PdxReader</code> and sets array length.
     * <p>C++ int16_t* is mapped to Java short[].</p>
     * @param fieldName name of the field to read
    ...
    /**
     * Read a int32_t* value from the <code>PdxReader</code> and sets array length.
     * <p>C++ int32_t* is mapped to Java int[].</p>
     * @param fieldName name of the field to read
    ...
    /**
     * Read a int64_t* value from the <code>PdxReader</code> and sets array length.
     * <p>C++ int64_t* is mapped to Java long[].</p>
     * @param fieldName name of the field to read
    ...
    /**
     * Read a int8_t** value from the <code>PdxReader</code> and sets ArrayOfByteArray's length and individual ByteArray's length.
     * <p>C++ int8_t** is mapped to Java byte[][].</p>
     * @param fieldName name of the field to read
     * @param arrayLength length is set with number of int8_t* elements
     * @param elementLength elementLength is set with the length value of individual byte arrays.
     * @return value of type int8_t**.
     * @throws IllegalStateException if PdxReader doesn't has the named field.
     *
     * @see PdxReader#hasField
    ...
    /**
     * Checks if the named field was {@link PdxWriter#markIdentityField}marked as an identity field.
     ...
     * is set to <code>true</code> then this method will always return an object that has no unread fields.
     *
