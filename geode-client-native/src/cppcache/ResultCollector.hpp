...
public:
   ...
   * If gemfire sendException is called then {@link ResultCollector.getResult} will not
   * throw exception but will have exception {@link UserFunctionExecutionException} as a part of results received.
