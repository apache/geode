...
namespace gemfire
{
  ...
  /**
  * @brief UserFunctionExecutionException class is used to encapsulate gemfire sendException in case of Function execution.
  **/
   ...
   */
    ...
    /**
    *@brief return as CacheableStringPtr the Exception message returned from gemfire sendException api.
    **/
    ...
    /**
    *@brief return as CacheableStringPtr the Exception name returned from gemfire sendException api.
    **/
