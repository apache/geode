...
CacheAttributes::~CacheAttributes()
{
  GF_SAFE_DELETE_ARRAY(m_endpoints);
}

int CacheAttributes::getRedundancyLevel()
{
  return m_redundancyLevel;
}
  
char *CacheAttributes::getEndpoints() 
{
  return m_endpoints;
}
...
int32_t CacheAttributes::compareStringAttribute(char* attributeA, char* attributeB) const {
