...
namespace gemfire
{
  ...
  typedef SharedPtr<PutAllPartialResultServerException> PutAllPartialResultServerExceptionPtr;


  /**
   * @brief PutAllPartialResultServerException class is used to encapsulate gemfire PutAllPartialResultServerException in case of PutAll execution.
   **/
  ...
  private:
    // never implemented.
    PutAllPartialResultServerException(const PutAllPartialResultServerException& other);
