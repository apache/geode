  ...
  class CPPCACHE_EXPORT ProxyRegion : public Region {
    ...
    */
        ...
        const RegionAttributesPtr& aRegionAttributes)
    {
      ...
      return NULLPTR;
      /*LOGDEBUG("ProxyRegion getSubregion");
      RegionPtr rPtr = m_realRegion->createSubregion(subregionName, aRegionAttributes);
    ...
    */
    virtual void subregions(const bool recursive, VectorOfRegion& sr)
    {
      ...
      if(realVectorRegion.size() > 0)
      {
        ...
        {
          RegionPtr prPtr( new ProxyRegion(m_proxyCache.ptr(), realVectorRegion.at(i)));
          sr.push_back(prPtr);
        }
      }
    }
    ...
    */
     ...
     * It is ignored if NULLPTR. It must be serializable if this operation is distributed.
    ...
    */
    ...
    virtual CachePtr getCache() const
    {
      unSupportedOperation("Region.getCache()");
      return NULLPTR;
    }
    ...
    */
    ...
    {
      GuardUserAttribures gua(m_proxyCache);
      m_realRegion->getAll(keys, values, exceptions, false/*TODO:hitesh*/, aCallbackArgument);
    }
    ...
    * @see destroy
    */
     virtual void removeAll(const VectorOfCacheableKey& keys, const UserDataPtr& aCallbackArgument = NULLPTR)
     {
       GuardUserAttribures gua(m_proxyCache);
