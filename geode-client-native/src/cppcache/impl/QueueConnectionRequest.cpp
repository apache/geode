...
const ClientProxyMembershipID& QueueConnectionRequest::getProxyMemberShipId() const
{
...
bool QueueConnectionRequest::isFindDurable() const
{
  return m_findDurable;
}
void QueueConnectionRequest::writeSetOfServerLocation(DataOutput& output) const
{
  output.writeInt((int32_t)m_excludedServers.size());
