...
namespace gemfire {
  ...
  PutAllPartialResultServerException::PutAllPartialResultServerException (PutAllPartialResultPtr result){
  ...
  void PutAllPartialResultServerException::consolidate(PutAllPartialResultServerExceptionPtr pre)
  {
    m_result->consolidate(pre->getResult());
  }

  void PutAllPartialResultServerException::consolidate(PutAllPartialResultPtr otherResult){
  ...
  VersionedCacheableObjectPartListPtr PutAllPartialResultServerException::getSucceededKeysAndVersions()
  {
  ...
  void PutAllPartialResultServerException::toData( DataOutput& output ) const {
    throw IllegalStateException("PutAllPartialResultServerException::toData is not intended for use.");
  }

  Serializable* PutAllPartialResultServerException::fromData( DataInput& input ) {
    throw IllegalStateException("PutAllPartialResultServerException::fromData is not intended for use.");
    return NULL;
  }

  int32_t PutAllPartialResultServerException::classId( ) const {
    throw IllegalStateException("PutAllPartialResultServerException::classId is not intended for use.");
    return 0;
  }

  uint32_t PutAllPartialResultServerException::objectSize( ) const {
    throw IllegalStateException("PutAllPartialResultServerException::objectSize is not intended for use.");
    return 0;
  }
  ...
  PutAllPartialResultServerException::PutAllPartialResultServerException(CacheableStringPtr msg):m_message(msg) {
  }
}
