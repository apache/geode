...
namespace gemfire
{
  ...
  public:
    inline static CacheableTokenPtr& invalid()
    {
      return *invalidToken;
    }

    inline static CacheableTokenPtr& destroyed()
    {
      return *destroyedToken;
    }

    inline static CacheableTokenPtr& overflowed()
    {
      return *overflowedToken;
    }
    inline static CacheableTokenPtr& tombstone()
    {
    ...
    {
      return m_value == DESTROYED;
    }

    inline bool isOverflowed()
    {
      return m_value == OVERFLOWED;
    }
    
    inline bool isTombstone()
    {
      return m_value == TOMBSTONE;
    }
