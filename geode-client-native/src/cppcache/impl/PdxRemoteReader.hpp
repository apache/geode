...
namespace gemfire {
  ...
  public:
    ...
    virtual void readASCII(const char* fieldName, char** value, uint16_t* len = NULL);
    ...
    *
    ...
    virtual void readASCIIHuge(const char* fieldName, char** value, uint32_t* len = NULL);
    ...
    * @param value value of the field which needs to serialize
    ...
    virtual void readUTF(const char* fieldName, char** value, uint16_t* len = NULL);
    ...
    * Returns String value
    ...
    virtual void readUTFHuge(const char* fieldName, char** value, uint32_t* len = NULL);
*/
    ...
    virtual int8_t** readArrayOfByteArrays(const char* fieldName, int32_t& arrayLength, int32_t** elementLength );
    ...
    virtual void readCollection( const char* fieldName, CacheableArrayListPtr& collection);
