...
StatisticsType * PoolStatType::getStatType() {
  ...
  if ( statsType == NULL ) {
    m_stats[0] = factory->createIntGauge( "locators", "Current number of locators discovered", "locators");
    m_stats[1] = factory->createIntGauge("servers", "Current number of servers discovered", "servers");
    m_stats[2] = factory->createIntGauge( "subscriptionServers", "Number of servers hosting this clients subscriptions", "servers");
    m_stats[3] = factory->createLongCounter( "locatorRequests", "Number of requests from this connection pool to a locator", "requests");
    m_stats[4] = factory->createLongCounter( "locatorResponses", "Number of responses from the locator to this connection pool", "responses");
    m_stats[5] = factory->createIntGauge("poolConnections", "Current number of pool connections", "connections");
    m_stats[6] = factory->createIntCounter("connects", "Total number of times a connection has been created.", "connects");
    m_stats[7] = factory->createIntCounter("disconnects", "Total number of times a connection has been destroyed.", "disconnects");
    m_stats[8] = factory->createIntCounter("minPoolSizeConnects", "Total number of connects done to maintain minimum pool size.", "connects");
    m_stats[9] = factory->createIntCounter("loadConditioningConnects", "Total number of connects done due to load conditioning.", "connects");
    m_stats[10] = factory->createIntCounter("idleDisconnects", "Total number of disconnects done due to idle expiration.", "disconnects");
    m_stats[11] = factory->createIntCounter("loadConditioningDisconnects", "Total number of disconnects done due to load conditioning expiration.", "disconnects");
    m_stats[12] = factory->createIntGauge("connectionWaitsInProgress", "Current number of threads waiting for a connection", "threads");
    m_stats[13] = factory->createIntCounter("connectionWaits", "Total number of times a thread completed waiting for a connection (by timing out or by getting a connection).", "waits");
    m_stats[14] = factory->createLongCounter("connectionWaitTime", "Total time (nanoseconds) spent waiting for a connection.", "nanoseconds");
    m_stats[15] = factory->createIntGauge("clientOpsInProgress", "Current number of clientOps being executed", "clientOps");
    m_stats[16] = factory->createIntCounter("clientOps", "Total number of clientOps completed successfully", "clientOps");
    m_stats[17] = factory->createLongCounter("clientOpTime", "Total amount of time, in nanoseconds spent doing clientOps", "nanoseconds");
    m_stats[18] = factory->createIntCounter("clientOpFailures", "Total number of clientOp attempts that have failed", "clientOps");
    m_stats[19] = factory->createIntCounter("clientOpTimeouts", "Total number of clientOp attempts that have timed out", "clientOps");
    m_stats[20] = factory->createLongCounter("receivedBytes", "Total number of bytes received from the server.", "bytes");
    m_stats[21] = factory->createLongCounter("messagesBeingReceived", "Total number of message being received off the network.","messages");
    m_stats[22] = factory->createLongCounter("processedDeltaMessages", "Total number of delta message processed successfully", "messages");
    m_stats[23] = factory->createLongCounter("deltaMessageFailures", "Total number of failures in processing delta", "messages");
    m_stats[24] = factory->createLongCounter("processedDeltaMessagesTime", "Total time spent while processing Delta", "nanoseconds");
    m_stats[25] = factory->createIntCounter("queryExecutions", "Total number of queryExecutions", "queryExecutions");
    m_stats[26] = factory->createLongCounter("queryExecutionTime", "Total time spent while processing queryExecution", "nanoseconds");

    statsType = factory->createType
      ("PoolStatistics", "Statistics for this pool", m_stats, 27);
    ...
    m_processedDeltaMessagesTimeId = statsType->nameToId("processedDeltaMessagesTime");
...
/* adongre
 * CID 28939: Uninitialized scalar field (UNINIT_CTOR)
 */
      m_clientOpsFailedId(0), m_clientOpsSuccessId(0), m_clientOpsSuccessTimeId(0),m_clientOpsTimeoutId(0),
        m_connectsId(0), m_curClientOpsId(0),m_deltaMessageFailuresId(0),m_disconnectsId(0),
        m_idleDisconnectsId(0), m_loadCondConnectsId(0),m_loadCondDisconnectsId(0),m_locReqsId(0),
        m_locRespsId(0), m_locatorsId(0), m_messagesBeingReceivedId(0), m_minPoolConnectsId(0),
        m_poolConnsId(0), m_processedDeltaMessagesId(0), m_processedDeltaMessagesTimeId(0),
        m_queryExecutionTimeId(0), m_queryExecutionsId(0), m_receivedBytesId(0), m_serversId(0),
        m_subsServsId(0), m_totalWaitingConnTimeId(0),m_totalWaitingConnsId(0),
...
PoolStats::PoolStats(const char* poolName)
{
  ...
  m_processedDeltaMessagesTimeId = poolStatType->getProcessedDeltaMessagesTimeId();
