...
namespace gemfire
{
  ...
  {
  public:
    DistributedMemberWithIntIdentifier(DSMemberForVersionStampPtr dsmember = NULLPTR, 
                                        uint16_t id = 0) {
  ...
  private:
    ...
    std::unordered_map<std::string, DistributedMemberWithIntIdentifier> m_members2;
