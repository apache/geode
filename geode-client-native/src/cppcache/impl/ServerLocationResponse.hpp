...
namespace gemfire
{
  ...
  public:
    ...
    virtual Serializable* fromData( DataInput& input ) = 0; //Has to be implemented by concerte class
    ...
    virtual uint32_t objectSize() const = 0; //Has to be implemented by concrete class
