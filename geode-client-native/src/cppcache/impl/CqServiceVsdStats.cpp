...
StatisticsType * CqServiceStatType::getStatType() {
  ...
  m_stats[0] = factory->createIntCounter
    ("CqsActive", "The total number of CqsActive this cq qurey", "entries", largerIsBetter);
  m_stats[1] = factory->createIntCounter
    ("CqsCreated", "The total number of CqsCreated for this cq Service", "entries", largerIsBetter);
  m_stats[2] = factory->createIntCounter
    ("CqsClosed", "The total number of CqsClosed for this cq Service", "entries", largerIsBetter);
  m_stats[3] = factory->createIntCounter
    ("CqsStopped", "The total number of CqsStopped for this cq Service", "entries", largerIsBetter);
  m_stats[4] = factory->createIntCounter
    ("CqsOnClient", "The total number of Cqs on the client for this cq Service", "entries", largerIsBetter);

  statsType = factory->createType
    (cqServiceStatsName, cqServiceStatsDesc, m_stats, 5);
...
//typedef ACE_Singleton<CqServiceVsdStatsInit, ACE_Thread_Mutex> TheCqServiceVsdStatsInit;
...
CqServiceVsdStats::CqServiceVsdStats(const char* cqServiceName)
{
  ...
  m_cqServiceVsdStats = factory->createAtomicStatistics(statsType, const_cast<char*>( cqServiceName ) );
