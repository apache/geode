...
namespace gemfire
{
  ...
  const CacheEventFlags CacheEventFlags::NORMAL(
      CacheEventFlags::GF_NORMAL);
  const CacheEventFlags CacheEventFlags::LOCAL(
      CacheEventFlags::GF_LOCAL);
  ...
  const CacheEventFlags CacheEventFlags::EVICTION(
      CacheEventFlags::GF_EVICTION);
  ...
  {
    throw UnsupportedOperationException("registerKeys only supported by "
      "Thin Client Region.");
  }

  void RegionInternal::unregisterKeys(const VectorOfCacheableKey& keys)
  {
    throw UnsupportedOperationException("unregisterKeys only supported by "
      "Thin Client Region.");
  }
  ...
  {
    throw UnsupportedOperationException( "unregisterAllKeys only supported by Thin Client Region." );
  }
  ...
  void RegionInternal::registerRegex(const char * regex, bool isDurable,
      ...
      bool receiveValues)
  {
    throw UnsupportedOperationException( "registerRegex only supported by Thin Client Region." );
  }

  void RegionInternal::unregisterRegex(const char * regex)
  {
    throw UnsupportedOperationException( "unregisterRegex only supported by Thin Client Region." );
  }

  SelectResultsPtr RegionInternal::query(const char * predicate, uint32_t timeout)
  {
    throw UnsupportedOperationException( "query only supported by Thin Client Region." );
  }

  bool RegionInternal::existsValue(const char * predicate, uint32_t timeout)
  {
    throw UnsupportedOperationException( "existsValue only supported by Thin Client Region." );
  }

  SerializablePtr RegionInternal::selectValue(const char * predicate, uint32_t timeout)
  {
    throw UnsupportedOperationException( "selectValue only supported by Thin Client Region." );
  }

  TombstoneListPtr RegionInternal::getTombstoneList()
  {
    throw UnsupportedOperationException( "getTombstoneList only supported by LocalRegion." );
  }
  ...
  void RegionInternal::setRegionTimeToLiveExpirationAction(ExpirationAction::Action action)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setRegionIdleTimeoutExpirationAction(ExpirationAction::Action action)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setEntryTimeToLiveExpirationAction(ExpirationAction::Action action)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setEntryIdleTimeoutExpirationAction(ExpirationAction::Action action)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setCacheListener(const char* libpath, const char* factoryFuncName)
  {
    if (m_regionAttributes != NULLPTR) {
    ...
    void RegionInternal::setPartitionResolver(const PartitionResolverPtr& aResolver)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setPartitionResolver(const char* libpath, const char* factoryFuncName)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setCacheLoader(const char* libpath, const char* factoryFuncName)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  void RegionInternal::setCacheWriter(const char* libpath, const char* factoryFuncName)
  {
    if (m_regionAttributes != NULLPTR) {
  ...
  {
	  throw UnsupportedOperationException( "txDestroy only supported by Thin Client Region." );
  }

  void RegionInternal::txInvalidate(const CacheableKeyPtr& key, 
    const UserDataPtr& callBack, VersionTagPtr versionTag)
  {
	  throw UnsupportedOperationException( "txInvalidate only supported by Thin Client Region." );
  }

  void RegionInternal::txPut(const CacheableKeyPtr& key, const CacheablePtr& value, 
    const UserDataPtr& callBack, VersionTagPtr versionTag)
  {
	  throw UnsupportedOperationException( "txPut only supported by Thin Client Region." );
  }
