...
namespace gemfire {
  ...
  PdxReaderWithTypeCollector::PdxReaderWithTypeCollector(DataInput& dataInput, PdxTypePtr pdxType, int32_t pdxlen): PdxLocalReader(dataInput, pdxType, pdxlen) {
  ...
  void PdxReaderWithTypeCollector::checkType(const char* fieldName, int8_t typeId, const char* fieldType )
  {
    ...
    if(pft != NULLPTR)
    {
      if(typeId != pft->getTypeId())
      {
         ...
         */
        ACE_OS::snprintf(excpStr, 128, "Expected %s fieldType field but found field of type %s ", fieldType, pft->toString()->asChar());
  ...
  char PdxReaderWithTypeCollector::readChar(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "char", PdxFieldTypes::CHAR, PdxTypes::CHAR_SIZE);
  ...
  bool PdxReaderWithTypeCollector::readBoolean(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "boolean", PdxFieldTypes::BOOLEAN, PdxTypes::BOOLEAN_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  int8_t PdxReaderWithTypeCollector::readByte(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "byte", PdxFieldTypes::BYTE, PdxTypes::BYTE_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  int16_t PdxReaderWithTypeCollector::readShort(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "short", PdxFieldTypes::SHORT, PdxTypes::SHORT_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  int32_t PdxReaderWithTypeCollector::readInt(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "int", PdxFieldTypes::INT, PdxTypes::INTEGER_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  int64_t PdxReaderWithTypeCollector::readLong(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "long", PdxFieldTypes::LONG, PdxTypes::LONG_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  float PdxReaderWithTypeCollector::readFloat(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "float", PdxFieldTypes::FLOAT, PdxTypes::FLOAT_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  double PdxReaderWithTypeCollector::readDouble(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "double", PdxFieldTypes::DOUBLE, PdxTypes::DOUBLE_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  char* PdxReaderWithTypeCollector::readString(const char* fieldName){
    ...
    int32_t position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    ...
    if(position != -1)
    {
      ...
      int32_t strSize = (int32_t)(m_dataInput->currentBufferPosition()- startLoc);
  ...
  wchar_t* PdxReaderWithTypeCollector::readWideString(const char* fieldName){
    ...
    m_newPdxType->addVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
    int32_t position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readWideString():position = %d", position);
  ...
  /*void PdxReaderWithTypeCollector::readASCII(const char* fieldName, char** value, uint16_t* len){
    checkType(fieldName, PdxFieldTypes::STRING, "String");
    m_newPdxType->addVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    if(position != -1)
  ...
  void PdxReaderWithTypeCollector::readASCIIHuge(const char* fieldName, char** value, uint32_t* len){
    checkType(fieldName, PdxFieldTypes::STRING, "String");
    m_newPdxType->addVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    if(position != -1)
  ...
  void PdxReaderWithTypeCollector::readUTF(const char* fieldName, char** value, uint16_t* len){
    checkType(fieldName, PdxFieldTypes::STRING, "String");
    m_newPdxType->addVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    if(position != -1)
    {
      m_dataInput->advanceCursor(position);
      PdxLocalReader::readUTF(fieldName, value, len);
      m_dataInput->rewindCursor(position);        
    }
    else {
      **value = '\0';
  ...
  void PdxReaderWithTypeCollector::readUTFHuge(const char* fieldName, char** value, uint32_t* len){
    checkType(fieldName, PdxFieldTypes::STRING, "String");
    m_newPdxType->addVariableLengthTypeField(fieldName, "String", PdxFieldTypes::STRING);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    if(position != -1)
    {
      m_dataInput->advanceCursor(position);
      PdxLocalReader::readUTFHuge(fieldName, value, len);
      m_dataInput->rewindCursor(position);        
    }
    else {
      **value = '\0';
...
*/
  SerializablePtr PdxReaderWithTypeCollector::readObject(const char* fieldName){
    ...
    if(position != -1)
    {
      ...
      m_newPdxType->addVariableLengthTypeField(fieldName, "Serializable",PdxFieldTypes::OBJECT);
      int32_t strSize = (int32_t)(m_dataInput->currentBufferPosition()- startLoc);
      m_dataInput->rewindCursor(strSize + position);
      startLoc = NULL;
      return ptr;
  ...
  char* PdxReaderWithTypeCollector::readCharArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readCharArray():position = %d", position);
    if (position != -1) {
      m_dataInput->advanceCursor(position);
      const uint8_t* startLoc =  m_dataInput->currentBufferPosition();
  ...
  wchar_t* PdxReaderWithTypeCollector::readWideCharArray(const char* fieldName, int32_t& length){
    checkType(fieldName, PdxFieldTypes::CHAR_ARRAY, "char[]");
    m_newPdxType->addVariableLengthTypeField(fieldName, "char[]", PdxFieldTypes::CHAR_ARRAY);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readCharArray():position = %d", position);
  ...
  bool* PdxReaderWithTypeCollector::readBooleanArray (const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("NIL:293: PdxReaderWithTypeCollector::readBooleanArray(): Position =%d ", position);
  ...
  int8_t* PdxReaderWithTypeCollector::readByteArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readByteArray(): position = %d", position);
    if(position != -1)
    {
      int8_t* byteArrptr;
      m_dataInput->advanceCursor(position);
  ...
  int16_t* PdxReaderWithTypeCollector::readShortArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readShortArray():position = %d", position);
    if(position != -1)
    {
      int16_t* shortArrptr;
      m_dataInput->advanceCursor(position);
  ...
  int32_t* PdxReaderWithTypeCollector::readIntArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readIntArray():position = %d", position);
    if(position != -1)
    {
      int32_t* intArrayptr;
      m_dataInput->advanceCursor(position);
  ...
  int64_t* PdxReaderWithTypeCollector::readLongArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readLongArray():position = %d", position);
    if(position != -1)
    {
      int64_t* longArrptr;
      m_dataInput->advanceCursor(position);
  ...
  float* PdxReaderWithTypeCollector::readFloatArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readFloatArray(): position = %d", position);
    if(position != -1)
    {
      float* floatArrptr;
      m_dataInput->advanceCursor(position);
  ...
  double* PdxReaderWithTypeCollector::readDoubleArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readDoubleArray():position = %d", position);
    if(position != -1)
    {
      double* doubleArrptr;
      m_dataInput->advanceCursor(position);
  ...
  char** PdxReaderWithTypeCollector::readStringArray(const char* fieldName, int32_t& length){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readStringArray(): position = %d", position);
    if(position != -1)
    {
      char** strArray;
      m_dataInput->advanceCursor(position);
  ...
  wchar_t** PdxReaderWithTypeCollector::readWideStringArray(const char* fieldName, int32_t& length){
    checkType(fieldName, PdxFieldTypes::STRING_ARRAY, "String[]");
    m_newPdxType->addVariableLengthTypeField(fieldName, "String[]", PdxFieldTypes::STRING_ARRAY);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readWideStringArray(): position = %d", position);
    if(position != -1)
    {
      wchar_t** strArray;
      m_dataInput->advanceCursor(position);
  ...
  CacheableObjectArrayPtr PdxReaderWithTypeCollector::readObjectArray(const char* fieldName){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readObjectArray():position = %d", position);
    if(position != -1)
    {
      m_dataInput->advanceCursor(position);
      const uint8_t* startLoc =  m_dataInput->currentBufferPosition();
  ...
  int8_t** PdxReaderWithTypeCollector::readArrayOfByteArrays(const char* fieldName, int32_t& arrayLength, int32_t** elementLength ){
    ...
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readArrayOfByteArrays() position = %d", position);
    if(position != -1)
    {
      m_dataInput->advanceCursor(position);
      const uint8_t* startLoc =  m_dataInput->currentBufferPosition();
      int8_t** retVal = PdxLocalReader::readArrayOfByteArrays(fieldName, arrayLength, elementLength);
      int32_t strSize = (int32_t)(m_dataInput->currentBufferPosition()- startLoc);
      m_dataInput->rewindCursor(strSize + position);
      startLoc = NULL;
      return retVal;
  ...
  CacheableDatePtr PdxReaderWithTypeCollector::readDate(const char* fieldName){
    ...
    m_newPdxType->addFixedLengthTypeField(fieldName, "Date", PdxFieldTypes::DATE, PdxTypes::DATE_SIZE );
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
 ...
 /* void PdxReaderWithTypeCollector::readBytes(const char* fieldName, uint8_t*& bytes,
    int32_t& len) {
      checkType(fieldName, PdxFieldTypes::BYTE_ARRAY, "byte[]");
      m_newPdxType->addVariableLengthTypeField(fieldName, "byte[]", PdxFieldTypes::BYTE_ARRAY);
      int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
  ...
  void PdxReaderWithTypeCollector::readBytes(const char* fieldName, int8_t*& bytes,
    int32_t& len ) {
  ...
  void PdxReaderWithTypeCollector::readASCIIChar(const char* fieldName, wchar_t& value) {
    checkType(fieldName, PdxFieldTypes::CHAR, "wchar_t");
    m_newPdxType->addFixedLengthTypeField(fieldName, "wchar_t", PdxFieldTypes::CHAR, PdxTypes::CHAR_SIZE);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    if (position != -1) {
      m_dataInput->advanceCursor(position);
  ...
  void PdxReaderWithTypeCollector::readCollection( const char* fieldName, CacheableArrayListPtr& collection) {
    checkType(fieldName, gemfire::GemfireTypeIds::CacheableArrayList, "Collection");
    m_newPdxType->addVariableLengthTypeField(fieldName, "Collection", gemfire::GemfireTypeIds::CacheableArrayList);
    int position = m_pdxType->getFieldPosition(fieldName, m_offsetsBuffer, m_offsetSize, m_serializedLength);
    LOGDEBUG("PdxReaderWithTypeCollector::readCollection() position = %d", position);
    if(position != -1)
    {
      m_dataInput->advanceCursor(position);
