...
StatisticsType * RegionStatType::getStatType() {
  ...
  m_stats[0] = factory->createIntCounter
    ("creates", "The total number of cache creates for this region", "entries", largerIsBetter);
  m_stats[1] = factory->createIntCounter
    ("puts", "The total number of cache puts for this region", "entries", largerIsBetter);
  m_stats[2] = factory->createIntCounter
    ("gets", "The total number of cache gets for this region", "entries", largerIsBetter);
  m_stats[3] = factory->createIntCounter
    ("hits", "The total number of cache hits for this region", "entries", largerIsBetter);
  m_stats[4] = factory->createIntCounter
    ("misses", "The total number of cache misses for this region", "entries", ! largerIsBetter);
  m_stats[5] = factory->createIntGauge
    ("entries", "The current number of cache entries for this region", "entries", largerIsBetter);
  m_stats[6] = factory->createIntCounter
    ("destroys", "The total number of cache destroys for this region", "entries", largerIsBetter);
  m_stats[7] = factory->createIntCounter
    ("overflows", "The total number of cache overflows for this region to persistence backup", "entries", largerIsBetter);
  ...
  m_stats[9] = factory->createIntCounter
    ("nonSingleHopCount", "The total number of times client request observed multiple hops", "entries", ! largerIsBetter);
  m_stats[10] = factory->createIntCounter
    ("metaDataRefreshCount", "The total number of times matadata is refreshed due to hoping observed", "entries", ! largerIsBetter);
  m_stats[11] = factory->createIntCounter
      ("getAll", "The total number of cache getAll for this region", "entries", largerIsBetter);
  m_stats[12] = factory->createIntCounter
      ("putAll", "The total number of cache putAll for this region", "entries", largerIsBetter);
  ...
  m_stats[17] = factory->createIntCounter
            ("cacheLoaderCallsCompleted", "Total number of times a load has completed for this region", "entries", largerIsBetter);
  ...
  m_stats[19] = factory->createIntCounter
            ("cacheWriterCallsCompleted", "Total number of times a cache writer call has completed for this region", "entries", largerIsBetter);
  m_stats[20] = factory->createLongCounter
            ("cacheWriterCallTime", "Total time spent doing cache writer calls", "Nanoseconds", ! largerIsBetter);
  m_stats[21] = factory->createIntCounter
            ("cacheListenerCallsCompleted", "Total number of times a cache listener call has completed for this region", "entries", largerIsBetter);
  m_stats[22] = factory->createLongCounter
            ("cacheListenerCallTime", "Total time spent doing cache listener calls for this region", "Nanoseconds", ! largerIsBetter);
  m_stats[23] = factory->createIntCounter
            ("clears", "The total number of times a clear has been done on this cache for this region", "entries", ! largerIsBetter);
  m_stats[24] = factory->createIntCounter
      ("removeAll", "The total number of cache removeAll for this region", "entries", largerIsBetter);
  m_stats[25] = factory->createLongCounter
          ("removeAllTime", "Total time spent doing removeAlls operations for this region", "Nanoseconds", ! largerIsBetter);
  statsType = factory->createType
    (statsName, statsDesc, m_stats, 26);
  }
  ...
  m_ListenerCallsCompletedId = statsType->nameToId("cacheListenerCallsCompleted");
...
RegionStats::RegionStats(const char* regionName)
{
  ...
  m_regionStats = factory->createAtomicStatistics(statsType, const_cast<char*>( regionName ) );
