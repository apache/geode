...
namespace gemfire {
  ...
  */
  ...
  public:
    ...
    */
    virtual PdxInstanceFactoryPtr writeWideChar(const char* fieldName, wchar_t value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeShort(const char* fieldName, int16_t value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeDouble(const char* fieldName, double value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeDate(const char* fieldName, CacheableDatePtr value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeWideString(const char* fieldName, const wchar_t* value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeString(const char* fieldName, const char* value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeObject(const char* fieldName, CacheablePtr value);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeBooleanArray(const char* fieldName, bool* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeWideCharArray(const char* fieldName, wchar_t* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeCharArray(const char* fieldName, char* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeByteArray(const char* fieldName, int8_t* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeShortArray(const char* fieldName, int16_t* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeIntArray(const char* fieldName, int32_t* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeLongArray(const char* fieldName, int64_t* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeFloatArray(const char* fieldName, float* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeDoubleArray(const char* fieldName, double* value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeStringArray(const char* fieldName, char** value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeWideStringArray(const char* fieldName, wchar_t** value, int32_t length);
    ...
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeObjectArray(const char* fieldName, CacheableObjectArrayPtr value);    
    ...
    * @param fieldName the name of the field to write
    * @param value the value of the field to write
    * @param arrayLength the length of the actual bytearray field holding individual byte arrays to write
    * @param elementLength the length of the individual byte arrays to write
    * @return this PdxInstanceFactory
    * @throws IllegalStateException if the named field has already been written or fieldName is NULL or empty.
    */
    virtual PdxInstanceFactoryPtr writeArrayOfByteArrays(const char* fieldName, int8_t** value, int32_t arrayLength, int32_t* elementLength);
