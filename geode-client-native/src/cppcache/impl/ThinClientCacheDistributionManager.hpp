...
namespace gemfire {
  ...
  class CPPCACHE_EXPORT ThinClientCacheDistributionManager : public ThinClientDistributionManager, public SharedBase
  {
    public:
    ...
    private:
      ...
      ThinClientCacheDistributionManager & operator = ( const ThinClientCacheDistributionManager & );
  };
