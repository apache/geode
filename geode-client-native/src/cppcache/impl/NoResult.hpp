...
class CPPCACHE_EXPORT NoResult : public ResultCollector
{
  ...
  inline CacheableVectorPtr getResult(uint32_t timeout =  DEFAULT_QUERY_RESPONSE_TIMEOUT){
    throw FunctionExecutionException("Cannot return any result, as Function.hasResult() is false");
  }
