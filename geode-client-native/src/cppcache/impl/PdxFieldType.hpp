...
public:
	...
	inline bool IsVariableLengthType() {
		return m_isVariableLengthType;
	}

  bool getIdentityField() const {
    return m_isIdentityField;
  }
  ...
  void setVarLenOffsetIndex(int32 value)  {
    m_vlOffsetIndex = value;
  }

  void setRelativeOffset(int32 value) {
    m_relativeOffset = value;
  }

  int32 getFixedSize() const {
    return m_fixedSize;
  }
  ...
  virtual uint32_t objectSize() const {
    ...
    int32 getVarLenOffsetIndex() const {
      return m_vlOffsetIndex;
    }

    int32 getRelativeOffset() const {
