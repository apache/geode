...
private:
  ...
  static int32_t compareStringAttribute(const  char* attributeA,const char* attributeB) ;
  static bool compareVectorOfStrings(const std::vector<std::string>& thisVector, const std::vector<std::string>& otherVector);
