...
public:
  ...
  inline int32_t getNumInsertsId() {
    return m_numInsertsId;
  }

  inline int32_t getNumUpdatesId() {
    return m_numUpdatesId;
  }

  inline int32_t getNumDeletesId() {
    return m_numDeletesId;
  }

  inline int32_t getNumEventsId() {
    return m_numEventsId;
  }
