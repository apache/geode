...
namespace gemfire {
  ...
  class TcpSslConn : public TcpConn
  {
    private:
      ...
      typedef void* (*gf_create_SslImpl)(ACE_SOCKET, const char*, const char*, const char *);
      typedef void (*gf_destroy_SslImpl)(void*);

      GFSsl* getSSLImpl(ACE_SOCKET sock, const char * pubkeyfile, const char * privkeyfile);
    ...
    public:
      ...
      // TODO: VJR: Watch out for virt dtor calling virt methods!
