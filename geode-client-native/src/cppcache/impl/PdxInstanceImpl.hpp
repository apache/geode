...
namespace gemfire {
  ...
  public:    
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, bool** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, signed char** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, unsigned char** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, int16_t** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, int32_t** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, int64_t** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, float** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField (const char *fieldname, double** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField(const char* fieldName, wchar_t** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField(const char* fieldName, char** value, int32_t& length)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField(const char* fieldName, int8_t*** value, int32_t& arrayLength, int32_t*& elementLength)const;
    ...
    * @see PdxInstance#hasField
    */
    virtual void getField(const char *fieldname, CacheableObjectArrayPtr& value)const;
    ...
    * or if the type of the value is not compatible with the field.
    */
    virtual void setField(const char* fieldName, signed char* value, int32_t length);
    ...
    * or if the type of the value is not compatible with the field.
    */
    virtual void setField(const char* fieldName, unsigned char* value, int32_t length);
    ...
    * or if the type of the value is not compatible with the field.
    */
    virtual void setField(const char* fieldName, int8_t** value, int32_t arrayLength, int32_t* elementLength);
  ...
  private:
    ...
    int getRawHashCode(PdxTypePtr pt, PdxFieldTypePtr pField, DataInput& dataInput) const;

    int getNextFieldPosition(DataInput& dataInput, int fieldId, PdxTypePtr pt) const;

    int getSerializedLength(DataInput& dataInput, PdxTypePtr pt) const;

    bool hasDefaultBytes(PdxFieldTypePtr pField, DataInput& dataInput, int start, int end) const;

    bool compareDefaulBytes(DataInput& dataInput, int start, int end, int8_t* defaultBytes, int32_t length) const;    

    void writeField(PdxWriterPtr writer, const char* fieldName, int typeId, CacheablePtr value);

    void writeUnmodifieldField(DataInput& dataInput, int startPos, int endPos, PdxLocalWriterPtr localWriter);

    void setOffsetForObject(DataInput& dataInput, PdxTypePtr pt, int sequenceId) const;

    bool compareRawBytes(PdxInstanceImpl& other, PdxTypePtr myPT,  PdxFieldTypePtr myF,DataInput& myDataInput, PdxTypePtr otherPT,  PdxFieldTypePtr otherF, DataInput& otherDataInput) const;

    void equatePdxFields(std::vector<PdxFieldTypePtr>& my, std::vector<PdxFieldTypePtr>& other) const;
    ...
    static bool enumerateObjectArrayEquals(CacheableObjectArrayPtr Obj, CacheableObjectArrayPtr OtherObj);

    static bool enumerateVectorEquals(CacheableVectorPtr Obj, CacheableVectorPtr OtherObj);

    static bool enumerateArrayListEquals(CacheableArrayListPtr Obj, CacheableArrayListPtr OtherObj);

    static bool enumerateMapEquals(CacheableHashMapPtr Obj, CacheableHashMapPtr OtherObj);

    static bool enumerateSetEquals(CacheableHashSetPtr Obj, CacheableHashSetPtr OtherObj);

    static bool enumerateLinkedSetEquals(CacheableLinkedHashSetPtr Obj, CacheableLinkedHashSetPtr OtherObj);

    static bool enumerateHashTableEquals(CacheableHashTablePtr Obj, CacheableHashTablePtr OtherObj);
