...
class CPPCACHE_EXPORT LRUAction
{
  ...
  static LRUAction* newLRUAction( const LRUAction::Action& lruAction, RegionInternal* regionPtr, LRUEntriesMap* entriesMapPtr );
 ...
 */
class CPPCACHE_EXPORT LRUDestroyAction
 ...
 */
class CPPCACHE_EXPORT LRULocalInvalidateAction
: public virtual LRUAction
{
  private:
  ...
  LRULocalInvalidateAction( RegionInternal* regionPtr, LRUEntriesMap* entriesMapPtr )
  : m_regionPtr( regionPtr ), m_entriesMapPtr(entriesMapPtr)
  {
    m_invalidates = true;
  }
 ...
 * @brief LRUAction for invalidate.
 */
class CPPCACHE_EXPORT LRUOverFlowToDiskAction
: public virtual LRUAction
{
  private:
  ...
  LRUOverFlowToDiskAction( RegionInternal* regionPtr, LRUEntriesMap* entriesMapPtr  )
  : m_regionPtr( regionPtr ), m_entriesMapPtr(entriesMapPtr)
  {
    m_overflows = true;
  }
