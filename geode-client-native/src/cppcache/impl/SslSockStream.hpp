...
namespace gemfire {
  ...
  private:
    ...
    typedef ssize_t (*gf_recv_n_Type)(void*, void*, size_t, const ACE_Time_Value*, size_t*);
    typedef ssize_t (*gf_send_n_Type)(void*, const void*, size_t, const ACE_Time_Value*, size_t*);
    typedef int (*gf_get_local_addr_Type)(void*, ACE_Addr &);

    #define DECLARE_SSL_FUNC_PTR(OrigName) \
      OrigName##_Type OrigName##_Ptr;
