...
public:
  ...
  {
    m_regionStats->incInt(m_destroysId, 1);
  }

  inline void incCreates()
  {
    m_regionStats->incInt(m_createsId, 1);
  }

  inline void incPuts()
  {
    m_regionStats->incInt(m_putsId, 1);
  }

  inline void incGets()
  {
    m_regionStats->incInt(m_getsId, 1);
  }

  inline void incGetAll()
  {
      m_regionStats->incInt(m_getAllId, 1);
  }

  inline void incPutAll()
  {
      m_regionStats->incInt(m_putAllId, 1);
  }

  inline void incRemoveAll()
  {
      m_regionStats->incInt(m_removeAllId, 1);
  }

  inline void incHits()
  {
    m_regionStats->incInt(m_hitsId, 1);
  }

  inline void incMisses()
  {
    m_regionStats->incInt(m_missesId, 1);
  }

  inline void incOverflows()
  {
    m_regionStats->incInt(m_overflowsId, 1);
  }

  inline void incRetrieves()
  {
    m_regionStats->incInt(m_retrievesId, 1);
  }
  ...
  inline void incClears() {
  	m_regionStats->incInt(m_clearsId, 1);
  }
...
public:
  ...
  inline int32_t getDestroysId() {
    return m_destroysId;
  }

  inline int32_t getCreatesId() {
    return m_createsId;
  }

  inline int32_t getPutsId() {
    return m_putsId;
  }

  inline int32_t getPutTimeId() {
    return m_putTimeId;
  }

  inline int32_t getPutAllId() {
        return m_putAllId;
  }

  inline int32_t getPutAllTimeId() {
        return m_putAllTimeId;
  }
  
  inline int32_t getRemoveAllId() {
        return m_removeAllId;
  }

  inline int32_t getRemoveAllTimeId() {
        return m_removeAllTimeId;
  }
 
  inline int32_t getGetsId() {
    return m_getsId;
  }
  ...
  inline int32_t getGetAllId() {
      return m_getAllId;
  }

  inline int32_t getGetAllTimeId() {
        return m_getAllTimeId;
  }

  inline int32_t getHitsId() {
    return m_hitsId;
  }

  inline int32_t getMissesId() {
    return m_missesId;
  }

  inline int32_t getEntriesId() {
    return m_entriesId;
  }

  inline int32_t getOverflowsId() {
    return m_overflowsId;
  }

  inline int32_t getRetrievesId() {
    return m_retrievesId;
  }

  inline int32_t getNonSingleHopCount() {
    return m_nonSingleHopId;
  }

  inline int32_t getMetaDataRefreshCount() {
    return m_metaDataRefreshId;
  }
  ...
  inline int32_t getLoaderCallTimeId() {
     return m_LoaderCallTimeId;
  }
  ...
  inline int32_t getWriterCallTimeId() {
      return m_WriterCallTimeId;
  }
  ...
  inline int32_t getListenerCallTimeId() {
      return m_ListenerCallTimeId;
  }

  inline int32_t getClearsId() {
      return m_clearsId;
  }
