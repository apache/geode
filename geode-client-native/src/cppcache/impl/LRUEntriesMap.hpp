...
namespace gemfire
{
   ...
   */
  class CPPCACHE_EXPORT LRUEntriesMap: public ConcurrentEntriesMap, private NonCopyable, private NonAssignable
  {
  protected:
    LRUAction* m_action;
  ...
  public:
    ...
    inline uint32_t validEntriesSize() const
    {
      return m_validEntries.value();
    }

    inline void adjustLimit( uint32_t limit )
    {
      m_limit = limit;
    }
