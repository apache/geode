...
private:
	...
	InternalCacheTransactionManager2PCImpl& operator = (const InternalCacheTransactionManager2PCImpl& other);
	InternalCacheTransactionManager2PCImpl (const InternalCacheTransactionManager2PCImpl & other);
