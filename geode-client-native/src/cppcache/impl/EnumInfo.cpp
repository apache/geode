...
namespace gemfire {
  ...
  EnumInfo::EnumInfo():m_ordinal(-1), m_enumClassName(NULLPTR), m_enumName(NULLPTR) {
  }

  EnumInfo::EnumInfo(const char *enumClassName, const char *enumName, int32_t ordinal):m_ordinal(ordinal) {
