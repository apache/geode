...
private:
  ...
  static void createMergedType(PdxTypePtr localType, PdxTypePtr remoteType, DataInput& dataInput);
...
public:
	...
	static PdxSerializablePtr deserializePdx(DataInput& dataInput, bool forceDeserialize );

    static PdxSerializablePtr deserializePdx(DataInput& dataInput, bool forceDeserialize, int32_t typeId, int32_t length );
  ...
  static int32 getEnumValue(const char* enumClassName, const char* enumName, int hashcode);
