 ...
 *
 * Cache are obtained from create method on the {@link CacheFactory#create} class
 * <p>
...
public:
   ...
   */
  virtual RegionPtr createRegion(const char* name,
  ...
  */
  ...
  virtual bool getPdxIgnoreUnreadFields();
   ...
   /**
   * Returns whether { @link PdxInstance} is preferred for PDX types instead of C++ object.   
   */
...
private:
     ...
     * @brief constructors
     */
  Cache(const char* name, DistributedSystemPtr sys, bool ignorePdxUnreadFields, bool readPdxSerialized );
  Cache(const char* name, DistributedSystemPtr sys, const char* id_data, bool ignorePdxUnreadFields, bool readPdxSerialized );
