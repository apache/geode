...
void VectorOfSharedBase::Iterator::operator ++ ( int )
{
  ++(*m_iter);
}
...
bool VectorOfSharedBase::empty( ) const
{
...
VectorOfSharedBase::VectorOfSharedBase( int32_t n )
: m_stdvector( NULL )
{
...
/** assignment operator */
VectorOfSharedBase& VectorOfSharedBase::operator = ( const VectorOfSharedBase& other )
{
...
void VectorOfSharedBase::reserve( int32_t n )
{
  m_stdvector->reserve( n );
}

/** returns the first element. */
SharedBasePtr& VectorOfSharedBase::front( )
{
...
SharedBasePtr& VectorOfSharedBase::back( )
{
...
void VectorOfSharedBase::pop_back( )
{
