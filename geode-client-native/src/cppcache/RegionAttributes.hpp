...
class CPPCACHE_EXPORT RegionAttributes: public Serializable  {
 ...
 public:
   ...
   *
   * @return the region's <code>ScopeType::Scope</code>
   */
   ...
   */
  inline bool getCachingEnabled() const
  {
    return m_caching;
  }
 ...
 /** TODO
  ...
  void setPersistenceManager(const char* lib, const char* func, const PropertiesPtr& config);
  ...
  void setScope(ScopeType::Scope scope);
