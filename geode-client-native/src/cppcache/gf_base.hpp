 ...
 * @image html PIVOTAL_GemFire_139x64.png
 *
*/
...
typedef enum {
  ...
  GF_CACHEWRITER_ERROR=121,  /**< An Exception occured while invoking a cachewritter callback*/
  GF_CANNOT_PROCESS_GII_REQUEST=123,  /**< A failure other than timeout occured durring a batch request */
  GF_CACHESERVER_EXCEPTION=124, /**< Java cache server exception sent to the thin client by java cache server */
  ...
  GF_DUPLICATE_DURABLE_CLIENT = 129, /**< Java cache server refused duplicate durable client  */
