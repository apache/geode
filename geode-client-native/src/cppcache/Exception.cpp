...
{
  return _exception_name_Exception;
}

const char* Exception::getMessage() const
{
   return m_message->asChar();
}
...
Exception::Exception(const Exception& other) :
  m_message(other.m_message), m_stack(other.m_stack), m_cause(other.m_cause)
{
}
