...
namespace gemfire {
  ...
  class CPPCACHE_EXPORT PdxWriter : public SharedBase{
    ...
    */
     ...
     * of this object on a server that is using {@link CacheFactory#setPdxReadSerialized} or when a client executes a query on a server.
     ...
     * The unread fields are obtained by calling {@link PdxReader#readUnreadFields}.
     ...
     * @return this PdxWriter
     * @throws IllegalStateException if one of the writeXXX methods has already been called.
     */
