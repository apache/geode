...
#include "impl/CqAttributesImpl.hpp"
...
CqAttributesFactory::CqAttributesFactory(CqAttributesPtr& cqAttributes) {
    ...
    CqAttributesImpl *cqAttr = dynamic_cast<CqAttributesImpl*>(cqAttributes.ptr());
...
void CqAttributesFactory::addCqListener(const CqListenerPtr& cqListener) {
    ...
    CqAttributesImpl *cqImpl = dynamic_cast<CqAttributesImpl*>(m_cqAttributes.ptr());
