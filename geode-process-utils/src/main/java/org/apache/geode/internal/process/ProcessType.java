...
/**
 * Enumeration of GemFire ControllableProcess types and the file names associated with
...
public enum ProcessType {
  ...
  public String getPidFileName() {
    return new StringBuilder(System.getProperty(PROPERTY_TEST_PREFIX, StringUtils.EMPTY))
        .append(fileName)
