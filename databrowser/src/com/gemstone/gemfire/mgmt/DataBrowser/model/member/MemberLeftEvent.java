...
/**
 * Implementation of {@link IMemberEvent}, representing event for member left
 * 
 * @author mghosh
 */
public class MemberLeftEvent implements IMemberEvent {
   ...
   * 
   */
  public MemberLeftEvent(GemFireMember[] mbrs) {
    if((mbrs != null)) {
  ...
  public MemberLeftEvent(GemFireMember mbr) {
  ...
  public String toString() {
    ...
    builder.append("member left event for: ");
