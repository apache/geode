...
/**
 * Implementation of {@link IMemberEvent}, representing event for member crashed
 * 
 * @author mghosh
 */
public class MemberCrashedEvent implements IMemberEvent {
   ...
   * 
   */
  public MemberCrashedEvent(GemFireMember[] mbrs) {
    if((mbrs != null)) {
  ...
  public MemberCrashedEvent(GemFireMember mbr) {
  ...
  public String toString() {
    ...
    builder.append("member crashed event for: ");
