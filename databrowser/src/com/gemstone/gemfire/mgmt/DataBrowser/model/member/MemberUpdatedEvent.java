...
/**
 * 
 * Implementation of {@link IMemberEvent}, representing event for member
 * updation
 * 
 * @author mghosh
 * 
 */
public class MemberUpdatedEvent implements IMemberEvent {
   ...
   * 
   */
  public MemberUpdatedEvent(GemFireMember[] mbrs) {
   if((mbrs != null)) {
  ...
  public MemberUpdatedEvent(GemFireMember mbr) {
  ...
  public String toString() {
    ...
    builder.append("member updated event for: ");
