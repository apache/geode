...
public class GeodeJBossModuleGeneratorTask extends DefaultTask {
  ...
  public File getInputFile() {
    return getProject().getTasks().withType(Jar.class).named("jar").get().getOutputs().getFiles()
        .getSingleFile();
  }
  ...
  public void run() {
    configurations
        .forEach(config -> descriptorService.createModuleDescriptor(getProject(), config, getInputFile()));
  }

  public GeodeJBossModuleGeneratorTask() {
