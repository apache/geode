...
public interface GeodeModuleDescriptorService {
  ...
  void createExternalLibraryDependenciesModuleDescriptor(Project project,
      ModulesGeneratorConfig config);

  void combineModuleDescriptors(Project project, ModulesGeneratorConfig config,
      List<File> inputFiles, Path rootPath);
}
