...
public class DockerWorkerProcessFactory extends DefaultWorkerProcessFactory {
  private final DockerProcessLauncher processLauncher;

  public DockerWorkerProcessFactory(LoggingManager loggingManager,
      ...
      MemoryManager memoryManager, DockerProcessLauncher processLauncher) {
  ...
  public WorkerProcessBuilder create(Action<? super WorkerProcessContext> workerAction) {
    return new DockerWorkerProcessBuilder(super.create(workerAction), processLauncher);
  }
}
