...
class DependencyConstraints implements Plugin<Project> {
  ...
  static private Map<String, String> initExternalDependencies() {
    ...
    deps.put("log4j.version", "2.13.0")
    deps.put("micrometer.version", "1.3.2")
    ...
    deps.put("protoc.version", "3.11.2")
    deps.put("protobuf-gradle-plugin.version", "0.8.10")
    deps.put("protobuf-java.version", "3.11.1")
  ...
  void apply(Project project) {
    ...
    project.dependencies {
      constraints {
        ...
        api(group: 'com.carrotsearch.randomizedtesting', name: 'randomizedtesting-runner', version: '2.7.5')
        api(group: 'com.fasterxml.jackson.module', name: 'jackson-module-scala_2.10', version: '2.10.1')
        api(group: 'com.github.davidmoten', name: 'geo', version: '0.7.6')
        ...
        api(group: 'com.sun.istack', name: 'istack-commons-runtime', version: '3.0.10')
        ...
        api(group: 'io.github.classgraph', name: 'classgraph', version: '4.8.59')
        api(group: 'io.micrometer', name: 'micrometer-core', version: get('micrometer.version'))
        api(group: 'io.netty', name: 'netty-all', version: '4.1.44.Final')
        ...
        api(group: 'org.assertj', name: 'assertj-core', version: '3.14.0')
        api(group: 'org.awaitility', name: 'awaitility', version: '4.0.2')
        api(group: 'org.bouncycastle', name: 'bcpkix-jdk15on', version: '1.64')
        api(group: 'org.codehaus.cargo', name: 'cargo-core-uberjar', version: '1.7.9')
        ...
        api(group: 'org.mockito', name: 'mockito-core', version: '3.2.4')
        api(group: 'org.mortbay.jetty', name: 'servlet-api', version: '3.0.20100224')
        api(group: 'org.openjdk.j1mh', name: 'jmh-core', version: '1.21')
        api(group: 'org.postgresql', name: 'postgresql', version: '42.2.9')
        ...
        api(group: 'org.springframework.hateoas', name: 'spring-hateoas', version: '1.0.2.RELEASE')
        ...
        api(group: 'com.fasterxml.jackson.datatype', name: 'jackson-datatype-joda', version: '2.10.1')
    ...
    dependencySet(group: 'org.powermock', version: '2.0.4') {
    ...
    dependencySet(group: 'org.springframework', version: '5.2.2.RELEASE') {
