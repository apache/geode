  ...
  void apply(Project project) {
    ...
    project.dependencies {
      constraints {
        ...
        api(group: 'com.fasterxml.jackson.module', name: 'jackson-module-scala_2.12', version: '2.12.1')
        ...
        api(group: 'net.minidev', name: 'json-smart', version: '2.4.1')
    ...
    dependencySet(group: 'org.springframework', version: '5.3.4') {
