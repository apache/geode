  ...
  void apply(Project project) {
    ...
    project.dependencies {
      constraints {
        ...
        api(group: 'io.netty', name: 'netty-all', version: '4.1.63.Final')
        api(group: 'io.swagger', name: 'swagger-annotations', version: '1.6.2')
        api(group: 'it.unimi.dsi', name: 'fastutil-core', version: get('fastutil.version'))
        api(group: 'it.unimi.dsi', name: 'fastutil-extra', version: get('fastutil.version'))
