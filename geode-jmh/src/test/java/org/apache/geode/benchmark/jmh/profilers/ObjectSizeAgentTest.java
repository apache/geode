...
public class ObjectSizeAgentTest {
  ...
  public void objectWithIntFieldExtendsObjectWithIntField() {
    final ObjectWithIntFieldExtendsObjectWithIntField object = new ObjectWithIntFieldExtendsObjectWithIntField();
    assertThat(sizeOfDeep(object)).isEqualTo(sizeOf(object));
  }
  ...
  public void objectWithArrayOfObject100Field() {
    ...
    assertThat(sizeOfDeep(object)).isEqualTo(sizeOf(object) + sizeOf(object.a1) + sizeOf(new Object()) * 100);
  }
