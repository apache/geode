...
set GEMFIRE_JARS=%GEMFIRE_JARS%;%gf%\lib\gemfire-modules-${gemfire.modules.version}.jar
set GEMFIRE_JARS=%GEMFIRE_JARS%;%gf%\lib\gemfire-modules-session-${gemfire.modules.version}.jar
set GEMFIRE_JARS=%GEMFIRE_JARS%;%gf%\lib\gemfire-modules-session-external-${gemfire.modules.version}.jar
