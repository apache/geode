...
@Experimental
public interface RegionRedundancyStatusSerializable extends JsonSerializable, Serializable {
  ...
  /**
   * Returns the for the region used to create this
   * RegionRedundancyStatus
   * at the time of creation.
   *
   * @return The for the region used to create this
   *         RegionRedundancyStatus.
   */
