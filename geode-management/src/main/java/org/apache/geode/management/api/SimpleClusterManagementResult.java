...
@Experimental
public class SimpleClusterManagementResult {
  ...
  public SimpleClusterManagementResult() {}

  public SimpleClusterManagementResult(boolean success, String message) {
    setStatus(success, message);
  }

  public SimpleClusterManagementResult(StatusCode statusCode, String message) {
