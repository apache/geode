...
public class AlterRuntimeCommandDistributedTest {
  ...
  // @Test
  // @Parameters({"true", "false"})
  // public void alterStatArchiveFileWithMember_updatesSelectedServerConfigs(boolean
  // connectOverHttp)
  // throws Exception {
  // Properties props = new Properties();
  // props.setProperty(LOG_LEVEL, "error");
  ...
  //
  // /**
  // * Test to verify that when 'alter runtime' without relevant options does not change the
  // server's
  // * configuration
  // */
  // @Test
